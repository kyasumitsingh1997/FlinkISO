...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectActivityRequirement['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectActivityRequirement['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectActivityRequirement['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectActivityRequirement['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("project_activity_id"));?></th>
				<th><?php echo h(Inflector::humanize("title"));?></th>
				<th><?php echo h(Inflector::humanize("details"));?></th>
				<th><?php echo h(Inflector::humanize("manpower"));?></th>
				<th><?php echo h(Inflector::humanize("manpower_Details"));?></th>
				<th><?php echo h(Inflector::humanize("infrastructure"));?></th>
				<th><?php echo h(Inflector::humanize("other"));?></th>
				<th><?php echo h(Inflector::humanize("branch_id"));?></th>
				<th><?php echo h(Inflector::humanize("users"));?></th>
				<th><?php echo h(Inflector::humanize("user_session_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectActivityRequirement['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivityRequirement['Milestone']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivityRequirement['ProjectActivity']['title']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectActivityRequirement['Branch']['name']); ?>&nbsp;</td>
		<td><?php echo h($projectActivityRequirement['ProjectActivityRequirement']['users']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivityRequirement['UserSession']['id']); ?>&nbsp;</td>
		<td><?php echo h($projectActivityRequirement['ProjectActivityRequirement']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectActivityRequirement['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivityRequirement['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivityRequirement['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivityRequirement['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivityRequirement['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
