...
<h4><?php echo __('Edit Capa Revised Date'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('CapaRevisedDate',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
		...
		echo "<div class='col-md-6'>".$this->Form->input('new_revised_date_requested') . '</div>'; 
		echo "<div class='col-md-12'>".$this->Form->input('reason') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('revised_date') . '</div>'; 
	?>
<?php
    ...
    $.validator.setDefaults({
     ...
     $("#submit-indicator").hide();
        $("#submit_id").click(function(){
            if($('#CapaRevisedDateEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#CapaRevisedDateEditForm').submit();
            }
        ...
        $('#CapaRevisedDateEditForm').validate({
            rules: {
