...
<div class="row">
	<div class="col-md-12">
		<h2><?php echo __('Preventive Maintainance Calendar'); ?></h2>	
		<div class="btn-group hide" role="group">
			...
			<?php echo $this->Html->link(__('Department-wise'),array(
									'action'=>'device_maintainance_plan',
									'type'=>'department',
			...
			<?php echo $this->Html->link(__('Device Category-wise'),array(
									'action'=>'device_maintainance_plan',
									'type'=>'auditor',
									'year'=>$this->request->params['named']['year'],
									'audit_type_masters'=>$this->request->params['named']['audit_type_masters'],
			...
			<!-- <div class="btn-group" role="group">
			    ...
			    <ul class="dropdown-menu">
			    	...
			    	foreach ($ie as $key => $value) {
			    		echo "<li>". $this->Html->link($value,array('action'=>'device_maintainance_plan','type'=>$this->request->params['named']['type'],'year'=>$this->request->params['named']['year'],'audit_type_masters'=>$this->request->params['named']['audit_type_masters'],'ie'=>$key))."</li>";
			    	} ?>		      
			    </ul>
			  </div> -->
			<!-- <div class="btn-group" role="group">
			    ...
			    <ul class="dropdown-menu">
			    	<?php foreach ($audit_type_masters as $key => $value) {
			    		echo "<li>". $this->Html->link($value,array('action'=>'device_maintainance_plan','type'=>$this->request->params['named']['type'],'year'=>$this->request->params['named']['year'],'audit_type_masters'=>$key,'ie'=>$this->request->params['named']['ie']))."</li>";
			    	} ?>		      
			    </ul>
			</div> -->
	...
	<div class="col-md-12">		
		<div class="btn-group">
		      <div class="btn btn-default"><?php echo $this->Html->link(__('2015'),array('action'=>'device_maintainance_plan','type'=>$this->request->params['named']['type'],'year'=>'2015','audit_type_masters'=>$this->request->params['named']['audit_type_masters'],'ie'=>$this->request->params['named']['ie']));?></div>
		      <div class="btn btn-default"><?php echo $this->Html->link(__('2016'),array('action'=>'device_maintainance_plan','type'=>$this->request->params['named']['type'],'year'=>'2016','audit_type_masters'=>$this->request->params['named']['audit_type_masters'],'ie'=>$this->request->params['named']['ie']));?></div>
		      <div class="btn btn-default"><?php echo $this->Html->link(__('2017'),array('action'=>'device_maintainance_plan','type'=>$this->request->params['named']['type'],'year'=>'2017','audit_type_masters'=>$this->request->params['named']['audit_type_masters'],'ie'=>$this->request->params['named']['ie']));?></div>
		      <div class="btn btn-default"><?php echo $this->Html->link(__('2018'),array('action'=>'device_maintainance_plan','type'=>$this->request->params['named']['type'],'year'=>'2018','audit_type_masters'=>$this->request->params['named']['audit_type_masters'],'ie'=>$this->request->params['named']['ie']));?></div>
		      <div class="btn btn-default"><?php echo $this->Html->link(__('2019'),array('action'=>'device_maintainance_plan','type'=>$this->request->params['named']['type'],'year'=>'2019','audit_type_masters'=>$this->request->params['named']['audit_type_masters'],'ie'=>$this->request->params['named']['ie']));?></div>
		      <div class="btn btn-default"><?php echo $this->Html->link(__('2020'),array('action'=>'device_maintainance_plan','type'=>$this->request->params['named']['type'],'year'=>'2020','audit_type_masters'=>$this->request->params['named']['audit_type_masters'],'ie'=>$this->request->params['named']['ie']));?></div>
		</div>	    
	</div>
	<div class="col-md-12">		
		<h2><?php echo 'Maintainance Plan for the year ' . $this->request->params['named']['year'] ;?></h2>
