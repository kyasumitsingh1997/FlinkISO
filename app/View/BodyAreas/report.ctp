...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($bodyArea['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($bodyArea['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($bodyArea['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($bodyArea['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($bodyArea['BodyArea']['publish']); ?>&nbsp;</td>
		<td><?php echo h($bodyArea['BodyArea']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($bodyArea['BodyArea']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($bodyArea['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($bodyArea['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($bodyArea['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($bodyArea['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($bodyArea['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($bodyArea['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
