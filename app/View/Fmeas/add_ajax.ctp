...
<?php echo $this->Session->flash();?>	<div class="nav">
		<div class="fmeas form col-md-8">
			<h4>Add FMEA</h4>
			<?php echo $this->Form->create('Fmea',array('role'=>'form','class'=>'form','default'=>false)); ?>
			<div class="row">
			<fieldset>
			<?php
					...
					echo "<div class='col-md-6'><h2>RPN : <span id='ranking'>0</span></h2>".$this->Form->hidden('rpn',array()) . '</div>'; 
			?>
			</fieldset>
			<?php
...
<?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#fmeas_ajax','async' => 'false')); ?>
