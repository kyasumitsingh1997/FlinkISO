			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('FileProcess',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","current_status"=>"Current Status","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","prepared_by"=>"Prepared By","approved_by"=>"Approved By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#fileProcesses_ajax','type'=>'data','method'=>'post')); ?>
...
<?php foreach ($fileProcesses as $fileProcess): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$fileProcess['FileProcess']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><span class=" glyphicon glyphicon-wrench"></span></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $fileProcess['FileProcess']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $fileProcess['FileProcess']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $fileProcess['FileProcess']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $fileProcess['FileProcess']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $fileProcess['FileProcess']['id']),array('class'=>''), __('Are you sure ?', $fileProcess['FileProcess']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($fileProcess['FileProcess']['sr_no']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($fileProcess['FileProcess']['current_status']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($fileProcess['FileProcess']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fileProcess['FileProcess']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($fileProcess['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $fileProcess['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileProcess['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $fileProcess['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileProcess['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $fileProcess['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileProcess['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $fileProcess['ApprovedBy']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#fileProcesses_ajax')));?>
...
<?php echo $this->Form->create('fileProcesses',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","current_status"=>"Current Status","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","prepared_by"=>"Prepared By","approved_by"=>"Approved By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
