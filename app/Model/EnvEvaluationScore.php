 ...
 */
class EnvEvaluationScore extends AppModel {
 ...
 */
	public $belongsTo = array(
		...
		'EnvEvaluation' => array(
			'className' => 'EnvEvaluation',
			'foreignKey' => 'env_evaluation_id',
			'conditions' => '',
			'fields' => array('id', 'title'),
			'order' => ''
		),
