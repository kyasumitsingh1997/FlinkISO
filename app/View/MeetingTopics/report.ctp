...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($meetingTopic['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($meetingTopic['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($meetingTopic['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($meetingTopic['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("meeting_id"));?></th>
				<th><?php echo h(Inflector::humanize("change_addition_deletion_request_id"));?></th>
				<th><?php echo h(Inflector::humanize("corrective_preventive_action_id"));?></th>
				<th><?php echo h(Inflector::humanize("document_amendment_record_sheet_id"));?></th>
				<th><?php echo h(Inflector::humanize("customer_complaint_id"));?></th>
				<th><?php echo h(Inflector::humanize("customer_feedback_id"));?></th>
				<th><?php echo h(Inflector::humanize("supplier_evaluation_reevaluation_id"));?></th>
				<th><?php echo h(Inflector::humanize("summery_of_supplier_evaluation_id"));?></th>
				<th><?php echo h(Inflector::humanize("internal_audit_plan_id"));?></th>
				<th><?php echo h(Inflector::humanize("title"));?></th>
				<th><?php echo h(Inflector::humanize("current_status"));?></th>
				<th><?php echo h(Inflector::humanize("action_plan"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($meetingTopic['Meeting']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['ChangeAdditionDeletionRequest']['request_details']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['CorrectivePreventiveAction']['name']); ?>&nbsp;</td>
		<td><?php echo h($meetingTopic['MeetingTopic']['document_amendment_record_sheet_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['CustomerComplaint']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['CustomerFeedback']['id']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($meetingTopic['Employee']['name']); ?>&nbsp;</td>
		<td><?php echo h($meetingTopic['MeetingTopic']['target_date']); ?>&nbsp;</td>
		<td><?php echo h($meetingTopic['MeetingTopic']['notes']); ?>&nbsp;</td>
		<td><?php echo h($meetingTopic['MeetingTopic']['publish']); ?>&nbsp;</td>
		<td><?php echo h($meetingTopic['MeetingTopic']['record_status']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['StatusUserId']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['PreparedBy']['name']); ?>&nbsp;</td>
		<td><?php echo h($meetingTopic['MeetingTopic']['division_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($meetingTopic['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
