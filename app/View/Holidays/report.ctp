...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($holiday['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($holiday['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($holiday['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($holiday['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("date"));?></th>
	...
	<tr>
		...
		<td><?php echo h($holiday['Holiday']['publish']); ?>&nbsp;</td>
		<td><?php echo h($holiday['Holiday']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($holiday['Holiday']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($holiday['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($holiday['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($holiday['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($holiday['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
