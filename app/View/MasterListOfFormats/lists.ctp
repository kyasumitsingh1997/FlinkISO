<div  id="main">
    ...
    <div class="masterListOfFormats ">
        <?php echo $this->element('nav-header-lists', array('postData' => array('pluralHumanName' => 'New Quality Document', 'modelClass' => 'MasterListOfFormat', 'options' => array("sr_no" => "Sr No", "title" => "Title", "document_number" => "Document Number", "issue_number" => "Issue Number", "revision_number" => "Revision Number", "revision_date" => "Revision Date", "prepared_by" => "Prepared By", "approved_by" => "Approved By", "archived" => "Archived"), 'pluralVar' => 'masterListOfFormats'))); ?>
        <div class="nav">
            <div id="tabs">
                <ul>
