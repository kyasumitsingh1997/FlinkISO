...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($processTeam['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($processTeam['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($processTeam['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($processTeam['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("objective_id"));?></th>
				<th><?php echo h(Inflector::humanize("team"));?></th>
				<th><?php echo h(Inflector::humanize("process_type"));?></th>
				<th><?php echo h(Inflector::humanize("branch_id"));?></th>
				<th><?php echo h(Inflector::humanize("department_id"));?></th>
				<th><?php echo h(Inflector::humanize("target"));?></th>
				<th><?php echo h(Inflector::humanize("measurement_details"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($processTeam['Process']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($processTeam['Objective']['title']); ?>&nbsp;</td>
		<td><?php echo h($processTeam['ProcessTeam']['team']); ?>&nbsp;</td>
		<td><?php echo h($processTeam['ProcessTeam']['process_type']); ?>&nbsp;</td>
		<td width="50"><?php echo h($processTeam['Branch']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($processTeam['Department']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($processTeam['ProcessTeam']['publish']); ?>&nbsp;</td>
		<td><?php echo h($processTeam['ProcessTeam']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($processTeam['ProcessTeam']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($processTeam['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($processTeam['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($processTeam['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($processTeam['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($processTeam['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
