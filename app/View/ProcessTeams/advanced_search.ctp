			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('ProcessTeam',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","team"=>"Team","process_type"=>"Process Type","target"=>"Target","measurement_details"=>"Measurement Details","start_date"=>"Start Date","end_date"=>"End Date","system_table"=>"System Table","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#processTeams_ajax','type'=>'data','method'=>'post')); ?>
...
<?php foreach ($processTeams as $processTeam): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$processTeam['ProcessTeam']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $processTeam['ProcessTeam']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $processTeam['ProcessTeam']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $processTeam['ProcessTeam']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $processTeam['ProcessTeam']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $processTeam['ProcessTeam']['id']),array('class'=>''), __('Are you sure ?', $processTeam['ProcessTeam']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($processTeam['ProcessTeam']['sr_no']); ?>&nbsp;</td>
		<td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($processTeam['ProcessTeam']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($processTeam['ProcessTeam']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($processTeam['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $processTeam['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($processTeam['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $processTeam['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($processTeam['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $processTeam['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($processTeam['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $processTeam['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($processTeam['Company']['name'], array('controller' => 'companies', 'action' => 'view', $processTeam['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#processTeams_ajax')));?>
...
<?php echo $this->Form->create('processTeams',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","team"=>"Team","process_type"=>"Process Type","target"=>"Target","measurement_details"=>"Measurement Details","start_date"=>"Start Date","end_date"=>"End Date","system_table"=>"System Table","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
