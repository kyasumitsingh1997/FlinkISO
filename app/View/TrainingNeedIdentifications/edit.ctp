...
<script>
    ...
    $().ready(function () {
        ...
        $('#TrainingNeedIdentificationEditForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#TrainingNeedIdentificationEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#TrainingNeedIdentificationEditForm").submit();
             }
        });
...
<div id="trainingNeedIdentifications_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="trainingNeedIdentifications form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Training Need Identification'); ?>
...
echo $this->Form->submit(__('Submit'), array('div' => false, 'class' => 'btn btn-primary btn-success', 'update' => '#trainingNeedIdentifications_ajax', 'async' => 'false','id'=>'submit_id')); ?>
