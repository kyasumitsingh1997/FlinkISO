...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($division['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($division['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($division['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($division['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($division['Division']['publish']); ?>&nbsp;</td>
		<td><?php echo h($division['Division']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($division['Division']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($division['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($division['DepartmentIds']['name']); ?>&nbsp;</td>
		<td><?php echo h($division['Division']['approved_by']); ?>&nbsp;</td>
		<td><?php echo h($division['Division']['prepared_by']); ?>&nbsp;</td>
		<td width="50"><?php echo h($division['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
