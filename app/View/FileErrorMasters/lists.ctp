...
<?php echo $this->Session->flash();?>	
	<div class="fileErrorMasters ">
		...
		<div class="nav">
			<div id="tabs">	
				<ul>
					<li><?php echo $this->Html->link(__('New File Error Master'), array('action' => 'add_ajax')); ?></li>
					...
					<li><?php // echo $this->Html->link(__('Add File Error'), array('controller' => 'file_errors', 'action' => 'add_ajax')); ?> </li>
					<li><?php echo $this->Html->image('indicator.gif', array('id' => 'busy-indicator','class'=>'pull-right')); ?></li>
				</ul>
			</div>
		</div>
	<div id="fileErrorMasters_tab_ajax"></div>
</div>
