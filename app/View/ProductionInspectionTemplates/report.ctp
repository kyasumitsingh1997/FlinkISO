...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($productionInspectionTemplate['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($productionInspectionTemplate['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($productionInspectionTemplate['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($productionInspectionTemplate['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($productionInspectionTemplate['ProductionInspectionTemplate']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($productionInspectionTemplate['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionInspectionTemplate['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionInspectionTemplate['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionInspectionTemplate['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionInspectionTemplate['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
