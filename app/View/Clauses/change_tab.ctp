...
<div class="row">
		...
		echo "<div class='col-md-6'>".$this->Form->input('existing_tab_name',array('value'=>base64_decode($this->request->params['pass'][1]),'disabled')) . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('new_tab_name',array('value'=>base64_decode($this->request->params['pass'][1]))) . '</div>'; 
		?>		
<?php
