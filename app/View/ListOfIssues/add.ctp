...
<h4><?php echo __('Add List Of Issue'); ?>		
...
<div class="row">
		...
		echo "<div class='col-md-12'>".$this->Form->input('issue_details') . '</div>'; 
...
<script>
    ...
    $().ready(function() {
        ...
        $("#submit_id").click(function(){
            if($('#ListOfIssueAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ListOfIssueAddForm').submit();
            }
