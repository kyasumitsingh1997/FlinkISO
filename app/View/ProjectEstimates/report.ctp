...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectEstimate['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectEstimate['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectEstimate['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectEstimate['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("cost_category_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectEstimate['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEstimate['CostCategory']['name']); ?>&nbsp;</td>
		<td><?php echo h($projectEstimate['ProjectEstimate']['details']); ?>&nbsp;</td>
		<td><?php echo h($projectEstimate['ProjectEstimate']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectEstimate['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEstimate['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEstimate['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEstimate['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
