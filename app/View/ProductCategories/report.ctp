...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($productCategory['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($productCategory['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($productCategory['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($productCategory['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($productCategory['ProductCategory']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($productCategory['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productCategory['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productCategory['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productCategory['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productCategory['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
