 ...
 */
class ContinualImprovement extends AppModel {
 ...
 */
	public $belongsTo = array(
		...
		'InternalAuditDetail' => array(
			'className' => 'InternalAuditDetail',
			'foreignKey' => 'internal_audit_detail_id',
			'conditions' => '',
			//'fields' => array('id', 'title'),
			'order' => ''
		),
