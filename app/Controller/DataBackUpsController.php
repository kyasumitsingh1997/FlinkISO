...
class DataBackUpsController extends AppController {
    ...
    public function advanced_search() {
        ...
        if ($this->request->query['from-date']) {
            $conditions[] = array('DataBackUp.created >' => date('Y-m-d h:i:s', strtotime($this->request->query['from-date'])), 'DataBackUp.created <' => date('Y-m-d h:i:s', strtotime($this->request->query['to-date'])));
        }
