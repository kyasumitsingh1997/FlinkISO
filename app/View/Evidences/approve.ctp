...
<div id="evidences_ajax">
	...
	<div class="nav panel panel-default">
		<div class="evidences form col-md-8">
			<h4><?php echo __('Approve Evidence'); ?>		
		...
		<div class="row">
        	...
        	<div class="col-md-2"><br /><br /><br /><?php
        		
        		$controller_to_get = Inflector::tableize(Inflector::variable($models[$this->request->data['Evidence']['model_name']]));
        		$record = $this->request->data['Evidence']['record'];
        		echo $this->Html->link('View Record',array('controller'=>$controller_to_get,'action'=>'view',$record),array('class'=>'btn btn-success btn-md pull-right','target'=>'_blank'));
        	?>
        	</div>
        	<?php
