			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('InvoiceSetting',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","vat_number"=>"Vat Number","sales_tax_number"=>"Sales Tax Number","service_tax_number"=>"Service Tax Number","company_name"=>"Company Name","banking_details"=>"Banking Details","footer"=>"Footer","contact_details"=>"Contact Details","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#invoiceSettings_ajax','type'=>'data','method'=>'post')); ?>
;									<?php echo $this->Form->end(); ?></li>
				...
				<div class="col-md-8">
					<h4><?php echo __('Invoice Settings'); ?>
...
<?php foreach ($invoiceSettings as $invoiceSetting): ?>
	<tr>
		...
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View'), array('action' => 'view', $invoiceSetting['InvoiceSetting']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $invoiceSetting['InvoiceSetting']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $invoiceSetting['InvoiceSetting']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $invoiceSetting['InvoiceSetting']['id'])); ?></li>
				<li class="divider"></li>
				...
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $invoiceSetting['InvoiceSetting']['id']),array('class'=>''), __('Are you sure ?', $invoiceSetting['InvoiceSetting']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($invoiceSetting['InvoiceSetting']['sr_no']); ?>&nbsp;</td>
		<td><?php echo h($invoiceSetting['InvoiceSetting']['vat_number']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($invoiceSetting['InvoiceSetting']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($invoiceSetting['InvoiceSetting']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($invoiceSetting['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $invoiceSetting['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($invoiceSetting['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $invoiceSetting['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($invoiceSetting['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $invoiceSetting['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($invoiceSetting['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $invoiceSetting['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($invoiceSetting['Division']['name'], array('controller' => 'divisions', 'action' => 'view', $invoiceSetting['Division']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($invoiceSetting['Company']['name'], array('controller' => 'companies', 'action' => 'view', $invoiceSetting['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
	<tr><td colspan=25>No results found</td></tr>
<?php } ?>
			</table>
		</div>
			<p>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#invoiceSettings_ajax')));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","vat_number"=>"Vat Number","sales_tax_number"=>"Sales Tax Number","service_tax_number"=>"Service Tax Number","company_name"=>"Company Name","banking_details"=>"Banking Details","footer"=>"Footer","contact_details"=>"Contact Details","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
