...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($envEvaluationScore['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($envEvaluationScore['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($envEvaluationScore['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($envEvaluationScore['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("env_evaluation_id"));?></th>
				<th><?php echo h(Inflector::humanize("aspect_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($envEvaluationScore['EnvActivity']['title']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($envEvaluationScore['Aspect']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($envEvaluationScore['EnvEvaluationScore']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($envEvaluationScore['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envEvaluationScore['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envEvaluationScore['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envEvaluationScore['PreparedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
