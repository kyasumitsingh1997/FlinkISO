...
<?php foreach ($envEvaluations as $envEvaluation): ?>
	<tr>
		...
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View'), array('action' => 'view', $envEvaluation['EnvEvaluation']['id'])); ?></li>
		...
		<td>
			<?php echo $this->Html->link($envEvaluation['EnvIdentification']['title'], array('controller' => 'env_indentifications', 'action' => 'view', $envEvaluation['EnvIdentification']['id'])); ?>
		</td>
