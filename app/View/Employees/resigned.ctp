        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('employment_status', __('Employment Status')); ?></th>
                ...
                <tr class="on_page_src">
                    ...
                    <td><?php echo $PublishedEmployeeList[$employee['Employee']['parent_id']]; ?>&nbsp;</td>
                    <td><?php echo $employmentStatuses[$employee['Employee']['employment_status']]; ?>&nbsp;</td>
