...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($otherMeasurableUnitValue['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($otherMeasurableUnitValue['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($otherMeasurableUnitValue['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($otherMeasurableUnitValue['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("other_measurable_unit_id"));?></th>
				<th><?php echo h(Inflector::humanize("value"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($otherMeasurableUnitValue['OtherMeasurableUnit']['id']); ?>&nbsp;</td>
		<td><?php echo h($otherMeasurableUnitValue['OtherMeasurableUnitValue']['value']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnitValue['ProjectProcessPlan']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnitValue['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnitValue['Milestone']['title']); ?>&nbsp;</td>
		<td><?php echo h($otherMeasurableUnitValue['OtherMeasurableUnitValue']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($otherMeasurableUnitValue['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnitValue['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnitValue['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnitValue['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
