 ...
 */
	public function error($field, $text = null, $options = array()) {
		$defaults = array('wrap' => true, 'class' => '', 'escape' => true);
	...
	protected function _getInput($args) {
		...
		switch ($type) {
			...
			case 'time':
				...
				return $this->text($fieldName, null, text, $options);
			case 'date':
				// $options['value'] = $selected;
				// return $this->text($fieldName, null, null, $options);
