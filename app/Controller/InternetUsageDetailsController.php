...
class InternetUsageDetailsController extends AppController {
    ...
    public function advanced_search() {
        ...
        if ($this->request->query['from-date']) {
            $conditions[] = array('InternetUsageDetail.created >' => date('Y-m-d h:i:s', strtotime($this->request->query['from-date'])), 'InternetUsageDetail.created <' => date('Y-m-d h:i:s', strtotime($this->request->query['to-date'])));
        }
