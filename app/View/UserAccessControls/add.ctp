...
<h4><?php echo __('Add User Access Control'); ?>		
...
<div class="row">
		...
		echo "<div class='col-md-12'>".$this->Form->input('user_access') . '</div>'; 
...
<script>
    ...
    $().ready(function() {
        ...
        $('#UserAccessControlAddForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#UserAccessControlAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#UserAccessControlAddForm').submit();
            }
