...
class CustomerFeedbacksController extends AppController {
    ...
    public function delete($id = null) {
        ...
        if (!empty($id)) {
            ...
            if(isset($data['CustomerFeedback'])){
                $data['CustomerFeedback']['model_action'] = $this->params['action'];
                $data['CustomerFeedback']['system_table_id'] = $this->_get_system_table_id();
                $modelName = $this->modelClass;
                $this->$modelName->save($data['CustomerFeedback'], false);
            }
        }
        $this->redirect(array(
            'action' => 'index'
    ...
    public function delete_all($id = null) {
        ...
        if (!empty($ids)) {
            ...
            if(isset($id) &&  isset($data['CustomerFeedback'])){
                $data['CustomerFeedback']['model_action'] = $this->params['action'];
                $data['CustomerFeedback']['system_table_id'] = $this->_get_system_table_id();
                $modelName = $this->modelClass;
                $this->$modelName->save($data['CustomerFeedback'], false);
