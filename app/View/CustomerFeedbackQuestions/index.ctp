    ...
    <div class="customerFeedbackQuestions ">
        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <?php
                    if ($customerFeedbackQuestions) {
                        $x = 0;
                        foreach ($customerFeedbackQuestions as $customerFeedbackQuestion):
                ?>
                <tr class="on_page_src">
                    <td class=" actions">
                        <?php echo $this->element('actions', array('created' => $customerFeedbackQuestion['CustomerFeedbackQuestion']['created_by'], 'postVal' => $customerFeedbackQuestion['CustomerFeedbackQuestion']['id'], 'softDelete' => $customerFeedbackQuestion['CustomerFeedbackQuestion']['soft_delete'])); ?>
                    </td>
                    <td><?php echo h($customerFeedbackQuestion['CustomerFeedbackQuestion']['title']); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$customerFeedbackQuestion['CustomerFeedbackQuestion']['prepared_by']]); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$customerFeedbackQuestion['CustomerFeedbackQuestion']['approved_by']]); ?>&nbsp;</td>
                    <td width="60">
