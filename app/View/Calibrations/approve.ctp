...
<script>
    ...
    $().ready(function () {
        ...
        $("#submit_id").click(function(){
             if($('#CalibrationApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#CalibrationApproveForm").submit();
             }
        ...
        $('#CalibrationApproveForm').validate({
            rules: {
...
<div id="calibrations_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="calibrations form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Calibration'); ?>
...
<script>
    $('#CalibrationCalibrationDate').datepicker({
        changeMonth: true,
        changeYear: true,
        format: 'yyyy-mm-dd',
      autoclose:true,
    ...
    $('#CalibrationCalibrationDate').datepicker('option', 'maxDate', 0);

    $('#CalibrationNextCalibrationDate').datepicker({
        changeMonth: true,
        changeYear: true,
        format: 'yyyy-mm-dd',
      autoclose:true,
    ...
    $('#CalibrationNextCalibrationDate').datepicker('option', 'minDate', 0);
</script>
