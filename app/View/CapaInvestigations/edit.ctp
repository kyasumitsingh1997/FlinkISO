...
<h4><?php echo __('Edit Capa Investigation'); ?>		
...
<div class="row">
		...
		echo "<div class='col-md-6'>".$this->Form->input('corrective_preventive_action_id',array('disabled', 'options' => $correctivePreventiveActionIds)) . '</div>'; 
                ...
                if($this->data['CapaInvestigation']['created_by'] != $this->Session->read('User.id')){
                    ...
                    echo "<div class='col-md-6 hide'>".$this->Form->input('target_date') . '</div>'; 
                }else{
		...
		echo $this->Form->input('current_status', array('value' => '0', 'label' => false, 'legend' => false,  'div' => array('class'=>'input'), 'options' => array('0' => 'Open', '1' => 'Close'), 'type' => 'radio', 'style' => 'float:none','onclick' => 'currentStatus()')). '</div>'; 
	?>
<?php
...
<script>
    ...
    $("#submit-indicator").hide();
     $("#submit_id").click(function(){
            if($('#CapaInvestigationEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#CapaInvestigationEditForm').submit();
            }
        ...
        $('#CapaInvestigationEditForm').validate({
            rules: {
