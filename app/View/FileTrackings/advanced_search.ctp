			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('FileTracking',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","from"=>"From","to"=>"To","by"=>"By","current_status"=>"Current Status","changed_on"=>"Changed On","changetype"=>"Changetype","function"=>"Function","comment"=>"Comment","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","prepared_by"=>"Prepared By","approved_by"=>"Approved By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#fileTrackings_ajax','type'=>'data','method'=>'post')); ?>
...
<?php foreach ($fileTrackings as $fileTracking): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$fileTracking['FileTracking']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><span class=" glyphicon glyphicon-wrench"></span></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $fileTracking['FileTracking']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $fileTracking['FileTracking']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $fileTracking['FileTracking']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $fileTracking['FileTracking']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $fileTracking['FileTracking']['id']),array('class'=>''), __('Are you sure ?', $fileTracking['FileTracking']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($fileTracking['FileTracking']['sr_no']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($fileTracking['FileTracking']['to']); ?>&nbsp;</td>
		<td><?php echo h($fileTracking['FileTracking']['by']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($fileTracking['FileTracking']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fileTracking['FileTracking']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($fileTracking['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $fileTracking['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileTracking['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $fileTracking['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileTracking['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $fileTracking['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileTracking['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $fileTracking['ApprovedBy']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#fileTrackings_ajax')));?>
...
<?php echo $this->Form->create('fileTrackings',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","from"=>"From","to"=>"To","by"=>"By","current_status"=>"Current Status","changed_on"=>"Changed On","changetype"=>"Changetype","function"=>"Function","comment"=>"Comment","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","prepared_by"=>"Prepared By","approved_by"=>"Approved By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
