...
$().ready(function() {
    ...
    $('#ListOfAcceptableSupplierEditForm').validate({
	rules: {
	...
	if($('#ListOfAcceptableSupplierEditForm').valid()){
	    $("#submit_id").prop("disabled",true);
	    $("#submit-indicator").show();
	    $("#ListOfAcceptableSupplierEditForm").submit();
	}
    });
...
<div class="nav panel panel-default">
    <div class="listOfAcceptableSuppliers form col-md-8">
        <h4><?php echo $this->element('breadcrumbs') . __('Edit Acceptable Supplier'); ?>
