...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($capaRating['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($capaRating['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($capaRating['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($capaRating['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($capaRating['CapaRating']['publish']); ?>&nbsp;</td>
		<td><?php echo h($capaRating['CapaRating']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($capaRating['CapaRating']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRating['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRating['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRating['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRating['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRating['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRating['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
