...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($autoApprovalStep['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($autoApprovalStep['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($autoApprovalStep['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($autoApprovalStep['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("auto_approval_id"));?></th>
				<th><?php echo h(Inflector::humanize("name"));?></th>
				<th><?php echo h(Inflector::humanize("step_number"));?></th>
				<th><?php echo h(Inflector::humanize("allow_approval"));?></th>
				<th><?php echo h(Inflector::humanize("show_details"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($autoApprovalStep['AutoApproval']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($autoApprovalStep['User']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($autoApprovalStep['AutoApprovalStep']['publish']); ?>&nbsp;</td>
