        ...
        <div class="users form col-md-8">
            ...
            <div class="row">
                <fieldset><legend><h5><?php echo __('Login Details'); ?></h5></legend>
                    <div class="col-md-6"><?php echo $this->Form->input('employee_id', array('style' => 'width:100%', 'label' => __('Employee'), 
...
<?php 
            ...
            <div class="row"><br />
                <fieldset><legend><h5><?php echo __('Choose Other Details'); ?></h5></legend>
                    ...
                    <?php echo $this->Form->input('division_id', array('style' => 'width:100%', 'div' => array('class' => 'col-md-12'), 'label' => __('Division'))); ?>
                </fieldset>
            </div>

            <div class="row"><br />
                <fieldset><legend><h5><?php echo __('Choose User\'s Privileges'); ?></h5></legend>
                    <div class="col-md-12"><?php echo $this->Form->input('is_mr', array('label' => __('New admin user'))); ?></div>
