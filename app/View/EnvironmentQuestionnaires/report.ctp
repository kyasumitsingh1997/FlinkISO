...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($environmentQuestionnaire['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($environmentQuestionnaire['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($environmentQuestionnaire['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($environmentQuestionnaire['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($environmentQuestionnaire['EnvironmentQuestionnaireCategory']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($environmentQuestionnaire['EnvironmentQuestionnaire']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($environmentQuestionnaire['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentQuestionnaire['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentQuestionnaire['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentQuestionnaire['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentQuestionnaire['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentQuestionnaire['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
