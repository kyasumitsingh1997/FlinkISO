			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('ContinualImprovement',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","name"=>"Name","details"=>"Details","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#continualImprovements_ajax','type'=>'data','method'=>'post')); ?>
;									<?php echo $this->Form->end(); ?></li>
				...
				<div class="col-md-8">
					<h4><?php echo __('Continual Improvements'); ?>
...
<?php foreach ($continualImprovements as $continualImprovement): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$continualImprovement['ContinualImprovement']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $continualImprovement['ContinualImprovement']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $continualImprovement['ContinualImprovement']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $continualImprovement['ContinualImprovement']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $continualImprovement['ContinualImprovement']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $continualImprovement['ContinualImprovement']['id']),array('class'=>''), __('Are you sure ?', $continualImprovement['ContinualImprovement']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($continualImprovement['ContinualImprovement']['sr_no']); ?>&nbsp;</td>
		<td><?php echo h($continualImprovement['ContinualImprovement']['name']); ?>&nbsp;</td>
		<td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($continualImprovement['ContinualImprovement']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($continualImprovement['ContinualImprovement']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($continualImprovement['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $continualImprovement['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($continualImprovement['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $continualImprovement['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($continualImprovement['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $continualImprovement['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($continualImprovement['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $continualImprovement['PreparedBy']['id'])); ?>
		</td>
		<td>
		...
		<td>
			<?php echo $this->Html->link($continualImprovement['Company']['name'], array('controller' => 'companies', 'action' => 'view', $continualImprovement['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Form->end();?>			
			...
			'update' => '#continualImprovements_ajax',
			'evalScripts' => true,
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#continualImprovements_ajax')));?>
...
<?php echo $this->Form->create('continualImprovements',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","name"=>"Name","details"=>"Details","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
