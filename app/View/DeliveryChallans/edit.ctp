<div id="deliveryChallans_ajax">
    ...
    <script>
        ...
        $().ready(function() {
            ...
            $('#DeliveryChallanEditForm').validate({
                rules: {
		...
		if($('#DeliveryChallanEditForm').valid()){
		    $("#submit_id").prop("disabled",true);
		    $("#submit-indicator").show();
		    $("#DeliveryChallanEditForm").submit();
		}
	    });
    ...
    <div class="nav panel panel-default">
        <div class="deliveryChallans form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Delivery Challan'); ?>
