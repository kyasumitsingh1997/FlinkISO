...
<h4><?php echo __('Approve Incident Investigator'); ?>		
...
<script>
  ...
  ignore: null,
    ...
    $("#submit-indicator").hide();
        ...
        $('#IncidentInvestigatorApproveForm').validate({
              rules: {
        ...
        $("#submit_id").click(function(){
            if($('#IncidentInvestigatorApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#IncidentInvestigatorApproveForm').submit();
            }
