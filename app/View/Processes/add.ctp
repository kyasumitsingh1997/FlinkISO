...
<div class="row">
		...
		echo "<div class='col-md-12'>".$this->Form->input('process_requirments') . '</div>'; 
		...
		echo "<div class='col-md-6'>".$this->Form->input('schedule_id',array('style'=>'')) . '</div>'; 
	?>
<?php
