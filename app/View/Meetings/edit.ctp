...
<script>
    ...
    $().ready(function () {
        ...
        $("#submit_id").click(function(){
             if($('#MeetingEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#MeetingEditForm").submit();
             }
...
<div id="meetings_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="meetings form col-md-8 panel">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Meeting'); ?>
    ...
    $.ajaxSetup({
        ...
        complete: function () {
            ...
            <?php
                    ...
                    if($this->data['Meeting']['meeting_type'] == 0)echo $this->Form->input('show_on_timeline', array('type' => 'checkbox', 'label' => __('Show on Timeline')));
                    if($this->data['Meeting']['meeting_type'] == 0)echo $this->Form->input('send_email', array('type' => 'checkbox', 'label' => __('Send Emails to invitees')));
            ?>
            <?php 
