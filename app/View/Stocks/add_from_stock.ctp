...
<div  id="main">
    ...
    <div class="stocks ">
        <?php echo $this->element('nav-header-lists', array('postData' => array('pluralHumanName' => 'Stocks', 'modelClass' => 'Stock', 'options' => array("sr_no" => "Sr No", "type" => "Type", "received_date" => "Received Date", "production_date" => "Production Date", "quantity" => "Quantity", "quantity_consumed" => "Quantity Consumed", "remarks" => "Remarks"), 'pluralVar' => 'stocks','sType'=>0))); ?>
        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('production_id', __('Batch No.')); ?></th>
