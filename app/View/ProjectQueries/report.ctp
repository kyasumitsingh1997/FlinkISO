...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectQuery['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectQuery['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectQuery['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectQuery['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("query_type_id"));?></th>
				...
				<th><?php echo h(Inflector::humanize("sent_to"));?></th>
				<th><?php echo h(Inflector::humanize("query"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectQuery['QueryType']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['Milestone']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['ProjectFile']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['ProjectProcessPlan']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['Employee']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($projectQuery['ProjectQuery']['publish']); ?>&nbsp;</td>
		<td><?php echo h($projectQuery['ProjectQuery']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($projectQuery['ProjectQuery']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQuery['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
