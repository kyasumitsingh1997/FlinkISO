...
<script>
    ...
    $().ready(function() {
        ...
        $('#ListOfComputerListOfSoftwareEditForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#ListOfComputerListOfSoftwareEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#ListOfComputerListOfSoftwareEditForm").submit();
             }
        });
...
<div id="listOfComputerListOfSoftwares_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="listOfComputerListOfSoftwares form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Computer Software'); ?>
...
<script>
    $("[name*='installation_date']").datepicker({
        changeMonth: true,
        changeYear: true,
        format: 'yyyy-mm-dd',
      autoclose:true,
