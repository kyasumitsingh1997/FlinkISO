			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('ProjectReleaseRequest',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","request_status"=>"Request Status","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","prepared_by"=>"Prepared By","approved_by"=>"Approved By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#projectReleaseRequests_ajax','type'=>'data','method'=>'post')); ?>
;									<?php echo $this->Form->end(); ?></li>
				...
				<div class="col-md-8">
					<h4><?php echo __('Project Release Requests'); ?>
...
<?php foreach ($projectReleaseRequests as $projectReleaseRequest): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$projectReleaseRequest['ProjectReleaseRequest']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><span class=" glyphicon glyphicon-wrench"></span></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $projectReleaseRequest['ProjectReleaseRequest']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $projectReleaseRequest['ProjectReleaseRequest']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $projectReleaseRequest['ProjectReleaseRequest']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $projectReleaseRequest['ProjectReleaseRequest']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $projectReleaseRequest['ProjectReleaseRequest']['id']),array('class'=>''), __('Are you sure ?', $projectReleaseRequest['ProjectReleaseRequest']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($projectReleaseRequest['ProjectReleaseRequest']['sr_no']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($projectReleaseRequest['ProjectReleaseRequest']['request_status']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($projectReleaseRequest['ProjectReleaseRequest']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($projectReleaseRequest['ProjectReleaseRequest']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($projectReleaseRequest['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $projectReleaseRequest['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectReleaseRequest['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $projectReleaseRequest['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectReleaseRequest['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $projectReleaseRequest['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectReleaseRequest['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $projectReleaseRequest['ApprovedBy']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Form->end();?>			
			...
			'update' => '#projectReleaseRequests_ajax',
			'evalScripts' => true,
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#projectReleaseRequests_ajax')));?>
...
<?php echo $this->Form->create('projectReleaseRequests',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","request_status"=>"Request Status","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","prepared_by"=>"Prepared By","approved_by"=>"Approved By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
