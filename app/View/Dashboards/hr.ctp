                        ...
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?php echo $this->Html->link(' ' . $this->requestAction('App/get_model_list/Employee/count'), array('controller' => 'employees', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('No. of Employees'))); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?php echo $this->Html->link(' ' . count($this->requestAction('App/get_model_list/Course')), array('controller' => 'courses', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'top', 'data-toggle' => 'tooltip', 'title' => __('No. of Courses'))); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?php echo $this->Html->link(' ' . count($this->requestAction('App/get_model_list/TrainingNeedIdentification')), array('controller' => 'training_need_identifications', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'top', 'data-toggle' => 'tooltip', 'title' => __(' No. of Training Need Identifications'))); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?php echo $this->Html->link(' ' . count($this->requestAction('App/get_model_list/Training')), array('controller' => 'trainings', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'top', 'data-toggle' => 'tooltip', 'title' => __('No. of Trainings'))); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?php echo $this->Html->link(' ' . count($this->requestAction('App/get_model_list/TrainingEvaluation')), array('controller' => 'training_evaluations', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('No. of Training Evaluations'))); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?php echo $this->Html->link(' ' . count($this->requestAction('App/get_model_list/CompetencyMapping')), array('controller' => 'competency_mappings', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('No. of Competency Mappings'))); ?><script>$('.btn').tooltip();</script>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="thumbnail">
                            <div class="caption">
                                ...
                                <div class="btn-group">
                                    ...
                                    <?php echo $this->Html->link(' ' . count($this->requestAction('App/get_model_list/Appraisal')), array('controller' => 'appraisals', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('No. of Appraisals'))); ?><script>$('.btn').tooltip();</script>
                                </div>
                            </div>
                        </div>
                    </div>
