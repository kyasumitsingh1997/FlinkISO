...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fileTracking['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fileTracking['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fileTracking['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fileTracking['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("project_file_id"));?></th>
				<th><?php echo h(Inflector::humanize("project_id"));?></th>
				<th><?php echo h(Inflector::humanize("milestone_id"));?></th>
				<th><?php echo h(Inflector::humanize("from"));?></th>
				<th><?php echo h(Inflector::humanize("to"));?></th>
				<th><?php echo h(Inflector::humanize("by"));?></th>
				<th><?php echo h(Inflector::humanize("current_status"));?></th>
				<th><?php echo h(Inflector::humanize("changed_on"));?></th>
				<th><?php echo h(Inflector::humanize("changetype"));?></th>
				<th><?php echo h(Inflector::humanize("function"));?></th>
				<th><?php echo h(Inflector::humanize("comment"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($fileTracking['ProjectFile']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileTracking['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileTracking['Milestone']['title']); ?>&nbsp;</td>
		...
		<td><?php echo h($fileTracking['FileTracking']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fileTracking['FileTracking']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fileTracking['FileTracking']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileTracking['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileTracking['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileTracking['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileTracking['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
