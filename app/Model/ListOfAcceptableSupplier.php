...
/**
 * ListOfAcceptableSupplier Model
 *
 ...
 */
class ListOfAcceptableSupplier extends AppModel {
 ...
 */
	public $validate = array(
		...
		'supplier_evaluation_tempplate_id' => array(
			'notBlank' => array(
				'rule' => array('notBlank'),
			),
		),
 ...
 */
	public $belongsTo = array(
		...
		'SupplierEvaluationTemplate' => array(
			'className' => 'SupplierEvaluationTemplate',
			'foreignKey' => 'supplier_evaluation_template_id',
			'conditions' => '',
			'fields' => array('id', 'title'),
			'order' => ''
		),
