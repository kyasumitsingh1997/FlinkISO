...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#SupplierRegistrationApproveForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#SupplierRegistrationApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#SupplierRegistrationApproveForm").submit();
             }
...
<div id="supplierRegistrations_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="supplierRegistrations form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Supplier Registration'); ?>
