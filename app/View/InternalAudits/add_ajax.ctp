    ...
    $.validator.setDefaults({
        ...
        submitHandler: function (form) {
            ...
            $(form).ajaxSubmit({
                ...
                type: 'POST',
                target: '#internalAudits_tab_ajax',
                beforeSend: function(){
                ...
                <div class="panel-body">
                    ...
                    <ul class="nav nav-tabs">
                        <?php foreach ($PublishedBranchList as $key => $value): ?>
                            <li><?php echo $this->Html->link($value . ' <span class="badge btn-info">' . count($plan[$key]) . '</span>', '#' . $key, array('data-toggle' => 'tab', 'escape' => false, 'onclick' => 'intAuditCheck(0)'), array()); ?>
...
<!--                                     <tr><?php echo ('<th>' . __('Department') . '</th><th>' . __('Clauses') . '</th><th>' . __('Auditee') . '</th><th>' . __('Auditor') . '</th><th>' . __('Time') . '</th>'); ?>
                                        <?php if (isset($this->request->params['pass'][1]) && $this->request->params['pass'][1] == 1) echo '<th>' . __('Add Findings') . '</th>'; ?>
                                    </tr> -->
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $department['ListOfTrainedInternalAuditor']['name'] ?></td>
                                        ...
                                        <?php
                                            if (isset($this->request->params['pass'][1]) && $this->request->params['pass'][1] == 1)
                                                echo "<td><div class='btn-group-vertical'>" . $this->Html->link(__('Add Findings'), '#add_details', array('class' => 'btn btn-xs btn-info', 'onClick' => 'getVals("' . 
                                                        $department['InternalAuditPlanDepartment']['branch_id'] . '","' . 
                                                        $department['InternalAuditPlanDepartment']['department_id'] . '","' . 
                                                        $department['InternalAuditPlanDepartment']['process_id'] . '","' . 
                                                        $department['InternalAuditPlanDepartment']['risk_assessment_id'] . '","' . 
                                                        $department['InternalAuditPlanDepartment']['list_of_trained_internal_auditor_id'] . '","' . 
                                                        $department['Employee']['id'] . '","' . 
                                                        $department['InternalAuditPlanDepartment']['clauses'] . '","' . 
                                                        date('yyyy-MM-dd',strtotime($department['InternalAuditPlanDepartment']['start_time'])) . '","' . 
                                                        date('yyyy-MM-dd',strtotime($department['InternalAuditPlanDepartment']['end_time'])) . '")'));
                                            echo "</div></td>";
                                        ?>
                                    </tr>
        ...
        <?php } ?>
            ...
            <div class="panel panel-default" id="add_details" style="display:none;">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo __('Add Audit Findings'); ?><span class="glyphicon glyphicon-remove pull-right text-danger" onclick="intAuditCheck(0)"></span></h3>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4"><?php echo $this->Form->input('start_time',array('label'=>'Start Date - End Date')); ?></div>
                        <!-- <div class="col-md-6"><?php echo $this->Form->input('end_time'); ?></div> -->
                        <div class="col-md-4"><?php echo $this->Form->input('clauses'); ?></div>
                        <div class="col-md-4"><?php echo $this->Form->input('section'); ?></div>
                        <div class="col-md-12"><?php echo $this->Form->input('process_id'); ?></div>
                        <div class="col-md-12"><?php echo $this->Form->input('risk_assessment_id'); ?></div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12"><?php echo $this->Form->input('opportunities_for_improvement'); ?></div>
                        ...
                        <div class="col-md-4">
                            <?php
                            echo "<label>" . __('Capa Priority') . "</label><br />";
                        ...
                        <div class="col-md-4">
                             <?php echo "<label>" . __('Current Capa Status') . "</label><br />";
                        ...
                        <div class="col-md-12">
                             <?php echo $this->Form->input('proposed_immidiate_action',array('type'=>'textarea','disabled','value'=>'Create CAPA and assign to user')); ?>
                        </div>
                    ...
                    <?php echo $this->Form->submit(__('Cancel'), array('type' => 'reset', 'div' => false, 'class' => 'btn btn-primary btn-danger', 'onclick'=>'intAuditCheck(0)', 'style' => 'margin-left:5px;')); ?>
        ...
        <?php if (isset($internalAudits)) { ?>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title"><?php echo __('Audit Findings'); ?></div>
                </div>
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                                                ...
                                                <div class="panel-collapse collapse" id="<?php echo $internalAudit['InternalAudit']['id'] ?>">
                                                    <div class="panel-body">
                                                        <dl>
                                                            ...
                                                            <dd><?php echo $internalAudit['Branch']['name'] ?>&nbsp; </dd>

                                                            <dt><?php echo __('Department : '); ?></dt>
                                                            <dd><?php echo $internalAudit['Department']['name'] ?>&nbsp; </dd>

                                                            <dt><?php echo __('Date : '); ?></dt>
                                                            <dd><?php echo date('d M Y',strtotime($internalAudit['InternalAudit']['start_time'])) .' To'. date('d M Y',strtotime($internalAudit['InternalAudit']['end_time'])) ?>&nbsp; </dd>
                                                            
                                                            <dt><?php echo __('Auditee'); ?></dt>
                                                            <dd><?php echo $internalAudit['Employee']['name'] ?>&nbsp; </dd>
                                                            
                                                            <dt><?php echo __('Auditor'); ?></dt>
                                                            <dd><?php echo $listOfTrainedInternalAuditors[$internalAudit['ListOfTrainedInternalAuditor']['id']] ?>&nbsp; </dd>
                                                            
                                                            <dt><?php echo __('Process'); ?></dt>
                                                            <dd><?php echo $internalAudit['Process']['title'] ?>&nbsp; </dd>

                                                            <dt><?php echo __('Risk'); ?></dt>
                                                            <dd><?php echo $internalAudit['RiskAssessment']['title'] ?>&nbsp; </dd>

                                                            <dt><?php echo __('Clauses'); ?></dt>
                                                            <dd><?php echo $internalAudit['InternalAudit']['clauses'] ?>&nbsp; </dd>

                                                            <dt><?php echo __('Section'); ?></dt>
                                                            <dd><?php echo $internalAudit['InternalAudit']['section'] ?>&nbsp; </dd>
                                                            
                                                            <dt><?php echo __('Question asked'); ?></dt>
                                                            <dd><?php echo $internalAudit['InternalAudit']['question_asked'] ?>&nbsp; </dd>
                                                            
                                                            <dt><?php echo __('Findings'); ?></dt>
                                                            <dd><?php echo $internalAudit['InternalAudit']['finding'] ?>&nbsp; </dd>
                                                            
                                                            <dt><?php echo __('Current Status'); ?></dt>
                                                            <dd><?php echo $internalAudit['InternalAudit']['current_status'] ?>&nbsp; </dd>
                                                            
                                                            <?php if($internalAudit['InternalAudit']['non_conformity_found'] == 1) { ?>
                                                            <dt><?php echo __('CAPA Source'); ?></dt>
                                                            <dd><?php echo $capaSources[$internalAudit['CorrectivePreventiveAction']['capa_source_id']]; ?>&nbsp; </dd>
                                                            ...
                                                            <dt><?php echo __('Notes'); ?></dt>
                                                            <dd><?php echo $internalAudit['InternalAudit']['notes'] ?>&nbsp; </dd>
                                                        </dl>
...
<script>
    $("#InternalAuditStartTime").daterangepicker({
        format: 'MM/DD/YYYY',
        minDate : '<?php echo date("m-d-Y",strtotime($internalAuditPlan["InternalAuditPlan"]["schedule_date_from"])) ;?>',
        maxDate : '<?php echo date("m-d-Y",strtotime($internalAuditPlan["InternalAuditPlan"]["schedule_date_to"])) ;?>',
...
<script>
    function getVals(branchid, departmentid, processid, riskAssessmentid, auditor, auditee, claues, start_time, end_time) {
        ...
        $('#InternalAuditProcessId').val(processid).trigger('chosen:updated');;
        $('#InternalAuditRiskAssessmentId').val(riskAssessmentid).trigger('chosen:updated');;
        $('#InternalAuditClauses').val(claues);
        $('#InternalAuditStartTime').val(start_time + ' - ' + end_time);
    ...
    function intAuditCheck(dispSwitch){
        if(dispSwitch == 0)
            $('#add_details').hide();
        else
            $('#add_details').show();
    ...
    function SelectCapa() {
        ...
        if ($('#InternalAuditNonConformityFound').is(':checked') == true) {
            ...
            $('#InternalAuditProposedImmidiateAction').attr('disabled', false);
            ...
            $('#InternalAuditTargetDate').attr('disabled', true);
            $('#InternalAuditProposedImmidiateAction').attr('disabled', true);
