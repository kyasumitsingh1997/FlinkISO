    ...
    public function appraisal_notification_email($employeeId = null, $token = null) {
        if (isset($employeeId) && isset($token)) {
            ...
            try{
                ...
                $EmailConfig->viewVars(array('baseurl' => $baseurl, 'recipientName' => $appraisalInfo['Employee']['name'], 'appraiserName' => $appraisalInfo['AppraiserBy']['name'], 'appraiserEmail' => $appraisalInfo['AppraiserBy']['office_email'], 'appraisalDate' => $appraisalInfo['Appraisal']['appraisal_date'],'env' => $env, 'app_url' => FULL_BASE_URL));
