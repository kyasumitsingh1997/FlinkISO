<div id="deliveryChallans_ajax">
    ...
    <script>
        ...
        $().ready(function() {
            // $("#MeetingTopicActionTakenDate").datepicker("setDate", new Date);
            $("#DeliveryChallanChallanDate").datepicker("setDate", new Date);
            $("#DeliveryChallanShippingDate").datepicker("setDate", new Date);
            $("#DeliveryChallanAcknowledgementDate").datepicker("setDate", new Date);
    ...
    <div class="nav">
        <div class="deliveryChallans form col-md-8">
            ...
            <div class="row">
                <div class="col-md-6"><?php echo $this->Form->input('challan_number',array('default'=>$dcNumber)); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6"><?php echo $this->Form->input('payment_details',array('default'=>'Cheque')); ?></div>
                ...
                <div class="col-md-6"><?php echo $this->Form->input('branch_id', array('default'=>$this->Session->read('User.branch_id'), 'style' => 'width:100%', 'label' => __('Branch'))); ?></div>
                <div class="col-md-6"><?php echo $this->Form->input('department_id', array('default'=>$this->Session->read('User.department_id'),'style' => 'width:100%', 'label' => __('Department'))); ?></div>
