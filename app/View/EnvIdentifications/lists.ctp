...
<?php echo $this->Session->flash();?>	
	<div class="envIdentifications ">
		...
		<div class="nav">
			<div id="tabs">	
				<ul>
					<li><?php echo $this->Html->link(__('New Env Identification'), array('action' => 'add_ajax')); ?></li>
					...
					<li><?php // echo $this->Html->link(__('Add Env Impact'), array('controller' => 'env_impacts', 'action' => 'add_ajax')); ?> </li>
					<li><?php echo $this->Html->image('indicator.gif', array('id' => 'busy-indicator','class'=>'pull-right')); ?></li>
				</ul>
			</div>
		</div>
	<div id="envIdentifications_tab_ajax"></div>
</div>
