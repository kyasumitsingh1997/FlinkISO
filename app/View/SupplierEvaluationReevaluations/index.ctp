...
$(function() {
            $('#SupplierEvaluationReevaluationDateRange').daterangepicker();
        });
...
<div  id="main">
    ...
    <div class="supplierEvaluationReevaluations ">
        <div class="panel panel-default from add_ajax">
            <div class="row">
                    <?php echo $this->Form->create('SupplierEvaluationReevaluation', array('role' => 'from', 'class' => 'from'));?> 
                    <div class="col-md-7">
                        <?php echo $this->Form->input('supplier_registration_id', array('label' => __('Select Supplier from the list to evaluate.'))); ?>
                    </div>
                    <div class="col-md-4">
                        <?php echo $this->Form->input('date_range', array()); ?>
                    </div>
                    <div class="col-md-1"><br />
                        <?php 
                            echo $this->Js->submit('Search', array( 'url' => array('controller' => 'supplier_evaluation_reevaluations', 'action' => 'evaluate'), 'update' => '#sup-eval','div' => false,'type' => 'json','async' => false,'class'=>'btn btn-sm btn-success'));
