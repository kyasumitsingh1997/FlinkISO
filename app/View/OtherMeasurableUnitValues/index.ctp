...
<?php echo $this->Session->flash();?>	
	<div class="otherMeasurableUnitValues ">
		<?php echo $this->element('nav-header-lists',array('postData'=>array('pluralHumanName'=>'Other Measurable Unit Values','modelClass'=>'OtherMeasurableUnitValue','options'=>array("sr_no"=>"Sr No","value"=>"Value"),'pluralVar'=>'otherMeasurableUnitValues'))); ?>
...
<?php foreach ($otherMeasurableUnitValues as $otherMeasurableUnitValue): ?>
	<tr>
	<td class=" actions">	<?php echo $this->element('actions', array('created' => $otherMeasurableUnitValue['OtherMeasurableUnitValue']['created_by'], 'postVal' => $otherMeasurableUnitValue['OtherMeasurableUnitValue']['id'], 'softDelete' => $otherMeasurableUnitValue['OtherMeasurableUnitValue']['soft_delete'])); ?>	</td>		<td>
		...
		<td><?php echo h($PublishedEmployeeList[$otherMeasurableUnitValue['OtherMeasurableUnitValue']['prepared_by']]); ?>&nbsp;</td>
		<td><?php echo h($PublishedEmployeeList[$otherMeasurableUnitValue['OtherMeasurableUnitValue']['approved_by']]); ?>&nbsp;</td>
...
<?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","value"=>"Value"),'PublishedBranchList'=>array($PublishedBranchList))); ?>
<?php echo $this->element('import',array('postData'=>array("sr_no"=>"Sr No","value"=>"Value"))); ?>
