...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($incidentWitness['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($incidentWitness['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($incidentWitness['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($incidentWitness['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("investigation_interview_taken_by"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($incidentWitness['Incident']['title']); ?>&nbsp;</td>
		<td><?php echo h($incidentWitness['IncidentWitness']['person_type']); ?>&nbsp;</td>
		<td width="50"><?php echo h($incidentWitness['Employee']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($incidentWitness['Department']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($incidentWitness['Designation']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($incidentWitness['IncidentWitness']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($incidentWitness['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($incidentWitness['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($incidentWitness['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($incidentWitness['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($incidentWitness['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
