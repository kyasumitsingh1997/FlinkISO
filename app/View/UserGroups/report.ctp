...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($userGroup['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($userGroup['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($userGroup['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($userGroup['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("group_leader"));?></th>
				<th><?php echo h(Inflector::humanize("group_members"));?></th>
	...
	<tr>
		...
		<td><?php echo h($userGroup['UserGroup']['publish']); ?>&nbsp;</td>
		<td><?php echo h($userGroup['UserGroup']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($userGroup['UserGroup']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userGroup['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userGroup['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userGroup['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userGroup['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userGroup['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
