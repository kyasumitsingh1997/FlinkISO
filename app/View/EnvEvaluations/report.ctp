...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($envEvaluation['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($envEvaluation['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($envEvaluation['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($envEvaluation['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("env_indentification_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($envEvaluation['EnvActivity']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envEvaluation['EnvIdentification']['title']); ?>&nbsp;</td>
		...
		<td><?php echo h($envEvaluation['EnvEvaluation']['publish']); ?>&nbsp;</td>
		<td><?php echo h($envEvaluation['EnvEvaluation']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($envEvaluation['EnvEvaluation']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envEvaluation['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envEvaluation['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envEvaluation['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envEvaluation['PreparedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
