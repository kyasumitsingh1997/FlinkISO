...
<div class="modal fade" id="deleteAllSent" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="btn-group">
                <?php echo $this->Form->submit('Yes', array('class' => 'btn  btn-sm btn-success','div'=>false)); ?>
                <?php echo $this->Form->button('No', array('class' => 'btn btn-sm btn-warning','div'=>false, 'data-dismiss' => "modal")); ?>
            </div>
            <?php echo $this->Form->end(); ?>
        </div>
    </div>
