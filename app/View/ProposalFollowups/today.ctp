...
<div  id="main">
    ...
    <div class="proposalFollowups ">
        <?php echo $this->element('nav-header-lists', array('postData' => array('pluralHumanName' => 'Today\'s Proposal Followups', 'modelClass' => 'ProposalFollowup', 'options' => array("sr_no" => "Sr No", "followup_heading" => "Followup Heading", "followup_details" => "Followup Details", "next_follow_up_date" => "Next Follow Up Date", "status" => "Status"), 'pluralVar' => 'proposalFollowups'))); ?>
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('proposal_id'); ?></th>
					  <th><?php echo $this->Paginator->sort('followup_type'); ?></th>
                    <th><?php echo $this->Paginator->sort('followup_assigned_to'); ?></th>
                ...
                <tr class="on_page_src">
                    ...
                    <td>
					  ...
					  <td><?php echo h($proposalFollowup['ProposalFollowup']['followup_type']); ?>&nbsp;</td>
                    <td>
                        <?php echo $this->Html->link($proposalFollowup['FollowupAssignedTo']['name'], array('controller' => 'employees', 'action' => 'view', $proposalFollowup['FollowupAssignedTo']['id'])); ?>
                    </td>
