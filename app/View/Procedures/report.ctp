...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($procedure['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($procedure['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($procedure['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($procedure['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("number"));?></th>
	...
	<tr>
		...
		<td><?php echo h($procedure['Procedure']['publish']); ?>&nbsp;</td>
		<td><?php echo h($procedure['Procedure']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($procedure['Procedure']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($procedure['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($procedure['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($procedure['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($procedure['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($procedure['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($procedure['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
