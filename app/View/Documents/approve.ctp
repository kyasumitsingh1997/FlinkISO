...
<h4><?php echo __('Approve Document'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('Document',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
		echo "<div class='col-md-6'>".$this->Form->input('title') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('document_number') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('issue_number') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('revision_number') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('revision_date') . '</div>'; 
		echo "<div class='col-md-12'>".$this->Form->input('content') . '</div>'; 
