...
<div class="materialQualityCheckDetails form col-md-12">
    ...
    <?php echo $this->Form->input('delivery_challan_detail_id',array('type'=>'hidden','value'=>$deliveryChallanDetail['DeliveryChallanDetail']['id'])); ?>
...
<?php } ?>
	  ...
	  echo $this->Form->submit('Add to stock',array('class'=>'btn btn-primary btn-success','id'=>'submit_id')); ?>
