...
<script>
    ...
    $().ready(function() {
        $("#submit-indicator").hide();
        $('#NotificationTypeAddAjaxForm').validate();
    });
</script>
...
<div id="notificationTypes_ajax">
    <?php echo $this->Session->flash(); ?><div class="nav">
        <div class="notificationTypes form col-md-8">
            <h4><?php __('Add Notification Type'); ?></h4>
            <?php echo $this->Form->create('NotificationType', array('role' => 'form', 'class' => 'form', 'default' => false)); ?>
            ...
            ?>
            <?php echo $this->Form->submit(__('Submit'), array('div' => false, 'class' => 'btn btn-primary btn-success', 'update' => '#notificationTypes_ajax', 'async' => 'false','id'=>'submit_id')); ?>
