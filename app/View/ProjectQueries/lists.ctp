...
<?php echo $this->Session->flash();?>	
	<div class="projectQueries ">
		...
		<div class="nav">
			<div id="tabs">	
				<ul>
					<li><?php echo $this->Html->link(__('New Project Query'), array('action' => 'add_ajax')); ?></li>
					<li><?php // echo $this->Html->link(__('Add Query Type'), array('controller' => 'query_types', 'action' => 'add_ajax')); ?> </li>
					...
					<li><?php // echo $this->Html->link(__('Add Project Query Response'), array('controller' => 'project_query_responses', 'action' => 'add_ajax')); ?> </li>
					<li><?php echo $this->Html->image('indicator.gif', array('id' => 'busy-indicator','class'=>'pull-right')); ?></li>
				</ul>
			</div>
		</div>
	<div id="projectQueries_tab_ajax"></div>
</div>
