...
<script>
    ...
    $().ready(function () {
        ...
        $('#SummeryOfSupplierEvaluationEditForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#SummeryOfSupplierEvaluationEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#SummeryOfSupplierEvaluationEditForm").submit();
             }
        });
...
<div id="summeryOfSupplierEvaluations_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="summeryOfSupplierEvaluations form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Summary Of Supplier Evaluation'); ?>
