...
<script>
    ...
    $().ready(function() {
        ...
        $('#CustomerMeetingAddFollowupsForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#CustomerMeetingAddFollowupsForm').valid()){
                 $("#CustomerMeetingCustomerId").prop("disabled",false);
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#CustomerMeetingAddFollowupsForm").submit();
             }
        });
...
<div id="customerMeetings_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="customerMeetings form col-md-8">
            <h4><?php echo __('Add Follow up'); ?>
                <?php echo $this->Html->link(__('List'), array('action' => 'index'), array('id' => 'list', 'class' => 'label btn-info')); ?>
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            </h4>
            <?php echo $this->Form->create('CustomerMeeting', array('role' => 'form', 'class' => 'form')); ?>
            <div class="row">
                <div class="col-md-6"><?php echo $this->Form->input('customer_id', array('disabled' => 'disabled')); ?></div>
                ...
                <div class="col-md-6"><?php echo $this->Form->input('followup_id', array('type' => 'hidden', 'value' => $followupId)); ?></div>
