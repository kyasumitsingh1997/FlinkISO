<div  id="main">
    ...
    <div class="productions ">
        ...
        <div class="nav">
            <div id="tabs">
                <ul>
                    <li><?php echo $this->Html->link(__('New Production'), array('action' => 'add_ajax','product_id'=>$this->request->params['named']['product_id'],'production_weekly_plan_id'=>$this->request->params['named']['production_weekly_plan_id'])); ?></li>
