...
class CustomerMeetingsController extends AppController {
    ...
    public function delete($id = null) {
        ...
        if (!empty($id)) {
            ...
            $data['CustomerMeeting']['model_action'] = $this->params['action'];
            $data['CustomerMeeting']['system_table_id'] = $this->_get_system_table_id();
            $modelName = $this->modelClass;
            $this->$modelName->save($data['CustomerMeeting'], false);
    ...
    public function delete_all($id = null) {
        ...
        if (!empty($ids)) {
            foreach ($ids as $id) {
             ...
             if(isset($id) &&  isset($data['CustomerMeeting'])){
                $data['CustomerMeeting']['model_action'] = $this->params['action'];
                $data['CustomerMeeting']['system_table_id'] = $this->_get_system_table_id();
                $modelName = $this->modelClass;
                $this->$modelName->save($data['CustomerMeeting'], false);
