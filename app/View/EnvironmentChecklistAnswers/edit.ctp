...
<?php echo $this->Form->create('EnvironmentChecklistAnswer'); ?>
	<fieldset>
		<legend><?php echo __('Edit Environment Checklist Answer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EnvironmentChecklistAnswer.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EnvironmentChecklistAnswer.id'))); ?></li>
