...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fmeaAction['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fmeaAction['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fmeaAction['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fmeaAction['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("fmea_id"));?></th>
				<th><?php echo h(Inflector::humanize("employee_id"));?></th>
				<th><?php echo h(Inflector::humanize("actions_recommended"));?></th>
				<th><?php echo h(Inflector::humanize("target_date"));?></th>
				<th><?php echo h(Inflector::humanize("action_taken"));?></th>
				<th><?php echo h(Inflector::humanize("action_taken_date"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($fmeaAction['Fmea']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaAction['Employee']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($fmeaAction['FmeaSeverityType']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaAction['FmeaOccurence']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaAction['FmeaDetection']['id']); ?>&nbsp;</td>
		<td><?php echo h($fmeaAction['FmeaAction']['rpn']); ?>&nbsp;</td>
		<td><?php echo h($fmeaAction['FmeaAction']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fmeaAction['FmeaAction']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fmeaAction['FmeaAction']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaAction['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaAction['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaAction['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaAction['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaAction['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
