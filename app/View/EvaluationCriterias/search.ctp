			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('Aspect',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									...
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#aspects_ajax','type'=>'data','method'=>'post')); ?>
...
<?php foreach ($aspects as $aspect): ?>
	<tr>
		...
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View'), array('action' => 'view', $aspect['Aspect']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $aspect['Aspect']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $aspect['Aspect']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $aspect['Aspect']['id'])); ?></li>
				<li class="divider"></li>
				...
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $aspect['Aspect']['id']),array('class'=>''), __('Are you sure ?', $aspect['Aspect']['id'])); ?></li>
			</ul>
		</div>
		</td>
		...
		<td>
			<?php echo $this->Html->link($aspect['AspectCategory']['name'], array('controller' => 'aspect_categories', 'action' => 'view', $aspect['AspectCategory']['id'])); ?>
		</td>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#aspects_ajax')));?>
