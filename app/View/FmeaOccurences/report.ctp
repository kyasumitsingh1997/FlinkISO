...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fmeaOccurence['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fmeaOccurence['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fmeaOccurence['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fmeaOccurence['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("probability_of_failure"));?></th>
				<th><?php echo h(Inflector::humanize("possible_failure_rates"));?></th>
				<th><?php echo h(Inflector::humanize("cpk"));?></th>
	...
	<tr>
		...
		<td><?php echo h($fmeaOccurence['FmeaOccurence']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fmeaOccurence['FmeaOccurence']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fmeaOccurence['FmeaOccurence']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaOccurence['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaOccurence['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaOccurence['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaOccurence['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaOccurence['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
