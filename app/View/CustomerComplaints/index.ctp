            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                ?>
                    ...
                    <td><?php
                        ...
                        ?>&nbsp;</td>
                    <td><?php if($customerComplaint['CustomerComplaint']['complaint_date'] != '1970-01-01')echo h($customerComplaint['CustomerComplaint']['complaint_date']); ?>&nbsp;</td>
                    <td>
                    ...
                    <td><?php if($customerComplaint['CustomerComplaint']['target_date'] != '1970-01-01')echo h($customerComplaint['CustomerComplaint']['target_date']); ?>&nbsp;</td>
                    <td><?php echo $customerComplaint['CustomerComplaint']['current_status'] ? __('Close') : __('Open'); ?>&nbsp;</td>
                    <td><?php if($customerComplaint['CustomerComplaint']['settled_date'] != '1970-01-01')echo h($customerComplaint['CustomerComplaint']['settled_date']); ?>&nbsp;</td>
