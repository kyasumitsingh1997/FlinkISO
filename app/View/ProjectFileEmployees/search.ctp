			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('ProjectFileEmployee',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									...
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#projectFileEmployees_ajax','type'=>'data','method'=>'post')); ?>
;									<?php echo $this->Form->end(); ?></li>
				...
				<div class="col-md-8">
					<h4><?php echo __('Project File Employees'); ?>
...
<?php foreach ($projectFileEmployees as $projectFileEmployee): ?>
	<tr>
		...
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><span class=" glyphicon glyphicon-wrench"></span></button>
				...
				<li><?php echo $this->Html->link(__('View'), array('action' => 'view', $projectFileEmployee['ProjectFileEmployee']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $projectFileEmployee['ProjectFileEmployee']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $projectFileEmployee['ProjectFileEmployee']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $projectFileEmployee['ProjectFileEmployee']['id'])); ?></li>
				<li class="divider"></li>
				...
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $projectFileEmployee['ProjectFileEmployee']['id']),array('class'=>''), __('Are you sure ?', $projectFileEmployee['ProjectFileEmployee']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($projectFileEmployee['ProjectFileEmployee']['sr_no']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($projectFileEmployee['ProjectFileEmployee']['current_status']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($projectFileEmployee['ProjectFileEmployee']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($projectFileEmployee['ProjectFileEmployee']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($projectFileEmployee['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $projectFileEmployee['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectFileEmployee['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $projectFileEmployee['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectFileEmployee['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $projectFileEmployee['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectFileEmployee['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $projectFileEmployee['ApprovedBy']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php } ?>
			...
			'update' => '#projectFileEmployees_ajax',
			'evalScripts' => true,
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#projectFileEmployees_ajax')));?>
