...
class NotificationTypesController extends AppController {
    ...
    public function advanced_search() {
        ...
        if ($this->request->query['from-date']) {
            $conditions[] = array('NotificationType.created >' => date('Y-m-d h:i:s', strtotime($this->request->query['from-date'])), 'NotificationType.created <' => date('Y-m-d h:i:s', strtotime($this->request->query['to-date'])));
        }
