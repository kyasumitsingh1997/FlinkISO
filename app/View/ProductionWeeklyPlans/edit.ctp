...
<?php echo $this->fetch('script'); ?><div id="productionWeeklyPlans_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="productionWeeklyPlans form col-md-8">
	<h4><?php echo __('Planned'); ?>       
...
<h4><?php echo __('Edit Production Weekly Plan'); ?></h4>
...
<script>
    $.validator.setDefaults({
    	...
    	errorPlacement: function(error, element) {
			...
			$(element).attr('name') == 'data[ProductionWeeklyPlan][product_id]')
						{	
    ...
    $().ready(function() {
        ...
        $("#ProductionWeeklyPlanProductionPlanned").on('change',function(){
            if($("#ProductionWeeklyPlanProductionPlanned").val() < <?php echo $total;?>){
                alert('Value can not be less then <?php echo $total;?>');
                $("#ProductionWeeklyPlanProductionPlanned").val(<?php echo $this->data['ProductionWeeklyPlan']['production_planned'];?>);
                return false;
            }
        });
        ...
        $('#ProductionWeeklyPlanEditForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProductionWeeklyPlanEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProductionWeeklyPlanEditForm').submit();
            }
