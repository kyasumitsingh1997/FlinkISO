...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fmea['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fmea['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fmea['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fmea['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("process_step"));?></th>
				<th><?php echo h(Inflector::humanize("process_sub_step"));?></th>
				<th><?php echo h(Inflector::humanize("contribution_of_sub_step"));?></th>
				<th><?php echo h(Inflector::humanize("potential_failure_mode"));?></th>
				<th><?php echo h(Inflector::humanize("potential_failure_effects"));?></th>
				<th><?php echo h(Inflector::humanize("fmea_severity_type_id"));?></th>
				<th><?php echo h(Inflector::humanize("potential_causes"));?></th>
				<th><?php echo h(Inflector::humanize("fmea_occurence_id"));?></th>
				<th><?php echo h(Inflector::humanize("current_controls"));?></th>
				<th><?php echo h(Inflector::humanize("fmea_detection_id"));?></th>
				<th><?php echo h(Inflector::humanize("rpn"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($fmea['Process']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmea['Product']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($fmea['FmeaSeverityType']['id']); ?>&nbsp;</td>
		<td><?php echo h($fmea['Fmea']['potential_causes']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmea['FmeaOccurence']['id']); ?>&nbsp;</td>
		<td><?php echo h($fmea['Fmea']['current_controls']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmea['FmeaDetection']['id']); ?>&nbsp;</td>
		<td><?php echo h($fmea['Fmea']['rpn']); ?>&nbsp;</td>
		<td><?php echo h($fmea['Fmea']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fmea['Fmea']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fmea['Fmea']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmea['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmea['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmea['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmea['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmea['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
