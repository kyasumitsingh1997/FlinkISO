<style type="text/css">
    .ui-tabs-panel{min-height: 900px}
</style>
<div  id="main">
        ...
        <div class="nav">
            <div id="tabs">
                <ul>
                    ...
                    <li><?php echo $this->Html->link(__('Add Internal Auditor'), array('controller'=>'list_of_trained_internal_auditors','action'=>'add_ajax')); ?></li>
