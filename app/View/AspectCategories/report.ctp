...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($aspectCategory['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($aspectCategory['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($aspectCategory['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($aspectCategory['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($aspectCategory['AspectCategory']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($aspectCategory['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($aspectCategory['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($aspectCategory['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($aspectCategory['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($aspectCategory['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($aspectCategory['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
