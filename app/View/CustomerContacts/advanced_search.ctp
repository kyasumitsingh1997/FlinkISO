			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('CustomerContact',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","name"=>"Name","phone"=>"Phone","mobile"=>"Mobile","email"=>"Email","address"=>"Address","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#customerContacts_ajax','type'=>'data','method'=>'post')); ?>
;									<?php echo $this->Form->end(); ?></li>
				...
				<div class="col-md-8">
					<h4><?php echo __('Customer Contacts'); ?>
...
<?php foreach ($customerContacts as $customerContact): ?>
	<tr class="on_page_src">
                    <td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$customerContact['CustomerContact']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $customerContact['CustomerContact']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $customerContact['CustomerContact']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $customerContact['CustomerContact']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $customerContact['CustomerContact']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $customerContact['CustomerContact']['id']),array('class'=>''), __('Are you sure ?', $customerContact['CustomerContact']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($customerContact['CustomerContact']['sr_no']); ?>&nbsp;</td>
		...
		<td><?php echo h($customerContact['CustomerContact']['address']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($customerContact['CustomerContact']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($customerContact['CustomerContact']['status_user_id']); ?>&nbsp;</td>
		<td><?php echo h($customerContact['CustomerContact']['branchid']); ?>&nbsp;</td>
		<td><?php echo h($customerContact['CustomerContact']['departmentid']); ?>&nbsp;</td>
		<td><?php echo h($customerContact['CustomerContact']['state_id']); ?>&nbsp;</td>
		<td><?php echo h($customerContact['CustomerContact']['approved_by']); ?>&nbsp;</td>
		<td><?php echo h($customerContact['CustomerContact']['prepared_by']); ?>&nbsp;</td>
		<td><?php echo h($customerContact['CustomerContact']['company_id']); ?>&nbsp;</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#customerContacts_ajax')));?>
...
<?php echo $this->Form->create('customerContacts',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","name"=>"Name","phone"=>"Phone","mobile"=>"Mobile","email"=>"Email","address"=>"Address","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
