    ...
    public function add_ajax() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->TrainingNeedIdentification->save($this->request->data)) {
                ...
                if ($this->_show_approvals()){ $this->_save_approvals ('tni',$this->request->data); }
                elseif($this->request->data['TrainingNeedIdentification']['publish'] == 1){
                    $this->_send_tni_email($this->request->data);                
                }
    ...
    public function edit($id = null) {
        ...
        if ($this->request->is('post') || $this->request->is('put')) {
            ...
            if ($this->TrainingNeedIdentification->save($this->request->data)) {
                ...
                if($this->request->data['TrainingNeedIdentification']['publish'] == 1){
                    $this->_send_tni_email($this->request->data);                
                }
