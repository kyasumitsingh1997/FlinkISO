...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($milestone['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($milestone['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($milestone['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($milestone['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($milestone['Project']['title']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($milestone['Branch']['name']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['users']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestone['UserSession']['id']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['publish']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($milestone['Milestone']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestone['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestone['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestone['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestone['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestone['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
