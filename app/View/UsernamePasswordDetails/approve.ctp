...
<script>
    ...
    $().ready(function () {
        ...
        $('#UsernamePasswordDetailApproveForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#UsernamePasswordDetailApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#UsernamePasswordDetailApproveForm").submit();
             }
...
<div id="usernamePasswordDetails_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="usernamePasswordDetails form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Username Password Detail '); ?>
