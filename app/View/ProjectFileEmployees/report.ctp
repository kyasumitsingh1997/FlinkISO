...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectFileEmployee['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectFileEmployee['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectFileEmployee['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectFileEmployee['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectFileEmployee['ProjectFile']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFileEmployee['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFileEmployee['Milestone']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFileEmployee['Employee']['name']); ?>&nbsp;</td>
		<td><?php echo h($projectFileEmployee['ProjectFileEmployee']['current_status']); ?>&nbsp;</td>
		<td><?php echo h($projectFileEmployee['ProjectFileEmployee']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectFileEmployee['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFileEmployee['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFileEmployee['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFileEmployee['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
