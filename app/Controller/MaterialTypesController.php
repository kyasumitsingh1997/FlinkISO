    ...
    public function advanced_search() {
        if ($this->request->is('post')) {
            ...
            if ($this->request->query['from-date']) {
                $conditions[] = array('MaterialType.created >' => date('Y-m-d h:i:s', strtotime($this->request->query['from-date'])), 'MaterialType.created <' => date('Y-m-d h:i:s', strtotime($this->request->query['to-date'])));
            }
