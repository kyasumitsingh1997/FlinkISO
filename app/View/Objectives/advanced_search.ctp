			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('Objective',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","title"=>"Title","clauses"=>"Clauses","objective"=>"Objective","desired_output"=>"Desired Output","team"=>"Team","requirments"=>"Requirments","system_table"=>"System Table","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#objectives_ajax','type'=>'data','method'=>'post')); ?>
...
<?php foreach ($objectives as $objective): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$objective['Objective']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $objective['Objective']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $objective['Objective']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $objective['Objective']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $objective['Objective']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $objective['Objective']['id']),array('class'=>''), __('Are you sure ?', $objective['Objective']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($objective['Objective']['sr_no']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($objective['Objective']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($objective['Objective']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($objective['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $objective['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($objective['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $objective['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($objective['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $objective['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($objective['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $objective['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($objective['Company']['name'], array('controller' => 'companies', 'action' => 'view', $objective['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#objectives_ajax')));?>
...
<?php echo $this->Form->create('objectives',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","title"=>"Title","clauses"=>"Clauses","objective"=>"Objective","desired_output"=>"Desired Output","team"=>"Team","requirments"=>"Requirments","system_table"=>"System Table","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
