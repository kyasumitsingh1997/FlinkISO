...
<h4><?php echo __('Approve File Upload'); ?>		
...
<?php echo $this->Form->create('FileUpload',array('role'=>'form','class'=>'form')); ?>
	...
	<?php
		...
		echo $this->Form->input('file_details'); 
		echo $this->Form->input('user_id',array('style'=>'width:90%')); 
		echo $this->Js->link('Add New',array('controller'=>'users','action'=>'add'),array('class'=>'label btn-info','update'=>'#fileUploads_ajax'));
		echo $this->Form->input('file_type'); 
		echo $this->Form->input('file_status'); 
		echo $this->Form->input('result'); 
		echo $this->Form->input('user_session_id',array('style'=>'width:90%')); 
		echo $this->Js->link('Add New',array('controller'=>'user_sessions','action'=>'add'),array('class'=>'label btn-info','update'=>'#fileUploads_ajax'));
