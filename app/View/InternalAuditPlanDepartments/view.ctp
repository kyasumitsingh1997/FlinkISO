          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <table class="table table-responsive">
                ...
                <tr><td><?php echo __('List Of Trained Internal Auditor'); ?></td>
                    <td>
                        <?php echo $this->Html->link($internalAuditPlanDepartment['ListOfTrainedInternalAuditor']['name'], array('controller' => 'list_of_trained_internal_auditors', 'action' => 'view', $internalAuditPlanDepartment['ListOfTrainedInternalAuditor']['id'])); ?>
                        &nbsp;
                    </td>
                </tr>
