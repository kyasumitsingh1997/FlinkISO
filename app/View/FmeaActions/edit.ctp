...
<h4><?php echo __('Edit FMEA Action'); ?>		
...
<div class="row">
	<?php
		...
		echo "<div class='col-md-6'><h2>RPN : <span id='ranking'>".$this->request->data['FmeaAction']['rpn']."</span></h2>".$this->Form->hidden('rpn',array()) . '</div>'; 
	?>
	<?php
...
<script>
    ...
    $().ready(function() {
        ...
        $("#submit_id").click(function(){
            if($('#FmeaActionEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#FmeaActionEditForm').submit();
            }
