...
<script>
    $().ready(function() {
        ...
        $("#submit_id").click(function(){
             if($('#CustomerFeedbackQuestionEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#CustomerFeedbackQuestionEditForm").submit();
             }

        });
        $('#CustomerFeedbackQuestionEditForm').validate();
    });
</script>
...
<div id="customerFeedbackQuestions_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="customerFeedbackQuestions form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Customer Feedback Question'); ?>
