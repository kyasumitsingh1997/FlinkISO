...
<?php echo $this->fetch('script'); ?><div id="processWeeklyPlans_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="processWeeklyPlans form col-md-8">
<h4><?php echo __('Edit Process Weekly Plan'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('ProcessWeeklyPlan',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
		...
		echo "<div class='col-md-6'>".$this->Form->input('year') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('week') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('planned') . '</div>'; 
	?>
<?php
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProcessWeeklyPlanEditForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProcessWeeklyPlanEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProcessWeeklyPlanEditForm').submit();
            }
