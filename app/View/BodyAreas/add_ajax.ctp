...
<h4>Add Body Area</h4>
<?php echo $this->Form->create('BodyArea',array('role'=>'form','class'=>'form','default'=>false)); ?>
<div class="row">
		<fieldset>
			<?php
...
<?php
	...
	if ($showApprovals && $showApprovals['show_panel'] == true) {
		...
		echo $this->Form->input('publish', array('label' => __('Publish')));
            ...
            ?><?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#bodyAreas_ajax','async' => 'false')); ?>
