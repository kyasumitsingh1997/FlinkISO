        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('device_category_id', __('Category')); ?></th>
                ...
                <tr class="on_page_src">
                    ...
                    <td>
                        <?php echo $this->Html->link($device['DeviceCategory']['name'], array('controller' => 'device_categories', 'action' => 'view', $device['DeviceCatogry']['id'])); ?>
                    </td>
