...
class DevicesController extends AppController {
    ...
    public function advanced_search() {
        ...
        if ($this->request->query['device_category_id'] != -1) {
            $deviceCategories = array('Device.device_category_id' => $this->request->query['device_category_id']);
            if ($this->request->query['strict_search'] == 0)
                $conditions[] = array('and' => $deviceCategories);
            else
                $conditions[] = array('or' => $deviceCategories);
        }
    ...
    public function add_ajax() {
        ...
        $deviceCategories = $this->Device->DeviceCategory->find('list', array('conditions' => array('DeviceCategory.publish' => 1, 'DeviceCategory.soft_delete' => 0)));
        ...
        $this->set(compact('deviceCategories', 'supplierRegistrations', 'employees', 'calibrationFrequencies', 'maintenanceFrequencies', 'branches', 'departments'));
    }
