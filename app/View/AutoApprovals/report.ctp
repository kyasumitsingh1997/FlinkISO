...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($autoApproval['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($autoApproval['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($autoApproval['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($autoApproval['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($autoApproval['AutoApproval']['publish']); ?>&nbsp;</td>
		<td><?php echo h($autoApproval['AutoApproval']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($autoApproval['AutoApproval']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($autoApproval['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($autoApproval['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($autoApproval['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($autoApproval['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($autoApproval['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
