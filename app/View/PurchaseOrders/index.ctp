        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <tr class="on_page_src">
                    <td class=" actions">
                        <?php echo $this->element('actions', array('created' => $purchaseOrder['PurchaseOrder']['created_by'], 'postVal' => $purchaseOrder['PurchaseOrder']['id'], 'softDelete' => $purchaseOrder['PurchaseOrder']['soft_delete'], 'type'=>$purchaseOrder['PurchaseOrder']['type'])); ?>
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td>
                        <?php if(isset($purchaseOrder['Project']['title'])){ ?>
                        <?php echo $this->Html->link($purchaseOrder['Project']['title'], array('controller' => 'projects', 'action' => 'view', $purchaseOrder['Project']['id'])); ?>
                        <?php }else { echo __('-'); }?>
                    </td>
                    <td>
                    ...
                    <td><?php 
                    if($purchaseOrder['DeliveryChallan']){
                        foreach($purchaseOrder['DeliveryChallan'] as $key => $value){
                                echo $this->Html->link($value,array('controller'=>'delivery_challans','action'=>'view',$key),array('target'=>'_blank')).', ';
                            }
                    }else{
                        echo $this->Html->link('Add Delivery',array('controller'=>'delivery_challans','action'=>'lists',$purchaseOrder['PurchaseOrder']['id']),array('class'=>'btn btn-xs btn-info'));
                    }
                             ?>&nbsp;
                    </td>
