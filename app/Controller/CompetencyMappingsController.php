...
class CompetencyMappingsController extends AppController {
    ...
    public function add_ajax() {
        ...
        if(isset($this->request->params['named']['employee_id']) && $this->request->params['named']['employee_id'] != NULL){                        
            $employee = $this->CompetencyMapping->Employee->find('first',array('conditions'=>array('Employee.id'=>$this->request->params['named']['employee_id'])));
