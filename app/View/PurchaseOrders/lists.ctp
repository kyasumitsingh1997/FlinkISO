<div  id="main">
    ...
    <div class="purchaseOrders ">
        ...
        <div class="nav">
            <div id="tabs">
                <ul>
                    <li><?php echo $this->Html->link(__('New Purchase Order'), array('action' => 'add_ajax',
                    'material_id'=>$this->request->params['named']['material_id'],
                    ...
                    'type'=>$this->request->params['named']['type'])); ?></li>
