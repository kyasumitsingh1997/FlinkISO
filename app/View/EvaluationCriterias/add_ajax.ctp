...
<h4>Add EvaluationCriteria</h4>
<?php echo $this->Form->create('EvaluationCriteria',array('role'=>'form','class'=>'form','default'=>false)); ?>
<div class="row">
		<fieldset>
			<?php
...
<?php
	...
	}?><?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#aspects_ajax','async' => 'false')); ?>
...
<script>
    $.validator.setDefaults({
		...
		$().ready(function() {
    $("#submit-indicator").hide();
        $('#EvaluationCriteriaAddAjaxForm').validate();        
    });
