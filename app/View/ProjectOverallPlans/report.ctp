...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectOverallPlan['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectOverallPlan['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectOverallPlan['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectOverallPlan['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("plan_type"));?></th>
				<th><?php echo h(Inflector::humanize("lot_process"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectOverallPlan['Project']['title']); ?>&nbsp;</td>
		...
		<td><?php echo h($projectOverallPlan['ProjectOverallPlan']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectOverallPlan['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectOverallPlan['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectOverallPlan['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectOverallPlan['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
