...
<div  id="main">
    ...
    <div class="calibrations ">
        <h4><?php echo __('Pending Calibrations'); ?></h4>
        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <tr class="on_page_src">
                    ...
                    <td><div id="<?php echo $calibration['Calibration']['id']?>-calibrationDiv">
                <?php echo $this->Html->link('Remind',array('controller'=>'customer_complaints','action'=>'send_reminder'),array('class'=>'btn btn-xs btn-danger','default'=>false,'id'=>$calibration['Calibration']['id'].'-calibration'));?>
            <div>
            <script type="text/javascript">
                $("#<?php echo $calibration['Calibration']['id']?>-calibration").click(function(){
                    $("#<?php echo $calibration['Calibration']['id']?>-calibrationDiv").html("<span class='btn btn-xs btn-warning'>Sending... <i class='fa fa-spinner fa-spin fa-1x fa-fw'></i></span>");
                    $("#<?php echo $calibration['Calibration']['id']?>-calibrationDiv").load("<?php echo Router::url('/', true); ?><?php echo $this->request->params['controller'] ?>/send_reminder/<?php echo $calibration['Calibration']['id']?>");
                });
            </script>
        </td>
                </tr>
