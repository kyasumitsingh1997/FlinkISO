...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fileError['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fileError['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fileError['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fileError['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("file_process_id"));?></th>
				<th><?php echo h(Inflector::humanize("file_error_master_id"));?></th>
				<th><?php echo h(Inflector::humanize("total_units"));?></th>
				<th><?php echo h(Inflector::humanize("total_errors"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($fileError['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileError['Milestone']['title']); ?>&nbsp;</td>
		<td><?php echo h($fileError['FileError']['project_file_id']); ?>&nbsp;</td>
		<td><?php echo h($fileError['FileError']['file_process_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileError['FileErrorMaster']['name']); ?>&nbsp;</td>
		<td><?php echo h($fileError['FileError']['total_units']); ?>&nbsp;</td>
		<td><?php echo h($fileError['FileError']['total_errors']); ?>&nbsp;</td>
		<td><?php echo h($fileError['FileError']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fileError['FileError']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fileError['FileError']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileError['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileError['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileError['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileError['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
