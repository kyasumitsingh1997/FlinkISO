...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($design['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($design['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($design['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($design['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($design['Product']['name']); ?>&nbsp;</td>
		<td><?php echo h($design['Design']['publish']); ?>&nbsp;</td>
		<td><?php echo h($design['Design']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($design['Design']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($design['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($design['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($design['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($design['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($design['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
