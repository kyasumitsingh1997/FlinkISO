...
class NotificationUsersController extends AppController {
    ...
    public function display_notifications() {
        ...
        $this->paginate = array('limit' => 1, 'order' => array('NotificationUser.sr_no' => 'DESC'), 'conditions' => array($conditions, 'NotificationUser.soft_delete' => 0),'fields'=>array('Notification.notification_type_id','Notification.title','Notification.message','Notification.start_date','Notification.created'));
        $notifications = $this->paginate();
        $this->set('notificationUsers', $notifications);
