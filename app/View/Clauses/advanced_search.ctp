...
<script>
	...
	var inputElements = clause.getElementsByTagName('input');
			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('Clause',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","title"=>"Title","standard"=>"Standard","clause"=>"Clause","sub-clause"=>"Sub-clause","details"=>"Details","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#documents_ajax','type'=>'data','method'=>'post')); ?>
...
<?php foreach ($clauses as $clause): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$clause['Clause']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $clause['Clause']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $clause['Clause']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $clause['Clause']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $clause['Clause']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $clause['Clause']['id']),array('class'=>''), __('Are you sure ?', $clause['Clause']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($clause['Clause']['sr_no']); ?>&nbsp;</td>
		<td><?php echo h($clause['Clause']['title']); ?>&nbsp;</td>
		<td><?php echo h($clause['Clause']['standard']); ?>&nbsp;</td>
		<td><?php echo h($clause['Clause']['clause']); ?>&nbsp;</td>
		<td><?php echo h($clause['Clause']['sub-clause']); ?>&nbsp;</td>
		<td><?php echo h($clause['Clause']['details']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($clause['Clause']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($clause['Clause']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($clause['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $clause['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($clause['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $clause['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($clause['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $clause['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($clause['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $clause['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($clause['Company']['name'], array('controller' => 'companies', 'action' => 'view', $clause['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#documents_ajax')));?>
...
<?php echo $this->Form->create('clauses',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","title"=>"Title","standard"=>"Standard","clause"=>"Clause","sub-clause"=>"Sub-clause","details"=>"Details","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
