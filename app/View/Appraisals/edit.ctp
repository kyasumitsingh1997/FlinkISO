...
<script>
    ...
    $().ready(function () {
        ...
        $("#submit_id").click(function(){
             if($('#AppraisalEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#AppraisalEditForm").submit();
             }
        });
        jQuery.validator.addMethod("greaterThanZero", function (value, element) {
            return this.optional(element) || (value != -1);
        }, "Please select the value");
        $('#AppraisalEditForm').validate({
            rules: {
...
<div id="appraisals_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="appraisals form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Appraisal'); ?>
		...
		<br />&nbsp;
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4><?php echo $this->element('breadcrumbs') . __('Select Appraisal Questions'); ?></h4>
                        <hr>
