...
<h4><?php echo __('Edit Environment Questionnaire'); ?>		
...
<script>
    ...
    $().ready(function() {
        $('#EnvironmentQuestionnaireEditForm').validate();
        $("#submit-indicator").hide();
        $("#submit_id").click(function(){
            if($('#EnvironmentQuestionnaireEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#EnvironmentQuestionnaireEditForm').submit();
            }
