						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","name"=>"Name","step_number"=>"Step Number","details"=>"Details","system_table"=>"System Table","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
...
<?php foreach ($autoApprovalSteps as $autoApprovalStep): ?>
	<tr>
		...
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View'), array('action' => 'view', $autoApprovalStep['AutoApprovalStep']['id'])); ?></li>
		...
		<td>
			<?php echo $this->Html->link($autoApprovalStep['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $autoApprovalStep['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($autoApprovalStep['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $autoApprovalStep['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($autoApprovalStep['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $autoApprovalStep['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($autoApprovalStep['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $autoApprovalStep['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($autoApprovalStep['Company']['name'], array('controller' => 'companies', 'action' => 'view', $autoApprovalStep['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","name"=>"Name","step_number"=>"Step Number","details"=>"Details","system_table"=>"System Table","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
