...
<h4><?php echo __('Approve Objective Monitoring'); ?>		
...
<div class="row">
	...
	?>
        ...
        <div class="col-md-2" id = "ObjectiveMonitoringCompletionh1"><h1><?php echo $this->request->data['ObjectiveMonitoring']['completion'] ?>%</h1></div>
    ...
    $.validator.setDefaults({
        submitHandler: function(form) {
            $(form).ajaxSubmit({
                ...
                type: 'POST',
                target: '#objectiveMonitorings_ajax',
                beforeSend: function(){
		...
		$().ready(function() {
    $("#submit-indicator").hide();
        $('#ObjectiveMonitoringApproveForm').validate();        
    });
</script>
