...
<h4><?php echo __('Add Project Activity Requirement'); ?>		
...
<script>
    ...
    $().ready(function() {
        $('#ProjectActivityRequirementAddForm').validate();
        $("#submit-indicator").hide();
        $("#submit_id").click(function(){
            if($('#ProjectActivityRequirementAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProjectActivityRequirementAddForm').submit();
            }
