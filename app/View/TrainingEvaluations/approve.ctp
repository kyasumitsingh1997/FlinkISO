...
<script>
    ...
    $().ready(function () {
        ...
        $('#TrainingEvaluationApproveForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#TrainingEvaluationApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#TrainingEvaluationApproveForm").submit();
             }
...
<div id="trainingEvaluations_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="trainingEvaluations form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Training Evaluation'); ?>
