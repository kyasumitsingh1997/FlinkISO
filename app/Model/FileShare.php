 ...
 */
class FileShare extends AppModel {
 ...
 */
	public $belongsTo = array(
		'FileUpload' => array(
			...
			'conditions' => '',
			'fields' => array('id', 'name','system_table_id','record','file_dir','file_type','user_id','file_status','archived','version','publish','soft_delete'),
			'order' => ''
		),
		'Branch' => array(
			'className' => 'Branch',
