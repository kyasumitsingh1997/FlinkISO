                                ...
                                ?>
                                    ...
                                    <p>
                                       ...
                                       To generate the report select the month & year from the dropn-down below and click "Generate Report". It will generate, daily, weekly , monthly reports for that month. 
									   		<br />However, it is recommned that you turn on your cron-jobs or schedule tasks. If you are having any difficulty contact us at <a herf="mailto:help@flinkiso.com" class="text-link">help@flinkiso.com</a>.
											<br /><strong>Note : </strong> Generating reports will take a while, please have patience. Do not move away from this page while reports are generated.
											<br />After reports are generated, you can view the reports from "Auto Reports menu.
                                    </p>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
										...
										<h5>If you require additional customised reports send us your requirments at <a herf="mailto:sales@flinkiso.com" class="text-link">sales@flinkiso.com</a></h5>
                                    <div class="row">
