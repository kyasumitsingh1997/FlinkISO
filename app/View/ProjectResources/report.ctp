...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectResource['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectResource['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectResource['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectResource['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("mandays"));?></th>
				<th><?php echo h(Inflector::humanize("resource_cost"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectResource['User']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectResource['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectResource['ProjectActivity']['title']); ?>&nbsp;</td>
		...
		<td><?php echo h($projectResource['ProjectResource']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectResource['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectResource['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectResource['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectResource['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
