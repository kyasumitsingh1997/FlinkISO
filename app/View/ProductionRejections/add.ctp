...
<?php echo $this->fetch('script'); ?><div id="productionRejections_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="productionRejections form col-md-8">
<h4><?php echo __('Add Production Rejection'); ?>		
...
<div class="row">
		...
		echo "<div class='col-md-6'>".$this->Form->input('production_inspection_template_id',array('style'=>'')) . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('total_quantity') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('sample_quantity') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('quality_check_date') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('start_sr_number') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('end_sr_number') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('number_of_rejections') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('employee_id',array('style'=>'')) . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('supplier_registration_id',array('style'=>'')) . '</div>'; 
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProductionRejectionAddForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProductionRejectionAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProductionRejectionAddForm').submit();
            }
