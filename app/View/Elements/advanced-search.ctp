...
function changeAdditionDocAmendment() {
    $('.hidediv').hide();
    $('#Branch').show();
...
if ($this->request->controller == 'customer_complaints') {
    ...
    if ($this->request->controller == 'purchase_orders') {
        ...
        if ($this->request->controller == 'master_list_of_formats') {
            $postData = null;
            $postData = array('title' => 'Title', 'document_number' => 'Document Number', 'issue_number' => 'Issue Number', 'revision_number' => 'Revision Number', 'work_instructions' => 'Work Instructions','document_details'=>'Document Details');
        }
        ?>
        <?php
        ...
        if ($this->request->controller == 'change_addition_deletion_requests') {
            $postData = null;
            $postData = array('current_document_details' => 'Current Document Details', 'request_details' => 'Request Details', 'reason_for_change' => 'Reason For Change');
            ?>
            <script>
            $(document).ready(function() {
                changeAdditionDocAmendment();
            })
            </script>
            <?php } ?>
            <?php
                ...
                if ($this->request->controller == 'customer_meetings') {
                    ...
                    if ($this->request->controller == 'proposal_followups') {
                        ...
                        if ($this->request->controller == 'evidences') {
                            $postData = null;
                            $postData = array('description' => 'Description');
                        }
                        ?>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="col-md-12"><?php echo $this->Form->input('Search.search_fields', array('label' => false, 'options' => array($postData), 'multiple' => 'checkbox', 'class' => 'col-md-3')); ?></div>
                                            <?php } else if ($this->request->controller == 'file_uploads') { ?>
                                            <?php } else { ?>
                                            <div class="col-md-12"><?php echo $this->Form->input('Search.search_fields', array('label' => false, 'options' => array($postData), 'multiple' => 'checkbox', 'class' => 'col-md-4')); ?></div>
                                            <?php } ?>
                                            <div class="col-md-12"><hr /></div>
                                        </div>
                                        <?php } ?>
                                        <?php
                                        if ($this->request->controller == 'milestones') {
                                            $projects = $this->requestAction('App/get_model_list/Project/');
                                            ?>
                                            <div class="">
                                                <div class="col-md-6"><?php echo $this->Form->input('Search.project_id', array('label' => __('Select Project'), 'options' => $projects, 'class' => 'form-control')); ?></div>
                                            ...
                                            if ($this->request->controller == 'devices') {
                                                ...
                                                $deviceCategories = $this->requestAction('App/get_model_list/DeviceCategory/');
                                                ?>
                                                <div class="">
                                                    ...
                                                    <div class="col-md-6"><?php echo $this->Form->input('Search.device_category_id', array('label' => __('Select Category'), 'options' => $deviceCategories, 'class' => 'form-control')); ?></div>
                                                                            ...
                                                                            <?php if ($this->request->controller == 'corrective_preventive_actions') {
                                                                                ...
                                                                                <?php if ($this->request->controller == 'customer_complaints') {
                                                                                    ...
                                                                                    <div class="">
                                                                                        ...
                                                                                        <div class="col-md-7"><?php echo $this->Form->input('Search.complaint_source', array('label' => __('Complaint Source'), 'type' => 'radio', 'options' => array('Product' => 'Product', 'Delivery' => 'Delivery', 'Service' => 'Service', 'Customer Care' => 'Customer Care'))); ?></div>
                                                                                                                    ...
                                                                                                                    <?php if ($this->request->controller == 'daily_backup_details') {
                                                                                                                        ...
                                                                                                                        <?php if ($this->request->controller == 'document_amendment_record_sheets') {
                                                                                                                            ...
                                                                                                                            <?php if ($this->request->controller == 'tasks') {
                                                                                                                                ...
                                                                                                                                $schedules = $this->requestAction('App/get_model_list/Schedule');
                                                                                                                                $masterListOfFormats = $this->requestAction('App/get_model_list/MasterListOfFormat/');
                                                                                                                                $taskTypes = array('0'=>'General','1'=>'Process','2'=>'Project');
                                                                                                                                $taskStatus = array('0' => 'On going', '1' => 'Completed','2'=>'Not Started','3'=>'Cancelled');
                                    $ragStatus = array(0 => 'Danger',1 => 'Warning',2 => 'Success',3 => 'Default');
                                                                                                                                ?>
                                    <div class="">
                                        <div class="col-md-6"><?php echo $this->Form->input('Search.task_type', array('label' => __('Select Type'), 'options' => $taskTypes, 'type' => 'radio')); ?></div>
                                        <div class="col-md-6"><?php echo $this->Form->input('Search.task_status', array('label' => __('Select Status'), 'type'=>'radio', 'options' => $taskStatus, 'class' => '')); ?></div>
                                        <div class="col-md-6"><?php echo $this->Form->input('Search.rag_status', array('label' => __('Select Rag Status'), 'type'=>'radio', 'options' => $ragStatus, 'class' => '')); ?></div>
                                        ...
                                        <div class="col-md-6"><?php echo $this->Form->input('Search.schedule_id', array('label' => __('Select Schedule'), 'options' => $schedules, 'multiple' => true, 'class' => 'form-control')); ?></div>
                                    </div>
                                                                                                                                <?php } ?>
                                                                                                                                                ...
                                                                                                                                                <?php if ($this->request->controller == 'housekeeping_responsibilities') {
                                                                                                                                                    ...
                                                                                                                                                    <?php if ($this->request->controller == 'summery_of_supplier_evaluations') {
                                                                                                                                                        ...
                                                                                                                                                        <?php if ($this->request->controller == 'list_of_computer_list_of_softwares') {
                                                                                                                                                            ...
                                                                                                                                                            <?php } ?>
                                                                                                                                                            <?php if ($this->request->controller == 'evidences') {
                                                                                                                                                               $models = $this->requestAction('App/get_model_list/SystemTable/');
                                                                                                                                                               $models = array_merge($models,array_keys($special));
                                                                                                                                                               ?>
                                                                                                                                                               <script type="text/javascript">
                                                                                                                                                               $(document).ready(function() {
                                                                                                                                                                $('#EvidencesModelName').change(function() {

                                                                                                                                                                    if(this.value == 1){
                                                                                                                                                                      $("#EvidencesRecord").load('<?php echo Router::url('/', true); ?><?php echo $this->request->params['controller'] ?>/get_records/' + encodeURIComponent(this.value), function(response, status, xhr) {            
                                                                                                                                                                        $("#EvidencesRecord").html(response);
                                                                                                                                                                        $('#EvidencesRecord').val(0).trigger('chosen:updated');               
                                                                                                                                                                    });
                                                                                                                                                                      $("#EvidencesRecordType").load('<?php echo Router::url('/', true); ?><?php echo $this->request->params['controller'] ?>/get_records/' + encodeURIComponent(2), function(response, status, xhr) {         
                                                                                                                                                                         $("#record_dd").show();
                                                                                                                                                                         $("#EvidencesRecordType").html(response);
                                                                                                                                                                         $('#EvidencesRecordType').val(0).trigger('chosen:updated');               
                                                                                                                                                                     });
...
<div class="">
    <div class="col-md-6"><?php  echo $this->Form->input('model_name',array('options'=>$models));  ?></div>
    <div class="col-md-6"><?php  echo $this->Form->input('record',array('options'=>array_values($special)));  ?></div>
    <div class="col-md-6" id="record_dd"><?php echo $this->Form->input('record_type',array('options'=>array_values($special))); ?> </div> 
</div>
<?php } ?>
                                        ...
                                        <?php if ($this->request->controller == 'employee_kras') {
                                            ...
                                            <?php if ($this->request->controller == 'non_conforming_products_materials') {
                                                ...
                                                <?php if ($this->request->controller == 'device_maintenances') {
                                                    ...
                                                    <div class="">
                                                        <div class="col-md-12"><hr /></div>
                                                        <div class="col-md-3"><?php echo $this->Form->input('Search.from-date', array('id' => 'ddfrom', 'label' => __('Select start date'))); ?></div>
                                                        <div class="col-md-3"><?php echo $this->Form->input('Search.to-date', array('id' => 'ddto', 'label' => __('Select end date'))); ?></div>
                                                        <div class="col-md-3"><?php echo $this->Form->input('Search.strict_search', array('label' => __('Strict Search'), 'options' => array('Yes', 'No'), 'checked' => 1, 'type' => 'radio')); ?></div>
                                                        <div class="col-md-3"><?php 
                                                            echo $this->Form->input('Search.limit', array('label' => __('Limit Records'), 'options' => array('5'=>'5','10'=>'10','20'=> '20' ,'30'=> '30','50'=> '50','100'=> '100'),'default'=>'20')); ?>
                                                        </div>
                                                    </div>
                                                    <div class="">
                                                        <div class="col-md-12">
