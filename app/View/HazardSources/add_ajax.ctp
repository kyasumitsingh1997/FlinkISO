...
<h4>Add Hazard Source</h4>
<?php echo $this->Form->create('HazardSource',array('role'=>'form','class'=>'form','default'=>false)); ?>
<div class="row">
		<fieldset>
			<?php
...
<?php
	...
	}?><?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#hazardSources_ajax','async' => 'false')); ?>
...
<script>
    $.validator.setDefaults({
		...
		$().ready(function() {
    $("#submit-indicator").hide();
        $('#HazardSourceAddAjaxForm').validate();        
    });
