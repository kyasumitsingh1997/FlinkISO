...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($environmentChecklist['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($environmentChecklist['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($environmentChecklist['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($environmentChecklist['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("date_created"));?></th>
				...
				<th><?php echo h(Inflector::humanize("environment_questionnaire_category_id"));?></th>
				<th><?php echo h(Inflector::humanize("environment_questionnaire_id"));?></th>
				<th><?php echo h(Inflector::humanize("answer"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($environmentChecklist['Branch']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['Department']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['Employee']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['EnvironmentQuestionnaireCategory']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['EnvironmentQuestionnaire']['title']); ?>&nbsp;</td>
		...
		<td><?php echo h($environmentChecklist['EnvironmentChecklist']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($environmentChecklist['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($environmentChecklist['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
