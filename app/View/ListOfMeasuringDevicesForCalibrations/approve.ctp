...
<script>
    ...
    $().ready(function() {
        ...
        $('#ListOfMeasuringDevicesForCalibrationApproveForm').validate({
            rules: {
	...
	$("#submit-indicator").hide();
        $("#submit_id").click(function(){
             if($('#ListOfMeasuringDevicesForCalibrationApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#ListOfMeasuringDevicesForCalibrationApproveForm").submit();
             }
...
<div id="listOfMeasuringDevicesForCalibrations_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="listOfMeasuringDevicesForCalibrations form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Measuring Devices For Calibration'); ?>
