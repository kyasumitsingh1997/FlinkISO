...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($envActivity['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($envActivity['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($envActivity['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($envActivity['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($envActivity['Branch']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envActivity['Department']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envActivity['Employee']['name']); ?>&nbsp;</td>
		<td><?php echo h($envActivity['EnvActivity']['other_details']); ?>&nbsp;</td>
		<td><?php echo h($envActivity['EnvActivity']['publish']); ?>&nbsp;</td>
		<td><?php echo h($envActivity['EnvActivity']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($envActivity['EnvActivity']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envActivity['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envActivity['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envActivity['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envActivity['PreparedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
