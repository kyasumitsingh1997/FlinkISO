        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <?php
                    if ($capaSources) {
                        $x = 0;
                        foreach ($capaSources as $capaSource):
                ?>
                <tr class="on_page_src">
                    <td class=" actions">
                        <?php echo $this->element('actions', array('created' => $capaSource['CapaSource']['created_by'], 'postVal' => $capaSource['CapaSource']['id'], 'softDelete' => $capaSource['CapaSource']['soft_delete'])); ?>

                    </td>
                    <td><?php echo h($capaSource['CapaSource']['name']); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$capaSource['CapaSource']['prepared_by']]); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$capaSource['CapaSource']['approved_by']]); ?>&nbsp;</td>
