...
<?php echo $this->Session->flash();?>	<div class="nav">
		<div class="deviceCategories form col-md-8">
			...
			<?php echo $this->Form->create('DeviceCategory',array('role'=>'form','class'=>'form','default'=>false)); ?>
			<div class="row">
			<fieldset>
					<?php
...
<?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#deviceCategories_ajax','async' => 'false')); ?>
...
<script>
    $.validator.setDefaults({
      ...
      //       }
        ...
        $('#DeviceCategoryAddAjaxForm').validate({
            rules: {
