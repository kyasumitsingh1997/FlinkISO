...
<?php echo $this->fetch('script'); ?><div id="projectFileEmployees_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="projectFileEmployees form col-md-8">
<h4><?php echo __('Edit Project File Employee'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('ProjectFileEmployee',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProjectFileEmployeeEditForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProjectFileEmployeeEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProjectFileEmployeeEditForm').submit();
            }
