...
$('#SupplierEvaluationReevaluationEditForm').validate({
    rules: {
...
$("#submit-indicator").hide();
	...
	if($('#SupplierEvaluationReevaluationEditForm').valid()){
	    $("#submit_id").prop("disabled",true);
	    $("#submit-indicator").show();
	    $("#SupplierEvaluationReevaluationEditForm").submit();
	}
    });
...
<h4><?php echo __('Edit Supplier Evaluation Reevaluation'); ?>
