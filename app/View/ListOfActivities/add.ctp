...
<?php echo $this->fetch('script'); ?><div id="listOfActivities_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="listOfActivities form col-md-8">
<h4><?php echo __('Add List Of Activity'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('ListOfActivity',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ListOfActivityAddForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ListOfActivityAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ListOfActivityAddForm').submit();
            }
