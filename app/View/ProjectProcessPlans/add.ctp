...
<?php echo $this->fetch('script'); ?><div id="projectProcessPlans_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="projectProcessPlans form col-md-8">
<h4><?php echo __('Add Project Process Plan'); ?>		
...
<div class="row">
		...
		echo "<div class='col-md-6'>".$this->Form->input('project_overall_plan_id',array('style'=>'')) . '</div>'; 
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProjectProcessPlanAddForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProjectProcessPlanAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProjectProcessPlanAddForm').submit();
            }
