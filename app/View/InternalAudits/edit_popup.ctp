            ...
            <div class="panel panel-default" id="add_details">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-4"><?php echo $this->Form->input('start_time'); ?></div>
...
<script>
    $("#InternalAuditStartTime").daterangepicker({
        ...
        startDate : '<?php echo date("m-d-Y",strtotime($this->data["InternalAudit"]["start_time"])) ;?>',
        endDate : '<?php echo date("m-d-Y",strtotime($this->data["InternalAudit"]["end_time"])) ;?>',
        locale: {
            format: 'MM/DD/YYYY'
        },
        autoclose:true,
