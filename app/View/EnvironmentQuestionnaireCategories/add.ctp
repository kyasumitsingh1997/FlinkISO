...
<h4><?php echo __('Add Environment Questionnaire Category'); ?>		
...
<script>
    ...
    $().ready(function() {
        $('#EnvironmentQuestionnaireCategoryAddForm').validate();
        $("#submit-indicator").hide();
        $("#submit_id").click(function(){
            if($('#EnvironmentQuestionnaireCategoryAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#EnvironmentQuestionnaireCategoryAddForm').submit();
            }
