...
<h4><?php echo __('Add Project Overall Plan'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('ProjectOverallPlan',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
		...
		echo "<div class='col-md-6'>".$this->Form->input('plan_type') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('lot_process') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('estimated_units') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('overall_metrics') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('start_date') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('end_date') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('estimated_resource') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('estimated_manhours') . '</div>'; 
	?>
<?php
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProjectOverallPlanAddForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProjectOverallPlanAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProjectOverallPlanAddForm').submit();
            }
