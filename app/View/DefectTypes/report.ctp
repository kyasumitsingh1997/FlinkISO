...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($defectType['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($defectType['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($defectType['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($defectType['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($defectType['DefectType']['publish']); ?>&nbsp;</td>
		<td><?php echo h($defectType['DefectType']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($defectType['DefectType']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($defectType['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($defectType['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($defectType['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($defectType['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($defectType['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
