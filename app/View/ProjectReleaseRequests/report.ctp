...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectReleaseRequest['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectReleaseRequest['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectReleaseRequest['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectReleaseRequest['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("current_project_id"));?></th>
				<th><?php echo h(Inflector::humanize("new_project_id"));?></th>
				<th><?php echo h(Inflector::humanize("employee_id"));?></th>
				<th><?php echo h(Inflector::humanize("request_from_id"));?></th>
				<th><?php echo h(Inflector::humanize("request_status"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectReleaseRequest['CurrentProject']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectReleaseRequest['NewProject']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectReleaseRequest['Employee']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectReleaseRequest['RequestFrom']['name']); ?>&nbsp;</td>
		<td><?php echo h($projectReleaseRequest['ProjectReleaseRequest']['request_status']); ?>&nbsp;</td>
		<td><?php echo h($projectReleaseRequest['ProjectReleaseRequest']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectReleaseRequest['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectReleaseRequest['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectReleaseRequest['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectReleaseRequest['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
