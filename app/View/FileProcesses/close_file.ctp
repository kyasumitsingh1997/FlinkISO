...
?>
	...
	<div class="row">	
		...
		<div class="col-md-6"><?php echo $this->Form->input('employee_id',array('label'=>'New User', 'default'=>$this->request->data['FileProcess']['employee_id'], 'onchange'=>'validate();', 'class'=>'form-control','options'=>$teamMembers));?>
			<div id="skillsetresult"></div>
		</div>
		<?php $this->request->data['FileProcess']['comments'] = '';?>
		<div class="col-md-12"><?php echo $this->Form->input('comments',array('default'=>false, 'required'=>'required'));?></div>
		<?php echo $this->Form->input('id');?>
		<div class="col-md-12"><br /><?php echo $this->Form->submit('Close File',array('id'=>'plan_submit_'.$this->request->data['FileProcess']['id'], 'class'=>'btn btn-md btn-success'));?></div>
		<div class="col-md-12">
...
<script type="text/javascript">
	...
	$.validator.setDefaults({
        submitHandler: function(form) {
            $(form).ajaxSubmit({
                url: "<?php echo Router::url('/', true); ?><?php echo $this->request->params['controller'] ?>/close_file",
                type: 'POST',                
                beforeSend: function(){
