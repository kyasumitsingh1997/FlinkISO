...
<h4><?php echo __('Approve Objective'); ?>		
...
<div class="row">
			<?php
		echo "<div class='col-md-8'>".$this->Form->input('title',array()) . '</div>'; 
        echo "<div class='col-md-4'>".$this->Form->input('objective_category_id',array()) . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('clauses',array()) . '</div>'; 
        echo "<div class='col-md-6'>".$this->Form->input('master_list_of_format',array('label'=>'Select Format (optional)')) . '</div>'; 
		...
		echo "<div class='col-md-6 hide'>".$this->Form->input('owner_id',array()) . '</div>'; 
        ...
        echo "<div class='col-md-6'>".$this->Form->input('schedule_id',array()) . '</div>'; 
