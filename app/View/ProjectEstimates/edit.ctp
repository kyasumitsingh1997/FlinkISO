...
<?php echo $this->fetch('script'); ?><div id="projectEstimates_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="projectEstimates form col-md-8">
<h4><?php echo __('Edit Project Estimate'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('ProjectEstimate',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProjectEstimateEditForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProjectEstimateEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProjectEstimateEditForm').submit();
            }
