...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fileProcess['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fileProcess['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fileProcess['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fileProcess['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($fileProcess['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileProcess['Milestone']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileProcess['ProjectProcessPlan']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileProcess['ProjectFile']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileProcess['Employee']['name']); ?>&nbsp;</td>
		<td><?php echo h($fileProcess['FileProcess']['current_status']); ?>&nbsp;</td>
		<td><?php echo h($fileProcess['FileProcess']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fileProcess['FileProcess']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fileProcess['FileProcess']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileProcess['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileProcess['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileProcess['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileProcess['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
