...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($costCategory['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($costCategory['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($costCategory['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($costCategory['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($costCategory['CostCategory']['publish']); ?>&nbsp;</td>
		<td><?php echo h($costCategory['CostCategory']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($costCategory['CostCategory']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($costCategory['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($costCategory['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($costCategory['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($costCategory['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
