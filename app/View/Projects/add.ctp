...
<div class="row">
		...
		echo "<div class='col-md-12'>".$this->Form->input('goal') . '</div>'; 
		echo "<div class='col-md-12'>".$this->Form->input('scope') . '</div>'; 
		echo "<div class='col-md-12'>".$this->Form->input('success_criteria') . '</div>'; 
		echo "<div class='col-md-12'>".$this->Form->input('challenges') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('project_cost') . '</div>'; 
		...
		echo "<div class='col-md-6'>".$this->Form->input('employees') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('customers') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('suppliers_vendors') . '</div>'; 
