			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('FileShare',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","everyone"=>"Everyone","users"=>"Users","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#fileShares_ajax','type'=>'data','method'=>'post')); ?>
...
<?php foreach ($fileShares as $fileShare): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$fileShare['FileShare']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $fileShare['FileShare']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $fileShare['FileShare']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $fileShare['FileShare']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $fileShare['FileShare']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $fileShare['FileShare']['id']),array('class'=>''), __('Are you sure ?', $fileShare['FileShare']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($fileShare['FileShare']['sr_no']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($fileShare['FileShare']['everyone']); ?>&nbsp;</td>
		<td><?php echo h($fileShare['FileShare']['users']); ?>&nbsp;</td>
		<td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($fileShare['FileShare']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fileShare['FileShare']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($fileShare['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $fileShare['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileShare['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $fileShare['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileShare['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $fileShare['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileShare['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $fileShare['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($fileShare['Company']['name'], array('controller' => 'companies', 'action' => 'view', $fileShare['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#fileShares_ajax')));?>
...
<?php echo $this->Form->create('fileShares',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","everyone"=>"Everyone","users"=>"Users","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
