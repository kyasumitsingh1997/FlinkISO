...
<script>
    $.validator.setDefaults({
        submitHandler: function(form) {
            $(form).ajaxSubmit({
                ...
                target:  <?php if($redirect){echo "'#courseTypes_ajax'";} else {echo "'#main'";}?>,
    ...
    $().ready(function() {
        $('#CourseTypeAddAjaxForm').validate();
          $("#submit-indicator").hide();
        });
</script>
        ...
        <div class="courseTypes form col-md-8">
          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <div class="table-responsive" id="courses">
                ...
                ?>
                <tr>
                    <td><?php echo h($courseType['CourseType']['title']); ?>&nbsp;</td>
                    <td width="60">
            ...
            <?php echo $this->Form->create('CourseType', array('role' => 'form', 'class' => 'form', 'default' => false)); ?>
            ...
            ?>
            <?php  if($redirect){
                echo $this->Form->submit(__('Submit'), array('div' => false, 'class' => 'btn btn-primary btn-success', 'update' => '#courseTypes_ajax', 'async' => 'false','id'=>'submit_id'));
            }else{
                echo $this->Form->submit(__('Submit'), array('div' => false, 'class' => 'btn btn-primary btn-success', 'update' => '#courseTypes_ajax', 'async' => 'false','id'=>'submit_id'));
            }?>
