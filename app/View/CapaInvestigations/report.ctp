...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($capaInvestigation['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($capaInvestigation['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($capaInvestigation['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($capaInvestigation['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("completed_on_date"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($capaInvestigation['CorrectivePreventiveActionId']['name']); ?>&nbsp;</td>
		<td><?php echo h($capaInvestigation['CapaInvestigation']['details']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaInvestigation['EmployeeId']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($capaInvestigation['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaInvestigation['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaInvestigation['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaInvestigation['PreparedBy']['name']); ?>&nbsp;</td>
		<td><?php echo h($capaInvestigation['CapaInvestigation']['publish']); ?>&nbsp;</td>
		<td><?php echo h($capaInvestigation['CapaInvestigation']['record_status']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaInvestigation['StatusUserId']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaInvestigation['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
