...
<?php echo $this->Session->flash();?>	
	<div class="fileErrors ">
		...
		<div class="nav">
			<div id="tabs">	
				<ul>
					<li><?php echo $this->Html->link(__('New File Error'), array('action' => 'add_ajax')); ?></li>
					...
					<li><?php // echo $this->Html->link(__('Add File Error Master'), array('controller' => 'file_error_masters', 'action' => 'add_ajax')); ?> </li>
					<li><?php // echo $this->Html->link(__('Add Prepared By'), array('controller' => 'employees', 'action' => 'add_ajax')); ?> </li>
					<li><?php echo $this->Html->image('indicator.gif', array('id' => 'busy-indicator','class'=>'pull-right')); ?></li>
				</ul>
			</div>
		</div>
	<div id="fileErrors_tab_ajax"></div>
</div>
