...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($otherMeasurableUnit['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($otherMeasurableUnit['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($otherMeasurableUnit['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($otherMeasurableUnit['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("unit_name"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($otherMeasurableUnit['ProjectProcessPlan']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnit['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnit['Milestone']['title']); ?>&nbsp;</td>
		<td><?php echo h($otherMeasurableUnit['OtherMeasurableUnit']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($otherMeasurableUnit['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnit['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnit['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($otherMeasurableUnit['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
