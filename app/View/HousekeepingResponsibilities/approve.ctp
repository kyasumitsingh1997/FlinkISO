<div id="housekeepingResponsibilities_ajax">
    ...
    <script>
        ...
        $().ready(function() {
            ...
            $('#HousekeepingResponsibilityApproveForm').validate({
                rules: {
            ...
            $("#submit_id").click(function(){
             if($('#HousekeepingResponsibilityApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#HousekeepingResponsibilityApproveForm").submit();
             }
    ...
    <div class="nav panel panel-default">
        <div class="housekeepingResponsibilities form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Housekeeping Responsibility'); ?>
