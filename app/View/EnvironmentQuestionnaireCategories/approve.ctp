...
<h4><?php echo __('Approve Environment Questionnaire Category'); ?>		
    ...
    $.validator.setDefaults({
        submitHandler: function(form) {
            $(form).ajaxSubmit({
                ...
                type: 'POST',
                target: '#environmentQuestionnaireCategories_ajax',
                beforeSend: function(){
		...
		$().ready(function() {
    $("#submit-indicator").hide();
        $('#EnvironmentQuestionnaireCategoryApproveForm').validate();        
    });
</script>
