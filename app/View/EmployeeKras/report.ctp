...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($employeeKra['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($employeeKra['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($employeeKra['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($employeeKra['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("target_achieved"));?></th>
				<th><?php echo h(Inflector::humanize("final_rating"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($employeeKra['Employee']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($employeeKra['EmployeeKra']['publish']); ?>&nbsp;</td>
		<td><?php echo h($employeeKra['EmployeeKra']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($employeeKra['EmployeeKra']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($employeeKra['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($employeeKra['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($employeeKra['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($employeeKra['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($employeeKra['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($employeeKra['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
