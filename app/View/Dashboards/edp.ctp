                            ...
                            <div class="thumbnail">
                                <div class="caption">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <?php echo $this->Html->link(' ' . $this->requestAction('App/get_model_list/User/count'), array('controller' => 'users', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('FlinkISO Users'))); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="thumbnail">
                                <div class="caption">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <?php echo $this->Html->link(' ' . $this->requestAction('App/get_model_list/ListOfSoftware/count'), array('controller' => 'list_of_softwares', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('No. of Softwares'))); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="thumbnail">
                                <div class="caption">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <?php echo $this->Html->link(' ' . $this->requestAction('App/get_model_list/ListOfComputer/count'), array('controller' => 'list_of_computers', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('No. of Computers'))); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="thumbnail">
                                <div class="caption">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <?php echo $this->Html->link(' ' . $this->requestAction('App/get_model_list/ListOfComputerListOfSoftware/count'), array('controller' => 'list_of_computer_list_of_softwares', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('No. of Computers/Softwares'))); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="thumbnail">
                                <div class="caption">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <?php echo $this->Html->link(' ' . $this->requestAction('App/get_model_list/UsernamePasswordDetail/count'), array('controller' => 'username_password_details', 'action' => 'index'), array('type' => 'button', 'class' => 'btn btn-info', 'data-placement' => 'bottom', 'data-toggle' => 'tooltip', 'title' => __('No. of Usernames'))); ?>
