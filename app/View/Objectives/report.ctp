...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($objective['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($objective['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($objective['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($objective['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("clauses"));?></th>
				<th><?php echo h(Inflector::humanize("objective"));?></th>
				<th><?php echo h(Inflector::humanize("desired_output"));?></th>
				<th><?php echo h(Inflector::humanize("owner_id"));?></th>
				<th><?php echo h(Inflector::humanize("team"));?></th>
				<th><?php echo h(Inflector::humanize("requirments"));?></th>
				<th><?php echo h(Inflector::humanize("system_table"));?></th>
				<th><?php echo h(Inflector::humanize("input_process_id"));?></th>
				<th><?php echo h(Inflector::humanize("output_process_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($objective['Owner']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($objective['InputProcess']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objective['OutputProcess']['id']); ?>&nbsp;</td>
		<td><?php echo h($objective['Objective']['publish']); ?>&nbsp;</td>
		<td><?php echo h($objective['Objective']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($objective['Objective']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objective['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objective['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objective['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objective['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objective['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
