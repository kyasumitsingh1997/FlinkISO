			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('ListOfIssue',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","title"=>"Title","issue_details"=>"Issue Details","other_details"=>"Other Details","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#listOfIssues_ajax','type'=>'data','method'=>'post')); ?>
;									<?php echo $this->Form->end(); ?></li>
		...
		<?php echo $this->Form->create(array('class'=>'no-padding no-margin no-background'));?>				
			<table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
				...
				<th><?php echo $this->Paginator->sort('issue_details'); ?></th>
...
<?php foreach ($listOfIssues as $listOfIssue): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$listOfIssue['ListOfIssue']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><span class=" glyphicon glyphicon-wrench"></span></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $listOfIssue['ListOfIssue']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $listOfIssue['ListOfIssue']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $listOfIssue['ListOfIssue']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $listOfIssue['ListOfIssue']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $listOfIssue['ListOfIssue']['id']),array('class'=>''), __('Are you sure ?', $listOfIssue['ListOfIssue']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($listOfIssue['ListOfIssue']['sr_no']); ?>&nbsp;</td>
		<td><?php echo h($listOfIssue['ListOfIssue']['title']); ?>&nbsp;</td>
		<td><?php echo h($listOfIssue['ListOfIssue']['issue_details']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($listOfIssue['ListOfIssue']['other_details']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($listOfIssue['ListOfIssue']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($listOfIssue['ListOfIssue']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($listOfIssue['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $listOfIssue['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($listOfIssue['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $listOfIssue['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($listOfIssue['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $listOfIssue['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($listOfIssue['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $listOfIssue['PreparedBy']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#listOfIssues_ajax')));?>
...
<?php echo $this->Form->create('listOfIssues',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","title"=>"Title","issue_details"=>"Issue Details","other_details"=>"Other Details","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
