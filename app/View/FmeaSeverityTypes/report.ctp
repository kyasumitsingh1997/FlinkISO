...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fmeaSeverityType['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fmeaSeverityType['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fmeaSeverityType['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fmeaSeverityType['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("effect"));?></th>
	...
	<tr>
		...
		<td><?php echo h($fmeaSeverityType['FmeaSeverityType']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($fmeaSeverityType['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaSeverityType['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaSeverityType['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaSeverityType['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fmeaSeverityType['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
