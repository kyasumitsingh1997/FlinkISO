        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <tr class="on_page_src">
                    ...
                    <td>
                        <?php switch ($documentAmendmentRecordSheet['DocumentAmendmentRecordSheet']['request_from']) {
                            case 'Branch':
                                echo "<strong>Branch : </strong>" . $this->Html->link($documentAmendmentRecordSheet['Branch']['name'], array('controller' => 'branches', 'action' => 'view', $documentAmendmentRecordSheet['Branch']['id']));
                                break;

                            case 'Department':
                                echo "<strong>Department : </strong>" . $this->Html->link($documentAmendmentRecordSheet['Department']['name'], array('controller' => 'departments', 'action' => 'view', $documentAmendmentRecordSheet['Department']['id']));
                                break;

                            case 'Employee':
                                echo "<strong>Employee : </strong>" . $this->Html->link($documentAmendmentRecordSheet['Employee']['name'], array('controller' => 'employees', 'action' => 'view', $documentAmendmentRecordSheet['Employee']['id']));
                                break;

                            case 'Customer':
                                echo "<strong>Customer : </strong>" . $this->Html->link($documentAmendmentRecordSheet['Customer']['name'], array('controller' => 'customers', 'action' => 'view', $documentAmendmentRecordSheet['Customer']['id']));
                                break;

                            case 'SuggestionForm':
                                echo "<strong>Suggestion Form : </strong>" . $this->Html->link($documentAmendmentRecordSheet['SuggestionForm']['title'], array('controller' => 'Suggestion_forms', 'action' => 'view', $documentAmendmentRecordSheet['SuggestionForm']['id']));
                                break;

                            case 'Other':
                                echo "<strong>Other : </strong>" . h($documentAmendmentRecordSheet['DocumentAmendmentRecordSheet']['others']);
                                break;
                        }?>&nbsp;
                    </td>
