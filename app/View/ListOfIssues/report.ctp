...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($listOfIssue['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($listOfIssue['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($listOfIssue['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($listOfIssue['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("issue_details"));?></th>
				...
				<th><?php echo h(Inflector::humanize("other_details"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($listOfIssue['Branch']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfIssue['Department']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfIssue['Employee']['name']); ?>&nbsp;</td>
		<td><?php echo h($listOfIssue['ListOfIssue']['other_details']); ?>&nbsp;</td>
		<td><?php echo h($listOfIssue['ListOfIssue']['publish']); ?>&nbsp;</td>
		<td><?php echo h($listOfIssue['ListOfIssue']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($listOfIssue['ListOfIssue']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfIssue['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfIssue['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfIssue['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfIssue['PreparedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
