...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectTimesheet['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectTimesheet['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectTimesheet['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectTimesheet['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("user_id"));?></th>
				<th><?php echo h(Inflector::humanize("project_id"));?></th>
				<th><?php echo h(Inflector::humanize("project_activity_id"));?></th>
				<th><?php echo h(Inflector::humanize("start_time"));?></th>
				<th><?php echo h(Inflector::humanize("end_time"));?></th>
				<th><?php echo h(Inflector::humanize("activity_description"));?></th>
				<th><?php echo h(Inflector::humanize("total_time"));?></th>
				<th><?php echo h(Inflector::humanize("total_cost"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectTimesheet['User']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectTimesheet['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectTimesheet['ProjectActivity']['title']); ?>&nbsp;</td>
		...
		<td><?php echo h($projectTimesheet['ProjectTimesheet']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectTimesheet['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectTimesheet['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectTimesheet['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectTimesheet['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
