            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered">
                ...
                <?php if ($correctivePreventiveActions) {
                    ...
                    <tr class="text-danger on_page_src">
                     ...
                     echo $this->Html->link($capa_investigation_cnt,
                        array('controller'=>'capa_investigations','action'=>'index',$correctivePreventiveAction['CorrectivePreventiveAction']['id']),
                        array('class'=> ( $capa_investigation_cnt>0)? "btn btn-xs btn-success" : "btn btn-xs btn-danger", 'escape'=>false)
                        );  ?>
                    </div>
                    <?php } ?>
                </td>
                ...
                <td> <div class="btn-group">
                    ...
                    echo $this->Html->link($capa_root_cuase_analysis_cnt,
                        array('controller'=>'capa_investigations','action'=>'index',$correctivePreventiveAction['CorrectivePreventiveAction']['id']),
                        array('class'=> ( $capa_root_cuase_analysis_cnt>0)? "btn btn-xs btn-success" : "btn btn-xs btn-danger", 'escape'=>false)
                        );  ?>
                    </div>
