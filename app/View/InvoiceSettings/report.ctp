...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($invoiceSetting['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($invoiceSetting['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($invoiceSetting['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($invoiceSetting['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("sales_tax_number"));?></th>
				<th><?php echo h(Inflector::humanize("service_tax_number"));?></th>
				<th><?php echo h(Inflector::humanize("company_name"));?></th>
				<th><?php echo h(Inflector::humanize("banking_details"));?></th>
				<th><?php echo h(Inflector::humanize("footer"));?></th>
				<th><?php echo h(Inflector::humanize("contact_details"));?></th>
	...
	<tr>
		...
		<td><?php echo h($invoiceSetting['InvoiceSetting']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($invoiceSetting['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceSetting['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceSetting['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceSetting['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceSetting['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceSetting['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
