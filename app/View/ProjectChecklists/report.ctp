...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectChecklist['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectChecklist['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectChecklist['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectChecklist['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectChecklist['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectChecklist['Milestone']['title']); ?>&nbsp;</td>
		<td><?php echo h($projectChecklist['ProjectChecklist']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectChecklist['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectChecklist['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectChecklist['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectChecklist['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
