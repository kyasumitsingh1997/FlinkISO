...
<?php echo $this->fetch('script'); ?><div id="otherMeasurableUnits_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="otherMeasurableUnits form col-md-8">
<h4><?php echo __('Edit Other Measurable Unit'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('OtherMeasurableUnit',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
		echo "<div class='col-md-6'>".$this->Form->input('unit_name') . '</div>'; 
...
<script>
    ...
    $().ready(function() {
        ...
        $('#OtherMeasurableUnitEditForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#OtherMeasurableUnitEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#OtherMeasurableUnitEditForm').submit();
            }
