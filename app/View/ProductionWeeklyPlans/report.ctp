...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($productionWeeklyPlan['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($productionWeeklyPlan['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($productionWeeklyPlan['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($productionWeeklyPlan['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("production_planned"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($productionWeeklyPlan['Product']['name']); ?>&nbsp;</td>
		<td><?php echo h($productionWeeklyPlan['ProductionWeeklyPlan']['production_planned']); ?>&nbsp;</td>
		<td><?php echo h($productionWeeklyPlan['ProductionWeeklyPlan']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($productionWeeklyPlan['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionWeeklyPlan['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionWeeklyPlan['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionWeeklyPlan['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionWeeklyPlan['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
