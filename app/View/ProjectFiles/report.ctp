...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectFile['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectFile['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectFile['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectFile['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("assigned_date"));?></th>
				<th><?php echo h(Inflector::humanize("estimated_time"));?></th>
				<th><?php echo h(Inflector::humanize("completed_date"));?></th>
				<th><?php echo h(Inflector::humanize("start_date"));?></th>
				<th><?php echo h(Inflector::humanize("end_date"));?></th>
				<th><?php echo h(Inflector::humanize("actual_time"));?></th>
				<th><?php echo h(Inflector::humanize("comments"));?></th>
				<th><?php echo h(Inflector::humanize("current_status"));?></th>
				<th><?php echo h(Inflector::humanize("checked_by"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectFile['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFile['Milestone']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFile['Employee']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($projectFile['ProjectFile']['publish']); ?>&nbsp;</td>
		<td><?php echo h($projectFile['ProjectFile']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($projectFile['ProjectFile']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFile['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFile['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFile['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectFile['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
