...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($currency['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($currency['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($currency['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($currency['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($currency['Currency']['publish']); ?>&nbsp;</td>
		<td><?php echo h($currency['Currency']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($currency['Currency']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($currency['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($currency['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($currency['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($currency['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($currency['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
