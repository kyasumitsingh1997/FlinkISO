...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($continualImprovement['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($continualImprovement['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($continualImprovement['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($continualImprovement['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("internal_audit_id"));?></th>
				<th><?php echo h(Inflector::humanize("internal_audit_detail_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($continualImprovement['CorrectivePreventiveAction']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($continualImprovement['Process']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($continualImprovement['InternalAudit']['start_time']); ?>&nbsp;</td>
		<td width="50"><?php echo h($continualImprovement['InternalAuditDetail']['id']); ?>&nbsp;</td>
		<td><?php echo h($continualImprovement['ContinualImprovement']['details']); ?>&nbsp;</td>
		<td><?php echo h($continualImprovement['ContinualImprovement']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($continualImprovement['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($continualImprovement['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($continualImprovement['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($continualImprovement['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($continualImprovement['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($continualImprovement['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
