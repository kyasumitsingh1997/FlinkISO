...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($capaRootCauseAnalysi['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($capaRootCauseAnalysi['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($capaRootCauseAnalysi['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($capaRootCauseAnalysi['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("root_cause_details"));?></th>
				<th><?php echo h(Inflector::humanize("determined_by"));?></th>
				<th><?php echo h(Inflector::humanize("determined_on_date"));?></th>
				<th><?php echo h(Inflector::humanize("root_cause_remarks"));?></th>
				<th><?php echo h(Inflector::humanize("proposed_action"));?></th>
				<th><?php echo h(Inflector::humanize("action_assigned_to"));?></th>
				<th><?php echo h(Inflector::humanize("action_completed_on_date"));?></th>
				<th><?php echo h(Inflector::humanize("action_completion_remarks"));?></th>
				<th><?php echo h(Inflector::humanize("effectiveness"));?></th>
				<th><?php echo h(Inflector::humanize("closure_remarks"));?></th>
				<th><?php echo h(Inflector::humanize("current_status"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($capaRootCauseAnalysi['CorrectivePreventiveAction']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRootCauseAnalysi['Employee']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($capaRootCauseAnalysi['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRootCauseAnalysi['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRootCauseAnalysi['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($capaRootCauseAnalysi['PreparedBy']['name']); ?>&nbsp;</td>
		<td><?php echo h($capaRootCauseAnalysi['CapaRootCauseAnalysi']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($capaRootCauseAnalysi['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
