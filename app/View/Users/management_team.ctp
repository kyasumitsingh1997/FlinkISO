...
<div  id="main">
    ...
    <div class="users ">
        <?php echo $this->element('nav-header-lists', array('postData' => array('pluralHumanName' => 'Management Team', 'modelClass' => 'User', 'options' => array("sr_no" => "Sr No", "name" => "Name", "username" => "Username", "is_mr" => "Is Mr", "is_view_all" => "Is View All", "is_approvar" => "Is Approvar", "status" => "Status", "login_status" => "Login Status", "last_login" => "Last Login", "last_activity" => "Last Activity", "user_access" => "User Access", "email_token_expires" => "Email Token Expires"), 'pluralVar' => 'users'))); ?>
