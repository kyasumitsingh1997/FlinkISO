...
<script>
    ...
    $().ready(function() {
        ...
        $('#FireExtinguisherApproveForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#FireExtinguisherApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#FireExtinguisherApproveForm").submit();
             }
...
<div id="fireExtinguishers_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="fireExtinguishers form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Fire Extinguisher'); ?>
