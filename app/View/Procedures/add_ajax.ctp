...
<h4>Add Procedure</h4>
<?php echo $this->Form->create('Procedure',array('role'=>'form','class'=>'form','default'=>false)); ?>
<div class="row">
		<fieldset>
			<?php
		echo "<div class='col-md-6'>".$this->Form->input('number',array()) . '</div>'; 
...
<?php
	...
	if ($showApprovals && $showApprovals['show_panel'] == true) {
		...
		echo $this->Form->input('publish', array('label' => __('Publish')));
            ...
            ?><?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#procedures_ajax','async' => 'false')); ?>
