...
<script>
	...
	$("#submit_id").click(function(){
             if($('#DeviceApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#DeviceApproveForm").submit();
             }
        });
...
<div id="devices_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="devices form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Device'); ?>
          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <?php echo $this->Form->input('id'); ?>
                <fieldset><legend><h4><?php echo __('Device Details') ?></h4></legend>
                    ...
                    <div class="col-md-6"><?php echo $this->Form->input('device_category_id', array('label' => __('Category'))); ?></div>
                    <div class="col-md-6"><?php echo $this->Form->input('number', array('label' => __('Number'))); ?></div>
                    <div class="col-md-6"><?php echo $this->Form->input('serial', array('label' => __('Serial'))); ?></div>
			...
			<div id="maintenanceDetails">
                ...
                <div class="row">
                    <br /><br />
                        ...
                        <div class="col-md-5"><?php echo $this->Form->input('employee_id', array('style' => 'width:100%', 'label' => __('Person Responsible for Maintenance'))); ?></div>
                        <div class="col-md-4"><?php echo $this->Form->input('branch_id', array('style' => 'width:100%', 'label' => __('Branch'))); ?></div>
                        <div class="col-md-3"><?php echo $this->Form->input('department_id', array('style' => 'width:100%', 'label' => __('Department'))); ?></div>
