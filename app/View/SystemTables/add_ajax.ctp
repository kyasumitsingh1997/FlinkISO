...
<div class="systemTables form col-md-8">
    ...
    <fieldset>
	<?php
	    echo $this->Form->input('name',array('value'=>Inflector::humanize($this->request->params['pass'][0])));
	    echo $this->Form->input('system_name',array('value'=>$this->request->params['pass'][0]));
	    echo $this->Form->input('evidence_required',array('checked'=>true));
	    echo $this->Form->input('approvals_required',array('checked'=>true));
        echo $this->Form->input('reports');
	    echo $this->Form->input('branchid',array('type'=>'hidden','value'=>$this->Session->read('User.branch_id')));
	    echo $this->Form->input('departmentid',array('type'=>'hidden','value'=>$this->Session->read('User.department_id')));
	    echo $this->Form->input('master_list_of_format_id',array('type'=>'hidden','value'=>$documentDetails['MasterListOfFormat']['id']));
	?>
	<?php echo $this->Form->input('publish', array('checked'=>'true', 'label'=> __('Publish'))); ?>
