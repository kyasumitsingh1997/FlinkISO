...
<?php echo $this->Session->flash();?>	
	<div class="otherMeasurableUnitValues ">
		...
		<div class="nav">
			<div id="tabs">	
				<ul>
					<li><?php echo $this->Html->link(__('New Other Measurable Unit Value'), array('action' => 'add_ajax')); ?></li>
					<li><?php // echo $this->Html->link(__('Add Other Measurable Unit'), array('controller' => 'other_measurable_units', 'action' => 'add_ajax')); ?> </li>
	...
	<div id="otherMeasurableUnitValues_tab_ajax"></div>
</div>
