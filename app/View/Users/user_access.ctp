...
<div class="panel">
    <div class="panel-heading">
        <h2><small><?php echo $this->Html->link('Users',array('action'=>'index')); ?> / </small> Set User Access for : <?php echo $this->request->data['User']['username']; ?></h2>
    </div>
        ...
        <div class="panel-group" id="accordion">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    echo $this->Form->input('assigned_branches[]',array(
                            'label'=>'Select Branches',
                            'id'=> 'AssignedBranches',
                            'name'=>'User.assigned_branches[]',
                            'multiple',
...
$().ready(function() {
        ...
        // $('#AssignedBranches').trigger("list:updated");
});
