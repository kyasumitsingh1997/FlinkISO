...
<?php echo $this->fetch('script'); ?><div id="masterListOfFormatCategories_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="masterListOfFormatCategories form col-md-8">
<h4><?php echo __('Edit Master List Of Format Category'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('MasterListOfFormatCategory',array('role'=>'form','class'=>'form')); ?>
<div class="row">
	<?php
...
<script>
    ...
    $().ready(function() {
        ...
        $('#MasterListOfFormatCategoryEditForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#MasterListOfFormatCategoryEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#MasterListOfFormatCategoryEditForm').submit();
            }
