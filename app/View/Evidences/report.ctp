...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($evidence['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($evidence['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($evidence['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($evidence['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("description"));?></th>
				<th><?php echo h(Inflector::humanize("model_name"));?></th>
				<th><?php echo h(Inflector::humanize("record"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($evidence['FileUpload']['id']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($evidence['UserSession']['id']); ?>&nbsp;</td>
		<td><?php echo h($evidence['Evidence']['publish']); ?>&nbsp;</td>
		<td><?php echo h($evidence['Evidence']['record_status']); ?>&nbsp;</td>
		<td width="50"><?php echo h($evidence['StatusUserId']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($evidence['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($evidence['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($evidence['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($evidence['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($evidence['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
