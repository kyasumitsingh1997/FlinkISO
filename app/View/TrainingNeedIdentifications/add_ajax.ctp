...
<div id="trainingNeedIdentifications_ajax">
    <?php echo $this->Session->flash(); ?><div class="nav">
        <div class="trainingNeedIdentifications form col-md-8">
            ...
            <div class="row">
                <div class="col-md-6"><?php echo $this->Form->input('employee_id', array('type'=>'select', 'default'=>$this->request->params['pass'][0], 'options'=>$PublishedEmployeeList,'style' => 'width:100%', 'label' => __('Employee'))); ?></div>
