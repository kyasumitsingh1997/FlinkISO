...
<div  id="main">
    ...
    <div class="deviceMaintenances ">
        <h4><?php echo __('Pending Device Maintenance'); ?></h4>
        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <tr class="on_page_src">
                    ...
                    <td><div id="<?php echo $deviceMaintenance['DeviceMaintenance']['id']?>-deviceMaintenanceDiv">
                            <?php echo $this->Html->link('Remind',array('controller'=>'customer_complaints','action'=>'send_reminder'),array('class'=>'btn btn-xs btn-danger','default'=>false,'id'=>$deviceMaintenance['DeviceMaintenance']['id'].'-deviceMaintenance'));?>
                        <div>
                        <script type="text/javascript">
                            $("#<?php echo $deviceMaintenance['DeviceMaintenance']['id']?>-deviceMaintenance").click(function(){
                                $("#<?php echo $deviceMaintenance['DeviceMaintenance']['id']?>-deviceMaintenanceDiv").html("<span class='btn btn-xs btn-warning'>Sending... <i class='fa fa-spinner fa-spin fa-1x fa-fw'></i></span>");
                                $("#<?php echo $deviceMaintenance['DeviceMaintenance']['id']?>-deviceMaintenanceDiv").load("<?php echo Router::url('/', true); ?><?php echo $this->request->params['controller'] ?>/send_reminder/<?php echo $deviceMaintenance['DeviceMaintenance']['id']?>");
                            });
                        </script>
                    </td>
                </tr>
