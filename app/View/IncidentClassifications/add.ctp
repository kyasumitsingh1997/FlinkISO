...
<h4><?php echo __('Add Incident Classification'); ?>		
...
<script>
    ...
    $().ready(function() {
        $('#IncidentClassificationAddForm').validate();
        $("#submit-indicator").hide();
        $("#submit_id").click(function(){
            if($('#IncidentClassificationAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#IncidentClassificationAddForm').submit();
            }
