...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($productionRejection['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($productionRejection['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($productionRejection['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($productionRejection['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("production_id"));?></th>
				<th><?php echo h(Inflector::humanize("product_id"));?></th>
				<th><?php echo h(Inflector::humanize("production_inspection_template_id"));?></th>
				<th><?php echo h(Inflector::humanize("total_quantity"));?></th>
				<th><?php echo h(Inflector::humanize("sample_quantity"));?></th>
				<th><?php echo h(Inflector::humanize("quality_check_date"));?></th>
				<th><?php echo h(Inflector::humanize("start_sr_number"));?></th>
				<th><?php echo h(Inflector::humanize("end_sr_number"));?></th>
				<th><?php echo h(Inflector::humanize("number_of_rejections"));?></th>
				<th><?php echo h(Inflector::humanize("employee_id"));?></th>
				<th><?php echo h(Inflector::humanize("supplier_registration_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($productionRejection['Production']['batch_number']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionRejection['Product']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionRejection['ProductionInspectionTemplate']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($productionRejection['Employee']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionRejection['SupplierRegistration']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionRejection['CustomerContact']['name']); ?>&nbsp;</td>
		<td><?php echo h($productionRejection['ProductionRejection']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($productionRejection['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionRejection['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionRejection['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionRejection['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionRejection['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
