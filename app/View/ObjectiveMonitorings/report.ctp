...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($objectiveMonitoring['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($objectiveMonitoring['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($objectiveMonitoring['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($objectiveMonitoring['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("analysis"));?></th>
				<th><?php echo h(Inflector::humanize("improvements_required"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($objectiveMonitoring['Objective']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objectiveMonitoring['Process']['title']); ?>&nbsp;</td>
		...
		<td><?php echo h($objectiveMonitoring['ObjectiveMonitoring']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($objectiveMonitoring['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objectiveMonitoring['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objectiveMonitoring['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objectiveMonitoring['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($objectiveMonitoring['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
