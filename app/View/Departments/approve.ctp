<div id="departments_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="departments form col-md-8">
            <h4><?php echo __('Approve Department'); ?>
          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-12"><?php echo $this->Form->input('name', array('disabled', 'label' => __('Department Name'))); ?>
                    <?php echo $this->Form->hidden('old_name', array('value' => $this->data['Department']['name'])); ?>
                </div>
                <div class="col-md-12">
