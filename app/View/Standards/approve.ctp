...
<h4><?php echo __('Approve Standard'); ?>		
...
<div class="row">
		...
		echo "<div class='col-md-6 hide'>".$this->Form->input('division_id',array('style'=>'')) . '</div>'; 
	?>
<?php
