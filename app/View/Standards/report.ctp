...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($standard['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($standard['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($standard['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($standard['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($standard['Standard']['publish']); ?>&nbsp;</td>
		<td><?php echo h($standard['Standard']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($standard['Standard']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($standard['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($standard['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($standard['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($standard['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($standard['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($standard['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
