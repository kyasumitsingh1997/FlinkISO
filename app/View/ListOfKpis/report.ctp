...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($listOfKpi['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($listOfKpi['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($listOfKpi['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($listOfKpi['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("kpi_details"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($listOfKpi['Branch']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfKpi['Department']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfKpi['Employee']['name']); ?>&nbsp;</td>
		<td><?php echo h($listOfKpi['ListOfKpi']['other_details']); ?>&nbsp;</td>
		<td><?php echo h($listOfKpi['ListOfKpi']['publish']); ?>&nbsp;</td>
		<td><?php echo h($listOfKpi['ListOfKpi']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($listOfKpi['ListOfKpi']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfKpi['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfKpi['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfKpi['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfKpi['PreparedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
