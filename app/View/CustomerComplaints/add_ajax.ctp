...
<div class="nav">
    <div class="customerComplaints form col-md-8">
        ...
        <div class="row">
            <div class="col-md-6"><br /><strong><?php echo 'Customer complaint number : ' . $customer_number;  ?></strong>
                <?php echo $this->Form->hidden('complaint_number',array('value'=>$customer_number)); ?></div>
