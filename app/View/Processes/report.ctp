...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($process['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($process['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($process['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($process['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($process['Objective']['title']); ?>&nbsp;</td>
		<td><?php echo h($process['Process']['clauses']); ?>&nbsp;</td>
		<td><?php echo h($process['Process']['process_requirments']); ?>&nbsp;</td>
		<td width="50"><?php echo h($process['InputProcess']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($process['OutputProcess']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($process['Schedule']['name']); ?>&nbsp;</td>
		<td><?php echo h($process['Process']['publish']); ?>&nbsp;</td>
		<td><?php echo h($process['Process']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($process['Process']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($process['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($process['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($process['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($process['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($process['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
