...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($valueDriver['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($valueDriver['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($valueDriver['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($valueDriver['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($valueDriver['ValueDriver']['publish']); ?>&nbsp;</td>
		<td><?php echo h($valueDriver['ValueDriver']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($valueDriver['ValueDriver']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($valueDriver['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($valueDriver['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($valueDriver['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($valueDriver['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($valueDriver['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
