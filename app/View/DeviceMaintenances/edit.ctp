...
<script>
    ...
    $().ready(function() {
        ...
        $('#DeviceMaintenanceEditForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#DeviceMaintenanceEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#DeviceMaintenanceEditForm").submit();
             }
        });
...
<div id="deviceMaintenances_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="deviceMaintenances form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Device Maintenance'); ?>
...
<script>
    ...
    $("[name*='maintenance_performed_date']").datepicker('option', 'maxDate', 0);
    $("[name*='next_maintanence_date']").datepicker('option', 'minDate', 0);
