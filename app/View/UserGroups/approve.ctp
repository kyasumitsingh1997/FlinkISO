...
<h4><?php echo __('Approve User Group'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('UserGroup',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
		echo "<div class='col-md-6'>".$this->Form->input('title') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('group_leader') . '</div>'; 
		echo "<div class='col-md-12'>".$this->Form->input('group_members') . '</div>'; 
	?>
<?php
