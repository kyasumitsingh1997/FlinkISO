...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fileView['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fileView['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fileView['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fileView['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($fileView['FileUpload']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileView['User']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileView['UserSession']['id']); ?>&nbsp;</td>
		<td><?php echo h($fileView['FileView']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fileView['FileView']['record_status']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileView['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileView['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileView['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileView['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileView['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileView['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
