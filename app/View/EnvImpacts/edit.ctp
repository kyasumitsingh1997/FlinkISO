...
<?php echo $this->fetch('script'); ?><div id="envImpacts_ajax">
<?php echo $this->Session->flash();?>	
<div class="nav panel panel-default">
<div class="envImpacts form col-md-8">
<h4><?php echo __('Edit Env Impact'); ?>		
		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
		
		</h4>
<?php echo $this->Form->create('EnvImpact',array('role'=>'form','class'=>'form')); ?>
<div class="row">
			<?php
...
<script>
    ...
    $().ready(function() {
        ...
        $("#submit_id").click(function(){
            if($('#EnvImpactEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#EnvImpactEditForm').submit();
            }
