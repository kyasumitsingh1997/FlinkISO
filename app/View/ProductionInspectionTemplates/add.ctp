...
<h4><?php echo __('Add Production Inspection Template'); ?>		
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProductionInspectionTemplateAddForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProductionInspectionTemplateAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProductionInspectionTemplateAddForm').submit();
            }
