          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <table class="table table-responsive">
                ...
                <tr><td><?php echo __('Complaint Date'); ?></td>
                    <td>
                        <?php if($customerComplaint['CustomerComplaint']['complaint_date'] != '1970-01-01')echo h($customerComplaint['CustomerComplaint']['complaint_date']); ?>
                        &nbsp;
                    </td></tr>
                ...
                <tr><td><?php echo __('Action Taken Date'); ?></td>
                    <td>
                        <?php if($customerComplaint['CustomerComplaint']['action_taken_date']!= '1970-01-01')echo h($customerComplaint['CustomerComplaint']['action_taken_date']); ?>
                        &nbsp;
                    </td></tr>
                ...
                <tr><td><?php echo __('Settled Date'); ?></td>
                    <td>
                        <?php if($customerComplaint['CustomerComplaint']['settled_date'] != '1970-01-01')echo h($customerComplaint['CustomerComplaint']['settled_date']); ?>
                        &nbsp;
                    </td></tr>
