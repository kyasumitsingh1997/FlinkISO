...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($internalAuditQuestion['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($internalAuditQuestion['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($internalAuditQuestion['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($internalAuditQuestion['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("clause"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($internalAuditQuestion['Department']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($internalAuditQuestion['InternalAuditQuestion']['publish']); ?>&nbsp;</td>
		<td><?php echo h($internalAuditQuestion['InternalAuditQuestion']['record_status']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditQuestion['StatusUserId']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditQuestion['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditQuestion['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditQuestion['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditQuestion['DepartmentIds']['name']); ?>&nbsp;</td>
