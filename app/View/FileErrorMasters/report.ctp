...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fileErrorMaster['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fileErrorMaster['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fileErrorMaster['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fileErrorMaster['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($fileErrorMaster['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileErrorMaster['Milestone']['title']); ?>&nbsp;</td>
		<td><?php echo h($fileErrorMaster['FileErrorMaster']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($fileErrorMaster['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileErrorMaster['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileErrorMaster['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileErrorMaster['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
