...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fileShare['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fileShare['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fileShare['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fileShare['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("file_upload_id"));?></th>
				<th><?php echo h(Inflector::humanize("branch_id"));?></th>
				<th><?php echo h(Inflector::humanize("everyone"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($fileShare['FileUpload']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileShare['Branch']['name']); ?>&nbsp;</td>
		<td><?php echo h($fileShare['FileShare']['everyone']); ?>&nbsp;</td>
		<td><?php echo h($fileShare['FileShare']['users']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileShare['UserSession']['id']); ?>&nbsp;</td>
		<td><?php echo h($fileShare['FileShare']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fileShare['FileShare']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fileShare['FileShare']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileShare['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileShare['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileShare['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileShare['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileShare['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
