...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectQueryResponse['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectQueryResponse['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectQueryResponse['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectQueryResponse['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("project_query_id"));?></th>
				<th><?php echo h(Inflector::humanize("level"));?></th>
				<th><?php echo h(Inflector::humanize("raised_by"));?></th>
				<th><?php echo h(Inflector::humanize("employee_id"));?></th>
				<th><?php echo h(Inflector::humanize("response"));?></th>
				<th><?php echo h(Inflector::humanize("sent_to_client"));?></th>
				<th><?php echo h(Inflector::humanize("client_response"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectQueryResponse['ProjectQuery']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectQueryResponse['Employee']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($projectQueryResponse['ProjectQueryResponse']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectQueryResponse['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQueryResponse['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQueryResponse['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectQueryResponse['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
