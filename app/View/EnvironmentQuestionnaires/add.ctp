...
<h4><?php echo __('Add Environment Questionnaire'); ?>		
...
<script>
    ...
    $().ready(function() {
        $('#EnvironmentQuestionnaireAddForm').validate();
        $("#submit-indicator").hide();
        $("#submit_id").click(function(){
            if($('#EnvironmentQuestionnaireAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#EnvironmentQuestionnaireAddForm').submit();
            }
