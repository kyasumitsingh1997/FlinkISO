...
<h4><?php echo __('Approve History'); ?>		
...
<?php echo $this->Form->create('History',array('role'=>'form','class'=>'form')); ?>
	...
	<?php
		...
		echo $this->Form->input('get_values'); 
		echo $this->Form->input('post_values'); 
		echo $this->Form->input('user_session_id',array('style'=>'width:90%')); 
		echo $this->Js->link('Add New',array('controller'=>'user_sessions','action'=>'add'),array('class'=>'label btn-info','update'=>'#histories_ajax'));
