...
<h4><?php echo __('Add Email Trigger'); ?>		
...
<div class="row">
		...
		echo "<div class='col-md-6'>".$this->Form->input('changed_field') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('if_added') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('if_edited') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('if_publish') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('if_approved') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('if_soft_delete') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('recipents') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('cc') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('bcc') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('subject') . '</div>'; 
		echo "<div class='col-md-6'>".$this->Form->input('template') . '</div>'; 
	?>
<?php
