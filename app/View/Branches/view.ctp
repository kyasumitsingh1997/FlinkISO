          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <table class="table table-responsive">
                ...
                <tr><td><?php echo __('Details'); ?></td>
                    <td>
                        <?php echo nl2br($branch['Branch']['details']); ?>
                        &nbsp;
                    </td>
                </tr>
                <tr><td><?php echo __('Departments under this branch/location'); ?></td>
                    <td>
                        <?php 
                            $departments = json_decode($branch['Branch']['departments'],true);
                            foreach ($departments as $key => $value) {
                                echo $PublishedDepartmentList[$value].','; 
                            }
