    ...
    <body>
        <div style='float:left;width:99%; display:block;padding:2px;margin:2px;'>
            ...
            <div style='background:#16AFDD;margin:0px; float:left; padding:0; border-bottom:1px dashed #FFFFFF; color:#fff; width:100%; text-shadow:0px 0px 1px #000000; line-height:19px'>
                <h2 style='padding-left:20px'>Login Details</h2>  
            </div>
                ...
                <table>
                    <tr>
                        <td style='padding:10px'>
                            Dear User,<br/><br/>
                            Below are the login details for the QMS.<br/><br/>
                            <br/><br/>
                            URL : ".$url."<br/>
                            Login Id :".$username."<br/>
                            Password :".$password."<br/>
                            <br/><br/>
                            You can change your password by using change password button after login.                            
                            <br/>                            
                        </td>
                    </tr>
                </table>
