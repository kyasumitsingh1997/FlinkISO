...
<script>
    $.validator.setDefaults({
        ...
        errorPlacement: function (error, element) {
            ...
            } else if ($(element).attr('name') == 'data[CorrecCAPA InvestigationstivePreventiveAction][capa_category_id]') {
                $(element).next().after(error);
    ...
    $().ready(function(){
        ...
        $("#submit_id").click(function(){
             if($('#CorrectivePreventiveActionEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#CorrectivePreventiveActionEditForm").submit();
             }
        });
        ...
        $('#CorrectivePreventiveActionEditForm').validate({
            rules: {
              ...
              <div class="tab-content">
                <?php foreach($capaRootCauseAnalysis as $capaRootCauseAnalysi){ ?> 
                    <div role="tabpanel" class="tab-pane" id="rootc_<?php echo $capaRootCauseAnalysi['CapaRootCauseAnalysi']['id'] ?>">
                        ...
                        <?php echo $this->Html->link('Edit',array('controller'=>'capa_root_cause_analysis','action'=>'edit',$capaRootCauseAnalysi['CapaRootCauseAnalysi']['id']),array('target'=>'_blank', 'class'=>'btn btn-sm btn-primary'));?>
                    </div>
                <?php } ?>
              </div>
            </div>            
