...
<?php echo $this->Session->flash();?>	
	<div class="projectFileEmployees ">
		<?php echo $this->element('nav-header-lists',array('postData'=>array('pluralHumanName'=>'Project File Employees','modelClass'=>'ProjectFileEmployee','options'=>array("sr_no"=>"Sr No","current_status"=>"Current Status"),'pluralVar'=>'projectFileEmployees'))); ?>
...
<?php foreach ($projectFileEmployees as $projectFileEmployee): ?>
	<tr>
	<td class=" actions">	<?php echo $this->element('actions', array('created' => $projectFileEmployee['ProjectFileEmployee']['created_by'], 'postVal' => $projectFileEmployee['ProjectFileEmployee']['id'], 'softDelete' => $projectFileEmployee['ProjectFileEmployee']['soft_delete'])); ?>	</td>		<td>
		...
		<td><?php echo h($PublishedEmployeeList[$projectFileEmployee['ProjectFileEmployee']['prepared_by']]); ?>&nbsp;</td>
		<td><?php echo h($PublishedEmployeeList[$projectFileEmployee['ProjectFileEmployee']['approved_by']]); ?>&nbsp;</td>
