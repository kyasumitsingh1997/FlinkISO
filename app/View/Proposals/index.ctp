...
<div  id="main">
    ...
    <div class="proposals ">
<?php if($this->request->params['named']['hide_panel'] == false){ ?>
...
<?php }else{ ?>
	<div class="nav">
		<div class="col-md-12">
		<?php echo $this->Html->link('BD Dashboard',array('controller'=>'dashboards','action'=>'bd'),array('class'=>'pull-right')); ?>
<?php } ?>
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('approved_by'); ?></th>
					  <th style="min-width: 190px"><?php echo __('Required Action'); ?></th>
                    ...
                    if ($proposal['Proposal']['active_lock'] == 1) {
                        if (($proposal['Proposal']['created_by'] == $this->Session->read('User.id') || ($this->Session->read('User.is_mr') == true))) {
                            ...
                            <td>
                                <div class="btn-group">
                                <?php 
										if($proposal['Proposal']['proposal_status'] == 0) echo $this->Html->link('Send', array('controller' => 'proposals', 'action' => 'send_to_customer', $proposal['Proposal']['id']), array('class' => 'btn btn-group btn-sm btn-danger', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Total')); 
										else echo $this->Html->link('Send', array('controller' => 'proposals', 'action' => 'send_to_customer', $proposal['Proposal']['id']), array('class' => 'btn btn-group btn-sm btn-success disabled', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Total'));
									?>    
									<?php echo $this->Html->link('Follow Ups', array('controller' => 'proposal_followups', 'action' => 'lists', $proposal['Proposal']['id']), array('class' => 'btn btn-group btn-sm btn-info', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Total')); ?>
                        ...
                        <td>
                            <div class="btn-group">
									<?php if($proposal['Proposal']['proposal_status'] == 0) echo $this->Html->link('Send', array('controller' => 'proposals', 'action' => 'send_to_customer', $proposal['Proposal']['id']), array('class' => 'btn btn-xs btn-danger', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Send')); 
										else echo $this->Html->link('Send', array('controller' => 'proposals', 'action' => 'send_to_customer', $proposal['Proposal']['id']), array('class' => 'btn btn-xs btn-success disabled', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Send'));
									?>
                                <?php echo $this->Html->link('Follow Ups', array('controller' => 'proposal_followups', 'action' => 'lists', $proposal['Proposal']['id']), array('class' => 'btn btn-xs btn-info', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Follow ups')); ?>
                                <?php echo $this->Html->link($c, '#', array('id' => 'count', 'class' => 'btn btn-xs btn-warning', 'data-toggle' => 'tooltip', 'data-placement' => 'bottom', 'data-original-title' => 'Total')); ?><script>$('#count').tooltip();</script>
                            </div>&nbsp;
...
<?php if($this->request->params['named']['hide_panel'] == true){ ?>
	</div>
</div>	
<?php } ?>
