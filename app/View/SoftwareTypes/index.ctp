        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <tr class="on_page_src">
                    <td class=" actions">
                        <?php echo $this->element('actions', array('created' => $softwareType['SoftwareType']['created_by'], 'postVal' => $softwareType['SoftwareType']['id'], 'softDelete' => $softwareType['SoftwareType']['soft_delete'])); ?>
                    </td>
                    <td><?php echo h($softwareType['SoftwareType']['title']); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$softwareType['SoftwareType']['prepared_by']]); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$softwareType['SoftwareType']['approved_by']]); ?>&nbsp;</td>
                    <td width="60">
