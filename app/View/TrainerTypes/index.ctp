...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        <div class="table-responsive">
            <?php echo $this->Form->create('index', array('class' => 'no-padding no-margin no-background')); ?>
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <tr class="on_page_src">
                    <td class=" actions">
                        <?php echo $this->element('actions', array('created' => $trainerType['TrainerType']['created_by'], 'postVal' => $trainerType['TrainerType']['id'], 'softDelete' => $trainerType['TrainerType']['soft_delete'])); ?>
                    </td>
                    <td><?php echo h($trainerType['TrainerType']['title']); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$trainerType['TrainerType']['prepared_by']]); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$trainerType['TrainerType']['approved_by']]); ?>&nbsp;</td>
                    <td width="60">
