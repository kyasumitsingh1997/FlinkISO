...
<h4><?php echo __('Add Project Release Request'); ?>		
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProjectReleaseRequestAddForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProjectReleaseRequestAddForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProjectReleaseRequestAddForm').submit();
            }
