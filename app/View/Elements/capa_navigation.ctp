...
<div class="row">
    <div class="col-md-7">
        ...
        <h4>
            ...
            <span class=""></span>
            <?php echo $this->Html->link('', array('action' => 'index'), array('id' => 'gridcall', 'class' => 'fa fa-list h4-title', 'data-original-title' => 'Switch to grid mode')); ?>
            <script>$('#gridcall').tooltip();</script>            
        </h4>
    </div>
    <div class="col-md-3"></div>
    <div class="col-md-2">
    <?php echo $this->Html->link('Advance Search', array('action' => '#capa_advanced_search_modal'), array('id' => 'ad_src', 'class' => 'btn btn-success pull-right', 'data-toggle' => 'modal', 'data-original-title' => 'Advanced Search', 'style' => 'margin-top:25px;margin-right:10px;padding-left:20px;padding-right:20px;')); ?>
    </div>
