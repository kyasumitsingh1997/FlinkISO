...
<div id="fireTypes_ajax">
    ...
    <div class="nav">
        <div class="fireTypes form col-md-8">
            <h4><?php echo __('Add Fire Type'); ?></h4>
            <?php echo $this->Form->create('FireType', array('role' => 'form', 'class' => 'form', 'default' => false)); ?>
            ...
            ?>
            <?php echo $this->Form->submit(__('Submit'), array('div' => false, 'class' => 'btn btn-primary btn-success', 'update' => '#fireTypes_ajax', 'async' => 'false','id'=>'submit_id')); ?>
