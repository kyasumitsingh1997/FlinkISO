...
<h4><?php echo __('Edit Production Rejection'); ?>		
				...
				<div id="rejectiondetails_ajax">
					...
					foreach ($rejections as $rejection) { ?>
						<div id="rejectiondetails_ajax<?php echo $i; ?>">
							<?php echo "<div class='col-md-5'>".$this->Form->input('RejectionDetail.'.$i.'.defect_type_id',array('value'=>$rejection['RejectionDetail']['defect_type_id'])) . '</div>';
						echo "<div class='col-md-5'>".$this->Form->input('RejectionDetail.'.$i.'.number_of_rejections',array('value'=>$rejection['RejectionDetail']['number_of_rejections'])) . '</div>';
						echo "<div class='col-md-2'><br /><span class='text-danger glyphicon glyphicon-remove danger pull-right' style='font-size:20px;background:none' type='button' onclick='removeAgendaDiv(".$i.")'></span></div>"; 
						$i++; ?>
						</div>
					<?php } ?>
...
<script>
    ...
    $().ready(function() {
        ...
        $('#ProductionRejectionEditForm').validate({        	
            rules: {
        ...
        $("#submit_id").click(function(){
            if($('#ProductionRejectionEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                $('#ProductionRejectionEditForm').submit();
            }
