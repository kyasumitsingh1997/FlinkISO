...
<script>
    ...
    $().ready(function() {
        ...
        $('#ListOfSoftwareApproveForm').validate({
            rules: {
            ...
            $("#submit_id").click(function(){
             if($('#ListOfSoftwareApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#ListOfSoftwareApproveForm").submit();
             }
...
<div id="listOfSoftwares_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="listOfSoftwares form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve List Of Software'); ?>
          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-3"><?php echo $this->Form->input('schedule_id', array('label' => __('Backup Schedule'))); ?></div>
            </div>
