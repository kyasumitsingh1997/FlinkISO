        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('training_id', __('Training')); ?></th>
                    <th><?php echo $this->Paginator->sort('is_it_fulfilled', __('is it Fulfilled')); ?></th>
                    <th><?php echo $this->Paginator->sort('prepared_by'); ?></th>
                    <th><?php echo $this->Paginator->sort('approved_by'); ?></th>
                    <th><?php echo $this->Paginator->sort('publish', __('Publish')); ?></th>
                </tr>
                <?php
                    if ($trainingEvaluations) {
                        $x = 0;
                        foreach ($trainingEvaluations as $trainingEvaluation):
                ?>
                <tr class="on_page_src">
                    <td class=" actions">
                        <?php echo $this->element('actions', array('created' => $trainingEvaluation['TrainingEvaluation']['created_by'], 'postVal' => $trainingEvaluation['TrainingEvaluation']['id'], 'softDelete' => $trainingEvaluation['TrainingEvaluation']['soft_delete'])); ?>
                    </td>
                    <td>
                    ...
                    <td><?php echo $trainingEvaluation['TrainingEvaluation']['is_it_fulfilled']; ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$trainingEvaluation['TrainingEvaluation']['prepared_by']]); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$trainingEvaluation['TrainingEvaluation']['approved_by']]); ?>&nbsp;</td>
                    <td width="60">
