...
<?php echo $this->Session->flash();?>	
	<div class="documents ">
		...
		<div class="nav">
			<div id="tabs">	
				<ul>
					<li><?php echo $this->Html->link(__('New Document'), array('action' => 'add_ajax')); ?></li>
...
<script>$.ajaxSetup({cache:false; beforeSend:function(){$("#busy-indicator").show();},complete:function(){$("#busy-indicator").hide();}});</script>