...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($auditTypeMaster['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($auditTypeMaster['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($auditTypeMaster['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($auditTypeMaster['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("reference"));?></th>
	...
	<tr>
		...
		<td><?php echo h($auditTypeMaster['AuditTypeMaster']['publish']); ?>&nbsp;</td>
		<td><?php echo h($auditTypeMaster['AuditTypeMaster']['record_status']); ?>&nbsp;</td>
		<td width="50"><?php echo h($auditTypeMaster['StatusUser']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($auditTypeMaster['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($auditTypeMaster['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
