...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($envIdentification['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($envIdentification['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($envIdentification['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($envIdentification['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("env_activity_id"));?></th>
				<th><?php echo h(Inflector::humanize("aspect_number"));?></th>
				<th><?php echo h(Inflector::humanize("aspect_details"));?></th>
				<th><?php echo h(Inflector::humanize("env_impact_id"));?></th>
				<th><?php echo h(Inflector::humanize("impact_details"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($envIdentification['EnvActivity']['title']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($envIdentification['EnvImpact']['name']); ?>&nbsp;</td>
		<td><?php echo h($envIdentification['EnvIdentification']['impact_details']); ?>&nbsp;</td>
		<td><?php echo h($envIdentification['EnvIdentification']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($envIdentification['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envIdentification['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envIdentification['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($envIdentification['PreparedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
