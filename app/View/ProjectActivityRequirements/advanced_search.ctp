			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('ProjectActivityRequirement',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","title"=>"Title","details"=>"Details","manpower"=>"Manpower","manpower_Details"=>"Manpower Details","infrastructure"=>"Infrastructure","other"=>"Other","users"=>"Users","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#projectActivityRequirements_ajax','type'=>'data','method'=>'post')); ?>
;									<?php echo $this->Form->end(); ?></li>
				...
				<div class="col-md-8">
					<h4><?php echo __('Project Activity Requirements'); ?>
...
<?php foreach ($projectActivityRequirements as $projectActivityRequirement): ?>
	<tr>
<td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$projectActivityRequirement['ProjectActivityRequirement']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $projectActivityRequirement['ProjectActivityRequirement']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $projectActivityRequirement['ProjectActivityRequirement']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $projectActivityRequirement['ProjectActivityRequirement']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $projectActivityRequirement['ProjectActivityRequirement']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $projectActivityRequirement['ProjectActivityRequirement']['id']),array('class'=>''), __('Are you sure ?', $projectActivityRequirement['ProjectActivityRequirement']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($projectActivityRequirement['ProjectActivityRequirement']['sr_no']); ?>&nbsp;</td>
		<td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($projectActivityRequirement['ProjectActivityRequirement']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($projectActivityRequirement['ProjectActivityRequirement']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($projectActivityRequirement['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $projectActivityRequirement['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectActivityRequirement['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $projectActivityRequirement['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectActivityRequirement['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $projectActivityRequirement['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectActivityRequirement['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $projectActivityRequirement['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($projectActivityRequirement['Company']['name'], array('controller' => 'companies', 'action' => 'view', $projectActivityRequirement['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Form->end();?>			
			...
			'update' => '#projectActivityRequirements_ajax',
			'evalScripts' => true,
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#projectActivityRequirements_ajax')));?>
...
<?php echo $this->Form->create('projectActivityRequirements',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","title"=>"Title","details"=>"Details","manpower"=>"Manpower","manpower_Details"=>"Manpower Details","infrastructure"=>"Infrastructure","other"=>"Other","users"=>"Users","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
