...
<h4><?php echo __('Edit Invoice'); ?>		
        ...
        <?php //echo $this->Html->link(__('Download PDF'), array('action' => 'generate_pdf',$this->request->params['pass'][0].'.pdf'),array('id'=>'pdf','class'=>'label btn-info')); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <table cellpadding="2" cellspacing="1" bgcolor="#D4D4D4" width="100%">
                                    <tr><td><?php echo __('Subtotal'); ?>(<?php echo $purchaseOrder['Currency']['name'];?>)</td><td><span id="subt"><?php echo $subtotal; ?></span><?php echo $this->Form->hidden('stotal',array('label'=>false,'value'=>$subtotal)); ?></td></tr>
