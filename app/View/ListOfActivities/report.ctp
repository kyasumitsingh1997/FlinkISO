...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($listOfActivity['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($listOfActivity['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($listOfActivity['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($listOfActivity['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($listOfActivity['Branch']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfActivity['Department']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfActivity['Employee']['name']); ?>&nbsp;</td>
		<td><?php echo h($listOfActivity['ListOfActivity']['other_details']); ?>&nbsp;</td>
		<td><?php echo h($listOfActivity['ListOfActivity']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($listOfActivity['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfActivity['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfActivity['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($listOfActivity['PreparedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
