...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectEmployee['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectEmployee['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectEmployee['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectEmployee['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectEmployee['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEmployee['Milestone']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEmployee['Employee']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($projectEmployee['ProjectEmployee']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectEmployee['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEmployee['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEmployee['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectEmployee['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
