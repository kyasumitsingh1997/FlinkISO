            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php if(isset($this->request->params['pass'][0])){
                        echo $this->Form->input('employee_id', array('label' => __('Employee'), 'default'=>$this->request->params['pass'][0], 'options' => $PublishedEmployeeList,));
                    }else{
                        echo $this->Form->input('employee_id', array('label' => __('Employee'), 'options' => $PublishedEmployeeList,));
                    }
                ?></div>
