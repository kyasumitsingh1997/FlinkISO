        ...
        <div class="purchaseOrders form col-md-8">
          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4"><?php echo $this->Form->input('project_id', array('style' => 'width:100%')); ?></div>
                <?php 
                    if($this->request->data['PurchaseOrder']['project_id']){ ?>
                        <div class="clearfix"></div>
                        <div class="col-md-4"><?php echo $this->Form->input('milestone_id', array('style' => 'width:100%')); ?></div>
