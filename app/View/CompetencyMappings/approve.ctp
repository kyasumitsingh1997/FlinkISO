    ...
    $().ready(function () {
        $("#submit-indicator").hide();
         $("#submit_id").click(function(){
             if($('#CompetencyMappingApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#CompetencyMappingApproveForm").submit();
             }
        });
        ...
        $('#CompetencyMappingApproveForm').validate({
            rules: {
...
<div id="competencyMappings_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="competencyMappings form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Competency Mapping'); ?>
