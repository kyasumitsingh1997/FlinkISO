...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectPayment['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectPayment['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectPayment['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectPayment['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("invoice_id"));?></th>
				<th><?php echo h(Inflector::humanize("amount"));?></th>
				<th><?php echo h(Inflector::humanize("amount_received"));?></th>
				<th><?php echo h(Inflector::humanize("unit"));?></th>
				<th><?php echo h(Inflector::humanize("received_date"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectPayment['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectPayment['Milestone']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectPayment['PurchaseOrder']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectPayment['Invoice']['id']); ?>&nbsp;</td>
		...
		<td><?php echo h($projectPayment['ProjectPayment']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectPayment['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectPayment['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectPayment['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectPayment['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
