...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($userAccessControl['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($userAccessControl['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($userAccessControl['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($userAccessControl['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("user_access"));?></th>
	...
	<tr>
		...
		<td><?php echo h($userAccessControl['UserAccessControl']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($userAccessControl['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userAccessControl['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userAccessControl['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userAccessControl['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userAccessControl['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($userAccessControl['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
