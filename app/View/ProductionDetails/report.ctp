...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($productionDetail['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($productionDetail['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($productionDetail['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($productionDetail['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("unit_id"));?></th>
				<th><?php echo h(Inflector::humanize("production_id"));?></th>
				<th><?php echo h(Inflector::humanize("value_driver_id"));?></th>
				<th><?php echo h(Inflector::humanize("performance_indicator_id"));?></th>
				<th><?php echo h(Inflector::humanize("production_accepted"));?></th>
				<th><?php echo h(Inflector::humanize("production_rejected"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($productionDetail['Unit']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionDetail['Production']['batch_number']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionDetail['ValueDriver']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionDetail['PerformanceIndicator']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($productionDetail['ProductionDetail']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($productionDetail['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionDetail['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionDetail['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionDetail['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($productionDetail['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
