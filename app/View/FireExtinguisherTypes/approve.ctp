...
<script>
    ...
    $().ready(function() {
        $('#FireExtinguisherTypeApproveForm').validate();
        $("#submit-indicator").hide();
        $("#submit_id").click(function(){
             if($('#FireExtinguisherTypeApproveForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
		 $("#FireExtinguisherTypeApproveForm").submit();
             }
...
<div id="fireExtinguisherTypes_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="fireExtinguisherTypes form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Fire Extinguisher Type'); ?>
