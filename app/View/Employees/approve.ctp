          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <div class="row">
                <fieldset><legend><h5><?php echo __('Mandatory Details'); ?></h5></legend>
                    ...
                    <div class="col-md-4"><?php echo $this->Form->input('designation_id', array('style' => 'width:100%', 'label' => __('Designation'))); ?></div>
                    <div class="col-md-4"><?php echo $this->Form->input('department_id', array('style' => 'width:100%', 'label' => __('Department'))); ?></div>
