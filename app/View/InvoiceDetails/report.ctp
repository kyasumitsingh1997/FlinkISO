...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($invoiceDetail['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($invoiceDetail['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($invoiceDetail['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($invoiceDetail['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("purchase_order_detail_id"));?></th>
				<th><?php echo h(Inflector::humanize("invoice_id"));?></th>
				<th><?php echo h(Inflector::humanize("product_id"));?></th>
				<th><?php echo h(Inflector::humanize("device_id"));?></th>
				<th><?php echo h(Inflector::humanize("material_id"));?></th>
				<th><?php echo h(Inflector::humanize("other"));?></th>
				<th><?php echo h(Inflector::humanize("item_number"));?></th>
				<th><?php echo h(Inflector::humanize("quantity"));?></th>
				<th><?php echo h(Inflector::humanize("description"));?></th>
				<th><?php echo h(Inflector::humanize("rate"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($invoiceDetail['PurchaseOrder']['name']); ?>&nbsp;</td>
		<td><?php echo h($invoiceDetail['InvoiceDetail']['purchase_order_detail_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['Invoice']['id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['Product']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['Device']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['Material']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($invoiceDetail['InvoiceDetail']['publish']); ?>&nbsp;</td>
		<td><?php echo h($invoiceDetail['InvoiceDetail']['record_status']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['StatusUser']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['DepartmentIds']['name']); ?>&nbsp;</td>
		<td><?php echo h($invoiceDetail['InvoiceDetail']['approved_by']); ?>&nbsp;</td>
		<td><?php echo h($invoiceDetail['InvoiceDetail']['prepared_by']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($invoiceDetail['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
