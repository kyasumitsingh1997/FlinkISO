...
<h4>Add Injury Type</h4>
<?php echo $this->Form->create('InjuryType',array('role'=>'form','class'=>'form','default'=>false)); ?>
<div class="row">
		<fieldset>
			<?php
...
<?php
	...
	if ($showApprovals && $showApprovals['show_panel'] == true) {
		...
		echo $this->Form->input('publish', array('label' => __('Publish')));
            ...
            ?><?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#injuryTypes_ajax','async' => 'false')); ?>
...
<script>
    $.validator.setDefaults({
		...
		$().ready(function() {
    $("#submit-indicator").hide();
        $('#InjuryTypeAddAjaxForm').validate();        
    });
