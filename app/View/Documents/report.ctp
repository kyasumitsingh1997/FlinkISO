...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($document['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($document['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($document['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($document['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("document_number"));?></th>
				<th><?php echo h(Inflector::humanize("issue_number"));?></th>
				<th><?php echo h(Inflector::humanize("revision_number"));?></th>
				<th><?php echo h(Inflector::humanize("revision_date"));?></th>
				<th><?php echo h(Inflector::humanize("content"));?></th>
	...
	<tr>
		...
		<td><?php echo h($document['Document']['publish']); ?>&nbsp;</td>
		<td><?php echo h($document['Document']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($document['Document']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($document['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($document['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($document['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($document['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($document['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($document['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
