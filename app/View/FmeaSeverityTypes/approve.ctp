...
<h4><?php echo __('Approve Fmea Severity Type'); ?>		
...
<div class="row">
			<?php
		echo "<div class='col-md-12'>".$this->Form->input('effect') . '</div>'; 
		echo "<div class='col-md-12'>".$this->Form->input('criteria') . '</div>'; 
		echo "<div class='col-md-12'>".$this->Form->input('ranking') . '</div>'; 
	?>
<?php
...
<script>
    $.validator.setDefaults({
		...
		$().ready(function() {
    $("#submit-indicator").hide();
        $('#FmeaSeverityTypeApproveForm').validate();        
    });
</script>
