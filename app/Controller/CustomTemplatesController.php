...
class CustomTemplatesController extends AppController {
    ...
    public function advanced_search() {
        ...
        if ($this->request->query['from-date']) {
            $conditions[] = array('CustomTemplate.created >' => date('Y-m-d h:i:s', strtotime($this->request->query['from-date'])), 'CustomTemplate.created <' => date('Y-m-d h:i:s', strtotime($this->request->query['to-date'])));
        }
