			...
			<div class="panel-heading">
				...
				<?php echo $this->Form->end(); ?>
                            ...
                            <div id="users_ajax_new" style="display: none;">
                                ...
                                <?php echo $this->Form->hidden('number_of_users'); ?>
                                <br />&nbsp;
                                <br />&nbsp;
                                <br />
                            </div>
				...
				<div class="col-md-6">
				    <?php echo $this->Form->submit(__('Activate'), array('div' => false, 'class' => 'btn btn-lg btn-success', 'update' => '#users_ajax', 'async' => 'false', 'id' => 'submit_id')); ?>
