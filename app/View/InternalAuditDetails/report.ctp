...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($internalAuditDetail['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($internalAuditDetail['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($internalAuditDetail['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($internalAuditDetail['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("nc_found"));?></th>
				<th><?php echo h(Inflector::humanize("question"));?></th>
				<th><?php echo h(Inflector::humanize("findings"));?></th>
				<th><?php echo h(Inflector::humanize("opportunities_for_improvement"));?></th>
				<th><?php echo h(Inflector::humanize("clause_number"));?></th>
				<th><?php echo h(Inflector::humanize("current_status"));?></th>
				<th><?php echo h(Inflector::humanize("comments"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($internalAuditDetail['InternalAudit']['start_time']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($internalAuditDetail['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditDetail['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditDetail['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditDetail['PreparedBy']['name']); ?>&nbsp;</td>
		<td><?php echo h($internalAuditDetail['InternalAuditDetail']['publish']); ?>&nbsp;</td>
		<td><?php echo h($internalAuditDetail['InternalAuditDetail']['record_status']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditDetail['StatusUserId']['name']); ?>&nbsp;</td>
		<td><?php echo h($internalAuditDetail['InternalAuditDetail']['division_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($internalAuditDetail['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
