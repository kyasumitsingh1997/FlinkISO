        ...
        <div class="table-responsive">
            ...
            <table cellpadding="0" cellspacing="0" class="table table-bordered table table-striped table-hover">
                ...
                <tr class="on_page_src">
                    <td class=" actions">
                        <?php echo $this->element('actions', array('created' => $courseType['CourseType']['created_by'], 'postVal' => $courseType['CourseType']['id'], 'softDelete' => $courseType['CourseType']['soft_delete'])); ?>
                    </td>
                    <td><?php echo h($courseType['CourseType']['title']); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$courseType['CourseType']['prepared_by']]); ?>&nbsp;</td>
                    <td><?php echo h($PublishedEmployeeList[$courseType['CourseType']['approved_by']]); ?>&nbsp;</td>
                    <td width="60">
