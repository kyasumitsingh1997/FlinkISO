...
<h4>Add File View</h4>
<?php echo $this->Form->create('FileView',array('role'=>'form','class'=>'form','default'=>false)); ?>
<div class="row">
		<fieldset>
			<?php
...
<?php
	...
	}?><?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#fileViews_ajax','async' => 'false')); ?>
