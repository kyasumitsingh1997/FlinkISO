...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($severiryType['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($severiryType['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($severiryType['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($severiryType['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("severiry"));?></th>
				<th><?php echo h(Inflector::humanize("score"));?></th>
	...
	<tr>
		...
		<td><?php echo h($severiryType['SeveriryType']['publish']); ?>&nbsp;</td>
		<td><?php echo h($severiryType['SeveriryType']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($severiryType['SeveriryType']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($severiryType['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($severiryType['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($severiryType['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($severiryType['PreparedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
