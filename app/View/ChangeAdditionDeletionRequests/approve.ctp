...
<script>
    ...
    $().ready(function () {
        ...
        $("#submit_id").click(function () {
            ...
            //     return false;
            // }
            if ($('#ChangeAdditionDeletionRequestApproveForm').valid()) {
                $("#submit_id").prop("disabled", true);
                $("#submit-indicator").show();
                $("#ChangeAdditionDeletionRequestApproveForm").submit();
            }
        ...
        $('#ChangeAdditionDeletionRequestApproveForm').validate({
            rules: {
...
<div id="changeAdditionDeletionRequests_ajax"> <?php echo $this->Session->flash(); ?>
    <div class="nav panel panel-default">
        <div class="changeAdditionDeletionRequests form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Change Request'); ?>
        ...
        <table class="table bordered">
            ...
            <tr>
                ...
                <td><?php echo __('Table'); ?></td><td><?php if($file['SystemTable']['name'])echo $file['SystemTable']['name']; else echo '---';?></td>
            </tr>
            <tr>
                <td><?php echo __('Record'); ?></td><td>---</td>
            ...
            <tr>
                ...
                <td><?php echo __('Format'); ?></td><td><?php echo $file['MasterListOfFormat']['title']; ?></td>
            </tr>
        </table>
                        </div>
...
<div id="changeAdditionDeletionRequests_ajax"> <?php echo $this->Session->flash(); ?>
    <div class="nav panel panel-default">
        <div class="changeAdditionDeletionRequests form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Approve Change Request'); ?> <?php echo $this->Html->link(__('List'), array('action' => 'index'), array('id' => 'list', 'class' => 'label btn-info')); ?>
