...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($milestoneType['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($milestoneType['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($milestoneType['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($milestoneType['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td width="50"><?php echo h($milestoneType['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestoneType['Milestone']['title']); ?>&nbsp;</td>
		<td><?php echo h($milestoneType['MilestoneType']['publish']); ?>&nbsp;</td>
		<td><?php echo h($milestoneType['MilestoneType']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($milestoneType['MilestoneType']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestoneType['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestoneType['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestoneType['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($milestoneType['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
