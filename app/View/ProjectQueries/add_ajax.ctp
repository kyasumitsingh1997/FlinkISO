...
<?php echo $this->Session->flash();?>	<div class="nav">
		<div class="projectQueries form col-md-8">
			<h4>Add Project Query</h4>
			<?php echo $this->Form->create('ProjectQuery',array('role'=>'form','class'=>'form','default'=>false)); ?>
			<div class="row">
			<fieldset>
					<?php
					echo "<div class='col-md-6'>".$this->Form->input('name',array()) . '</div>'; 
					echo "<div class='col-md-6'>".$this->Form->input('query_type_id',array()) . '</div>'; 
					...
					echo "<div class='col-md-6'>".$this->Form->input('sent_to',array()) . '</div>'; 
					echo "<div class='col-md-6'>".$this->Form->input('query',array()) . '</div>'; 
...
<?php echo $this->Form->submit('Submit',array('div'=>false,'class'=>'btn btn-primary btn-success','update'=>'#projectQueries_ajax','async' => 'false')); ?>
...
<script>
    $.validator.setDefaults({
        ...
        $('#ProjectQueryAddAjaxForm').validate({
            rules: {
