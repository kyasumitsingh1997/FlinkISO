...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($projectActivity['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($projectActivity['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($projectActivity['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($projectActivity['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("estimated_cost"));?></th>
				<th><?php echo h(Inflector::humanize("start_date"));?></th>
				<th><?php echo h(Inflector::humanize("end_date"));?></th>
				<th><?php echo h(Inflector::humanize("sequence"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($projectActivity['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivity['Milestone']['title']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectActivity['Branch']['name']); ?>&nbsp;</td>
		<td><?php echo h($projectActivity['ProjectActivity']['users']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivity['UserSession']['id']); ?>&nbsp;</td>
		<td><?php echo h($projectActivity['ProjectActivity']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($projectActivity['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivity['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivity['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivity['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($projectActivity['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
