			...
			<div class="row">
				<div class="col-md-4 pull-right">
					<div class="input-group pull-left">
						<?php echo $this->Form->create('IncidentWitness',array('role'=>'form','class'=>'no-padding no-margin','id'=>'search-form','action'=>'search')); ?>
						...
						<?php echo $this->Form->input(__('search'),array('label'=>false,'placeholder'=>'search','role'=>'form','class'=>'form-control','action'=>'search')); ?>
							...
							<div class="input-group-btn">
								...
								<ul class="dropdown-menu pull-right">
									<li class="search-dropdown"><?php echo $this->Form->input('search_field',array('multiple'=>'checkbox','options'=>array("sr_no"=>"Sr No","person_type"=>"Person Type","name"=>"Name","address"=>"Address","phone"=>"Phone","age"=>"Age","gender"=>"Gender","investigation_interview_taken_by"=>"Investigation Interview Taken By","date_of_interview"=>"Date Of Interview","investigation_interview_findings"=>"Investigation Interview Findings","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By")));?></li>		
									<li><?php echo $this->Js->submit('Submit',array('url'=>'search','div'=>false,'class'=>'btn btn-primary btn-success','update' => '#incidentWitnesses_ajax','type'=>'data','method'=>'post')); ?>
;									<?php echo $this->Form->end(); ?></li>
				...
				<div class="col-md-8">
					<h4><?php echo __('Incident Witnesses'); ?>
...
<?php foreach ($incidentWitnesses as $incidentWitness): ?>
	<tr class="on_page_src">
                    <td width="15"><?php echo $this->Form->checkbox('rec_ids_'.$i,array('label'=>false,'value'=>$incidentWitness['IncidentWitness']['id'],'multiple'=>'checkbox','class'=>'rec_ids')); ?></td>		<td class=" actions">
		<div class="btn-group">
		<button type="button" data-toggle="dropdown" class="dropdown-toggle btn  btn-sm btn-default "><i class="fa fa-wrench" aria-hidden="true"></i></button>
				...
				<li><?php echo $this->Html->link(__('View / Upload Evidance'), array('action' => 'view', $incidentWitness['IncidentWitness']['id'])); ?></li>
				<li><?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $incidentWitness['IncidentWitness']['id'])); ?></li>
				<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $incidentWitness['IncidentWitness']['id']),array('class'=>''), __('Are you sure you want to delete this record ?', $incidentWitness['IncidentWitness']['id'])); ?></li>
				<li class="divider"></li>
				<li><?php echo $this->Html->link(__('Send for Approval'), '#makerchecker',array('data-toggle'=>'modal')); ?></li>
				<li><?php echo $this->Form->postLink(__('Email Record'), array('controller'=>'message','action' => 'add', $incidentWitness['IncidentWitness']['id']),array('class'=>''), __('Are you sure ?', $incidentWitness['IncidentWitness']['id'])); ?></li>
			</ul>
		</div>
		</td>
		<td width="50"><?php echo h($incidentWitness['IncidentWitness']['sr_no']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($incidentWitness['IncidentWitness']['person_type']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($incidentWitness['IncidentWitness']['address']); ?>&nbsp;</td>
		<td><?php echo h($incidentWitness['IncidentWitness']['phone']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($incidentWitness['IncidentWitness']['age']); ?>&nbsp;</td>
		<td><?php echo h($incidentWitness['IncidentWitness']['gender']); ?>&nbsp;</td>
		<td><?php echo h($incidentWitness['IncidentWitness']['investigation_interview_taken_by']); ?>&nbsp;</td>
		<td><?php echo h($incidentWitness['IncidentWitness']['date_of_interview']); ?>&nbsp;</td>
		<td><?php echo h($incidentWitness['IncidentWitness']['investigation_interview_findings']); ?>&nbsp;</td>
		...
		<td width="60">
			...
			<?php } ?>&nbsp;</td>
		<td><?php echo h($incidentWitness['IncidentWitness']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($incidentWitness['IncidentWitness']['status_user_id']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($incidentWitness['BranchIds']['name'], array('controller' => 'branches', 'action' => 'view', $incidentWitness['BranchIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($incidentWitness['DepartmentIds']['name'], array('controller' => 'departments', 'action' => 'view', $incidentWitness['DepartmentIds']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($incidentWitness['ApprovedBy']['name'], array('controller' => 'employees', 'action' => 'view', $incidentWitness['ApprovedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($incidentWitness['PreparedBy']['name'], array('controller' => 'employees', 'action' => 'view', $incidentWitness['PreparedBy']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($incidentWitness['Company']['name'], array('controller' => 'companies', 'action' => 'view', $incidentWitness['Company']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
<?php }else{ ?>
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'add', 'ajax'),array('async' => true, 'update' => '#incidentWitnesses_ajax')));?>
...
<?php echo $this->Form->create('incidentWitnesses',array('action'=>'report','target'=>'_blank','class'=>'no-padding no-margin no-background zero-height'));?>
...
<div class="modal-body"><?php echo $this->element('advanced-search',array('postData'=>array("sr_no"=>"Sr No","person_type"=>"Person Type","name"=>"Name","address"=>"Address","phone"=>"Phone","age"=>"Age","gender"=>"Gender","investigation_interview_taken_by"=>"Investigation Interview Taken By","date_of_interview"=>"Date Of Interview","investigation_interview_findings"=>"Investigation Interview Findings","record_status"=>"Record Status","branchid"=>"Branchid","departmentid"=>"Departmentid","approved_by"=>"Approved By","prepared_by"=>"Prepared By"),'PublishedBranchList'=>array($PublishedBranchList))); ?></div>
		<div class="modal-footer">
		<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
		</div></div></div></div>
