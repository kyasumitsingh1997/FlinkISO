...
class SummeryOfSupplierEvaluationsController extends AppController {
    ...
    public function add_ajax() {
        ...
        $supplierEvaluationTemplates = $this->SummeryOfSupplierEvaluation->SupplierEvaluationTemplate->find('list', array('conditions' => array('SupplierEvaluationTemplate.publish' => 1, 'SupplierEvaluationTemplate.soft_delete' => 0)));

        $this->set(compact('supplierRegistrations', 'supplierCategories','supplierEvaluationTemplates'));
    }
