...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($injuryType['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($injuryType['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($injuryType['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($injuryType['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
	...
	<tr>
		...
		<td><?php echo h($injuryType['InjuryType']['publish']); ?>&nbsp;</td>
		<td><?php echo h($injuryType['InjuryType']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($injuryType['InjuryType']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($injuryType['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($injuryType['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($injuryType['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($injuryType['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($injuryType['Division']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($injuryType['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
