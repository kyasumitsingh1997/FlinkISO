...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($fileCategory['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($fileCategory['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($fileCategory['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($fileCategory['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("priority"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($fileCategory['Project']['title']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileCategory['Milestone']['title']); ?>&nbsp;</td>
		<td><?php echo h($fileCategory['FileCategory']['publish']); ?>&nbsp;</td>
		<td><?php echo h($fileCategory['FileCategory']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($fileCategory['FileCategory']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileCategory['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileCategory['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileCategory['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($fileCategory['ApprovedBy']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
