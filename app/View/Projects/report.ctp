...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($project['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($project['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($project['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($project['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("goal"));?></th>
				<th><?php echo h(Inflector::humanize("scope"));?></th>
				<th><?php echo h(Inflector::humanize("success_criteria"));?></th>
				<th><?php echo h(Inflector::humanize("challenges"));?></th>
				<th><?php echo h(Inflector::humanize("project_cost"));?></th>
				...
				<th><?php echo h(Inflector::humanize("employees"));?></th>
				<th><?php echo h(Inflector::humanize("customers"));?></th>
				<th><?php echo h(Inflector::humanize("suppliers_vendors"));?></th>
				<th><?php echo h(Inflector::humanize("others"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($project['Employee']['name']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($project['Branch']['name']); ?>&nbsp;</td>
		<td><?php echo h($project['Project']['users']); ?>&nbsp;</td>
		<td width="50"><?php echo h($project['UserSession']['id']); ?>&nbsp;</td>
		<td><?php echo h($project['Project']['publish']); ?>&nbsp;</td>
		<td><?php echo h($project['Project']['record_status']); ?>&nbsp;</td>
		<td><?php echo h($project['Project']['status_user_id']); ?>&nbsp;</td>
		<td width="50"><?php echo h($project['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($project['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($project['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($project['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($project['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
