...
<script>
    ...
    $().ready(function() {
        ...
        $('#HousekeepingChecklistEditForm').validate({
            rules: {
        ...
        $("#submit_id").click(function(){
             if($('#HousekeepingChecklistEditForm').valid()){
                 $("#submit_id").prop("disabled",true);
                 $("#submit-indicator").show();
                 $("#HousekeepingChecklistEditForm").submit();
             }
        });
...
<div id="housekeepingChecklists_ajax">
    ...
    <div class="nav panel panel-default">
        <div class="housekeepingChecklists form col-md-8">
            <h4><?php echo $this->element('breadcrumbs') . __('Edit Housekeeping Checklist'); ?>
