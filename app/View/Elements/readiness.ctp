            ...
            <table class="table table-responsive">
                ...
                <tr>
                    <td class="col-md-11">
                        <?php
                        if ($result['chars'] == 0)
                            echo "<span class='text-danger'>You have not yet updated your <strong>" . $result['title'] . "</strong> format</span>";
                        else
                            echo "<span class='text-success'>Format <strong>" . $result['title'] . "</strong> is updated</span>";
                        ?>
                    </td>
                    <td class="col-md-1">
                        <?php echo $this->Html->link('View', array('controller' => 'master_list_of_formats', 'action' => 'view', $result['id'],1), array('class' => 'btn btn-sm btn-info')) ?>
                    </td>
                </tr>
                <?php endforeach ?>
            </table>
