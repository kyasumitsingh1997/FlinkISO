        ...
        <div class="customers form col-md-8">
          ...
          <?php echo $this->Html->link(__('Download PDF'), array('action' => 'view',$this->request->params['pass'][0].'.pdf'), array('id' => 'pdf', 'class' => 'label btn-info')); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php
                        echo "<label>" . __('Lead Type') . "</label>";
                        echo $this->Form->input('lead_type', array('type' => 'radio', 'class' => 'checkbox-2', 'legend' => false, 'options' => array('0' => __('New Prospect (Lead)'), '1' => __('Existing Customer'))));
                    ?>
                </div>
