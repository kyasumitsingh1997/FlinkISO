...
class BranchesController extends AppController {
    ...
    public function get_employee_list($branch_id = null) {
         
       
        $this->loadModel('Employee');
        $this->Employee->recursive = -1;
        $EmployeeList = $this->Employee->find('list', array('conditions' => array('Employee.publish' => 1, 'Employee.soft_delete' => 0, 'Employee.branch_id'=>$branch_id)));
        $this->set('options', $EmployeeList);
