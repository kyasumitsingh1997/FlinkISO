...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($rejectionDetail['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($rejectionDetail['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($rejectionDetail['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($rejectionDetail['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				<th><?php echo h(Inflector::humanize("sr_no"));?></th>
				<th><?php echo h(Inflector::humanize("production_rejection_id"));?></th>
				<th><?php echo h(Inflector::humanize("value_driver_id"));?></th>
				<th><?php echo h(Inflector::humanize("defect_type_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($rejectionDetail['ProductionRejection']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($rejectionDetail['ValueDriver']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($rejectionDetail['DefectType']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($rejectionDetail['PerformanceIndicator']['name']); ?>&nbsp;</td>
		<td><?php echo h($rejectionDetail['RejectionDetail']['publish']); ?>&nbsp;</td>
		...
		<td width="50"><?php echo h($rejectionDetail['BranchIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($rejectionDetail['DepartmentIds']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($rejectionDetail['ApprovedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($rejectionDetail['PreparedBy']['name']); ?>&nbsp;</td>
		<td width="50"><?php echo h($rejectionDetail['Company']['name']); ?>&nbsp;</td>
	</tr>
	<?php endforeach; ?>
			</table>
			<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
