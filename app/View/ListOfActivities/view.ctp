...
<h4><?php echo __('View List Of Activity'); ?>		<?php echo $this->Html->link(__('List'), array('action' => 'index'),array('id'=>'list','class'=>'label btn-info')); ?>
...
<table class="table table-responsive">
		...
		<td>
			<?php echo h($listOfActivity['ListOfActivity']['title']); ?>
			&nbsp;
		</td></tr>
		<tr><td><?php echo __('Activity Details'); ?></td>
		<td>
			<?php echo h($listOfActivity['ListOfActivity']['activity_details']); ?>
			&nbsp;
		</td></tr>
		...
		<td>
			<?php echo h($listOfActivity['ListOfActivity']['other_details']); ?>
			&nbsp;
		</td></tr>
		<tr><td><?php echo __('Prepared By'); ?></td>

	<td><?php echo h($listOfActivity['ApprovedBy']['name']); ?>&nbsp;</td></tr>
...
&nbsp;</td></tr>
		...
		<td>
			<?php if($listOfActivity['ListOfActivity']['soft_delete'] == 1) { ?>
			<span class="fa fa-check"></span>
			<?php } else { ?>
			<span class="fa fa-ban"></span>
			<?php } ?>&nbsp;</td>
...
<?php echo $this->element('upload-edit', array('usersId' => listOfActivity['ListOfActivity']['created_by'], 'recordId' => listOfActivity['ListOfActivity']['id'])); ?>
;
</div>
<div class="col-md-4">
...
<?php echo $this->Js->event('click',$this->Js->request(array('action' => 'edit',$listOfActivity['ListOfActivity']['id'] ,'ajax'),array('async' => true, 'update' => '#listOfActivities_ajax')));?>
