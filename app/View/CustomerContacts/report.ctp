...
<div id="reports_ajax">
 ...
 ?>	<fieldset>
	...
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		...
		<tr>
			<td>Document Title </td><td>&nbsp;<?php echo h($customerContact['MasterListOfFormat']['title']); ?></td>
			<td>Document Number</td><td>&nbsp;<?php echo h($customerContact['MasterListOfFormat']['document_number']); ?></td>
		</tr>
		<tr>
			<td>Revision Number </td><td>&nbsp;<?php echo h($customerContact['MasterListOfFormat']['revision_number']); ?></td>
			<td>Revision Date</td><td>&nbsp;<?php echo h($customerContact['MasterListOfFormat']['revision_date']); ?></td>
		</tr>
                </table>
	<table cellpadding="2" cellspacing="2" border="1" width="100%" style="font-size:10px">
		<tr>
				...
				<th><?php echo h(Inflector::humanize("mobile"));?></th>
				<th><?php echo h(Inflector::humanize("email"));?></th>
				...
				<th><?php echo h(Inflector::humanize("state_id"));?></th>
	...
	<tr>
		...
		<td width="50"><?php echo h($customerContact['Customer']['name']); ?>&nbsp;</td>
		...
		<td><?php echo h($customerContact['CustomerContact']['publish']); ?>&nbsp;</td>
